...
ADI always is happy to support the GNU Radio community with not only `Sponsorship <https://events.gnuradio.org/event/8/page/5-sponsors>`__, presentations and the PlutoSDR Workshop.
...
`Abstract <https://events.gnuradio.org/event/8/contributions/62/>`__
...
`Abstract <https://events.gnuradio.org/event/8/contributions/30/>`__
...
`Abstract <https://events.gnuradio.org/event/8/contributions/63/>`__
...
`Abstract <https://events.gnuradio.org/event/8/contributions/130/>`__
...
`Abstract <https://events.gnuradio.org/event/8/contributions/61/>`__
...
-  `PlutoSDR Workshop Labs <https://github.com/sdrforengineers/LabGuides/tree/master/grcon2020>`__
-  `PlutoSDR Workshop Slides <https://wiki.analog.com/_media/plutoworkshop.pdf>`__

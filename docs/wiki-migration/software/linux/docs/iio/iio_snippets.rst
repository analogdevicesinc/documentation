...
+-----------------------------------------------------------------------+-------------------------------------------------------------------------------+
| `iio-trig-sysfs <https://wiki.analog.com/iio-trig-sysfs>`__           | Provides support for using SYSFS entry as IIO triggers.                       |
+-----------------------------------------------------------------------+-------------------------------------------------------------------------------+
| `iio-trig-bfin-timer <https://wiki.analog.com/iio-trig-bfin-timer>`__ | Provides support for using a Blackfin timer as IIO triggers.                  |
+-----------------------------------------------------------------------+-------------------------------------------------------------------------------+
...
.. include:: ../../../../resources/tools-software/linux-drivers/need_help.rst

...
-  `Yahoo! Style Guide <http://styleguide.yahoo.com/writing>`_
-  `Common Bugs in Writing <http://www.cs.columbia.edu/~hgs/etc/writing-bugs.html>`_

For more information
--------------------

-  `IEEE Professional Communication Society <http://ewh.ieee.org/soc/pcs/index.php?q=node/23>`_
-  `Society for Technical Communication <http://www.stc.org/>`_

...
All attendees should have received instructions to install `MATLAB <https://www.mathworks.com//campaigns/products/trials.html?prodcode=CM>`__. If not, please use this `this link <https://www.mathworks.com//campaigns/products/trials.html?prodcode=CM>`__ and then install the `support package <https://www.mathworks.com//hardware-support/adalm-pluto-radio.html>`__. You will also need some additional software from ADI. Please install libIIO, libad9361, and IIO-Scope based on your operating system:
...
`Baltimore/Natick <https://wiki.analog.com/_media/richardsonmathworksseminars.pdf>`__

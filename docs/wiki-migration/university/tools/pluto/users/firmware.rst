...
The PlutoSDR/M2K driver package bundles also a dfu utility. There is a windows command console batch script called `UPDATE.BAT <https://raw.githubusercontent.com/analogdevicesinc/plutosdr_scripts/master/UPDATE.BAT>`__ which eases the update procedure.

-  Download and save `UPDATE.BAT <https://raw.githubusercontent.com/analogdevicesinc/plutosdr_scripts/master/UPDATE.BAT>`__
...
.. note::
   ...
   **dfu-util** - a short dfu primer
   ...
   `DFU <http://dfu-util.sourceforge.net/dfu-util.1.html>`__ has lots of options, the ones to remember are:

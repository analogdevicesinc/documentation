...
When the device is powered from the Auxiliary Power Supply it support various HOST functions, such as USB WIFI, Storage and HID. Using the correct cables is the key to `OTG <https://en.wikipedia.org/wiki/USB_On-The-Go>`__ operation.

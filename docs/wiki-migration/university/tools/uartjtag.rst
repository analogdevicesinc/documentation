...
This includes the Silicon Labs `CP2103-GM <https://www.silabs.com/Support%20Documents/TechnicalDocs/CP2103.pdf>`__ USB to UART bridge, which you can plug a USB cable into.

This also includes connection to Xilinx JTAG cable as well. You will need a `Xilinx JTAG Cable <https://www.xilinx.com/support/documentation/data_sheets/ds593.pdf>`__ or `equivalent <https://store.digilentinc.com/jtag-hs3-programming-cable>`__ to use it.
...
.. admonition:: Download
   ...
   -  PCB Layout
   -  Bill of Materials
   -  Allegro Project (get the `Allegro FREE Physical Viewer <https://www.cadence.com/en_US/home/tools/pcb-design-and-analysis/allegro-downloads-start.html>`__ to view)

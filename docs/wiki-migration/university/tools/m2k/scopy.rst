...
.. admonition:: Download
   ...
   -  Google Play store link: `Scopy <https://play.google.com/store/apps/details?id=org.adi.scopy>`__
...
| |youtube>894HkVXf7-U|
| === Scopy for Linux === Before downloading and extracting the scopy-v1.1.1-Linux-flatpak.zip archive, you need to setup Flatpak using `this setup guide <https://flatpak.org/setup/>`__ for your Linux distribution.
...
| 
| ====== Source code ====== The source code for the entire application can be found on `github <https://github.com/analogdevicesinc/scopy>`__.

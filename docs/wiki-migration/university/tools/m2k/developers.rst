...
-  Hardware
   ...
   -  `Schematics <https://wiki.analog.com/.devs/hardware>`__
   -  Detailed Performance *(Coming soon)*
   -  Accessing the Console\ *(Coming soon)* with the `ADALM-JTAGUART <https://wiki.analog.com/../uartjtag>`__ adapter
   -  Accessing FPGA JTAG\ *(Coming soon)* with the `ADALM-JTAGUART <https://wiki.analog.com/../uartjtag>`__ adapter

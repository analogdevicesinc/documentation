...
-  **Press and hold the** `device button <https://wiki.analog.com/../../pluto/hacking/hardware>`__ with a toothpick, paper-clip or similar while applying power by plugging in the USB cable.
...
The M2K driver package bundles also a dfu utility. There is a windows command console batch script called `UPDATE.BAT <https://raw.githubusercontent.com/analogdevicesinc/plutosdr_scripts/master/UPDATE.BAT>`__ which eases the update procedure.

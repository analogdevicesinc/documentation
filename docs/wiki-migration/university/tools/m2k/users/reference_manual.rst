...
| System memory is a Micron `MT41K256M16TW-107 <https://www.micron.com/parts/dram/ddr3-sdram/mt41k256m16tw-107>`__ 4Gbit (512 MByte), 1066 Mbps, DDR3L low voltage SDRAM. This memory is used for temporary storage of streaming data as well as the operating system.
| |image31|
...
Firmware is stored in a Micron `MT25QU256ABA8E12-1SIT <https://www.micron.com/products/nor-flash/serial-nor-flash/part-catalog/mt25qu256aba8e12-1sit>`__ 265Mbyte, 90MBps Serial Flash. This device has an endurance of 100,000 ERASE cycles minimum (don't update the firmware more times than this).
...
A `Xilinx Zynq <https://www.xilinx.com//products/silicon-devices/soc.html>`__ XC7Z010-1CLG225C System on Chip provides processing and programmable logic functionality with the following specifications:
...
Additional information may be found at `Zynq-7000 All Programmable SoC Overview <https://www.xilinx.com//support/documentation/data_sheets/ds190-Zynq-7000-Overview.pdf>`__ and `Datasheet <https://www.xilinx.com//support/documentation/data_sheets/ds187-XC7Z010-XC7Z020-Data-Sheet.pdf>`__

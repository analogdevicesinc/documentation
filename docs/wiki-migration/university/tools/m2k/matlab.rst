...
The MATLAB bindings follow the `C++ API <https://analogdevicesinc.github.io/libm2k/index.html>`__. Since MATLAB has an interpreter it can be very helpful when exploring the API. This can be done through help or doc commands. For example, if you want to understand the M2kAnalogIn method getAvailableSampleRates you can query it directly.

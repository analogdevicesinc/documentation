...
-  Creating a new out-of-tree module. Please check the available OutOfTreeModules `documentation <https://wiki.gnuradio.org/index.php/OutOfTreeModules#Tools_and_resources_at_my_disposal>`__
...
This project was presented in GRCon 2019. Slides are available `here <https://www.gnuradio.org/grcon/grcon19/presentations/Building_a_radio_with_M2K_and_spare_parts/>`__

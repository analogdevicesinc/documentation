...
-  the most recent `nightly Winbdows builds <https://ci.appveyor.com/project/analogdevicesinc/scopy/build/artifacts>`__. It's possible that someone else already reported the bug, and it has been solved.
...
-  **Windows:** ``C:\Users\<your_username>\AppData\Roaming\ADI`` Sometimes this is a hidden directory, and you `unhide it <https://cybertext.wordpress.com/2012/05/29/cant-see-the-appdata-folder/>`__.

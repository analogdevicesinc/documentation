...
.. image:: https://wiki.analog.com/_media/university/tools/m1k/alice-cd4051-analog-mux-fig1.png
   :align: center
   :width: 500px
...
.. image:: https://wiki.analog.com/_media/university/tools/m1k/alice-cd4051-analog-mux-fig2.png
   :align: center
   :width: 500px
...
.. image:: https://wiki.analog.com/_media/university/tools/m1k/alice-cd4051-analog-mux-fig3.png
   :align: center
   :width: 500px
...
.. image:: https://wiki.analog.com/_media/university/tools/m1k/alice-cd4051-analog-mux-fig4.png
   :align: center
   :width: 500px
...
The wiring connections to the CD4051 are relatively simple and can be often built on the Solder-less breadboard along with the rest of the experiment circuitry. However, this might not always be a workable solution. A break-out board based on the 74HC4051 is available commercially `Sparkfun 8 Channel Multiplexer Breakout <https://www.sparkfun.com/products/13906>`__. Figure 6 is a rendering of the top of the PCB showing the connections to the M1k.

.. image:: https://wiki.analog.com/_media/university/tools/m1k/alice-cd4051-analog-mux-fig6.png
   :align: center
   :width: 500px
...
.. image:: https://wiki.analog.com/_media/university/tools/m1k/alice-cd4051-analog-mux-fig7.png
   :align: center
   :width: 600px

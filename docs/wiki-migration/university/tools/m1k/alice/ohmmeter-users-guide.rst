...
`ohm-meter-tool.py(w) <https://wiki.analog.com/_media/university/tools/ohm-meter-tool.zip>`__
...
`ohm-meter-vdiv.py(w) <https://wiki.analog.com/_media/university/tools/ohm-meter-tool.zip>`__

...
.. admonition:: Download
   ...
   -  `Latest release for 32 bit Python 2.7 <https://wiki.analog.com/_media/university/tools/alice-1.0-32bit-setup.zip>`__
   -  `Latest release for 64 bit Python 2.7 <https://wiki.analog.com/_media/university/tools/alice-1.0-64bit-setup.zip>`__

...
`Using ALICE XY display and The Lissajous Pattern <https://wiki.analog.com/_media/university/tools/m1k/alice/alice_xy-plot_lissajous_pattern.pdf>`__
...
`TFilter Online FIR filter design <http://t-filter.engineerjs.com/>`__

...
Doxygen-based documentation is available on `the github pages <https://analogdevicesinc.github.io/libsmu/>`__.
...
The `Google Test framework <https://github.com/google/googletest>`__ is used to run various streaming tests. Make sure it's installed on the host system and then use the following to build and run tests:

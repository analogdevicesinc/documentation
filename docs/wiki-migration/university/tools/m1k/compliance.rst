...
The ADALM1000 passes all requirements of the `CE <https://en.wikipedia.org/wiki/CE_marking>`_ tests.

-  `EMC emissions and immunity test report for CE <https://wiki.analog.com/_media/university/tools/m1k/analog_devices_adalm1000_-_emc_emissions_and_immunity_-_ce_mark_test_report_rev_1.0.pdf>`_
-  `CE Safety Findings <https://wiki.analog.com/_media/university/tools/m1k/ce-safety-findings-adalm1000-kit.pdf>`_

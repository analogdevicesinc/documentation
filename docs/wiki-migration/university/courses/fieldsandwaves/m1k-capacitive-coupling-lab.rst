...
| `Capacitive coupling <https://en.wikipedia.org/wiki/Capacitive_coupling>`__
| `Crosstalk <https://en.wikipedia.org/wiki/Crosstalk>`__
| `From learn EMC <https://learnemc.com/electric-field-coupling>`__

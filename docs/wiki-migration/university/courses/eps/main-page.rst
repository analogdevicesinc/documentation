...
| Eagle CAD and Gerber files `schematic and board files <https://wiki.analog.com/_media/university/courses/eps/power_system_adg.zip>`__
| **Parts List:**
...
The same 60X60 mm 4.5 Volt solar panels are available from `Electronic Goldmine <http://www.goldmine-elec-products.com/prodinfo.asp?number=G16394>`__, part number G16394, for $3.50 each which is less than half the Jameco price.

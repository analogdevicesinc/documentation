...
| `Wikipedia page on DC-to-DC converters <https://en.wikipedia.org/wiki/DC-to-DC_converter>`__
| `Wikipedia page on charge pumps <https://en.wikipedia.org/wiki/Charge_pump>`__

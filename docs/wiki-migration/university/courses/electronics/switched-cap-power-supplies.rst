...
| LTspice files for this activity: `switch_cap_ltspice_files.zip <https://wiki.analog.com/_media/university/courses/electronics/sw_cap/switch_cap_ltspice_files.zip>`__

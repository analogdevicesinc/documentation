...
Passive and Active filter pre-lab simulation `schematic files <https://wiki.analog.com/_media/university/courses/electronics/continuous-time-filter-sims.zip>`__.
...
Sampled Data Systems pre-lab simulation `schematic files <https://wiki.analog.com/_media/university/courses/electronics/sampled-data-sims.zip>`__.

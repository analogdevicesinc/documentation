...
| `Low Dropout Regulators <https://en.wikipedia.org/wiki/Low-dropout_regulator>`__
| `Linear Regulators <https://en.wikipedia.org/wiki/Linear_regulator>`__
| `Low Dropout Linear Regulator Frequently asked Questions <http://electronicdesign.com/power/low-dropout-ldo-linear-regulators>`__

...
| `Electromagnetic coil <https://en.wikipedia.org/wiki/Electromagnetic_coil>`_
| `Signal Transformer Application and Specification <http://www.coilcraft.com/pdfs/doc157_SigXfrmApp.pdf>`_

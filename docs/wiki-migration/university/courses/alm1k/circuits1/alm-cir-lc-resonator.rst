...
| `Inductor <https://en.wikipedia.org/wiki/Inductor>`__
| `Damped sine wave <https://en.wikipedia.org/wiki/Damped_sine_wave>`__
| `Self-resonant frequency <https://en.wikipedia.org/wiki/Self-resonant_frequency>`__
| `Parasitic capacitance <https://en.wikipedia.org/wiki/Parasitic_capacitance>`__

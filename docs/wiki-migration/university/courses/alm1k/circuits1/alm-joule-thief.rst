...
`Data Sheet <http://www.coilcraft.com/pdfs/doc157_SigXfrmApp.pdf>`__
...
| `Joule Thief <https://en.wikipedia.org/wiki/Joule_thief>`__
| `Compound Transistor <https://en.wikipedia.org/wiki/Sziklai_pair>`__

...
| `CMOS Logic <https://en.wikipedia.org/wiki/CMOS>`__
| `Noise Margin <https://en.wikipedia.org/wiki/Noise_margin>`__
| `Propagation Delay <https://en.wikipedia.org/wiki/Propagation_delay>`__
| `Rise <https://en.wikipedia.org/wiki/Rise_time>`__ / `Fall time <https://en.wikipedia.org/wiki/Fall_time>`__
| `Schmitt Trigger <https://en.wikipedia.org/wiki/Schmitt_trigger>`__
| `Transmission gate <https://en.wikipedia.org/wiki/Transmission_gate>`__

...
You can do all this configuration automatically by loading the intro-logic-gates.cfg contained in this zip archive `intro-logic-gates.zip <https://wiki.analog.com/_media/university/courses/alm1k/intro/intro-logic-gates.zip>`__.
...
| `Logic Gates <https://en.wikipedia.org/wiki/Logic_gate>`__
| `The Inverter, NOT gate <https://en.wikipedia.org/wiki/Inverter_(logic_gate)>`__
| `The AND gate <https://en.wikipedia.org/wiki/AND_gate>`__
| `The NAND gate <https://en.wikipedia.org/wiki/NAND_gate>`__
| `The OR gate <https://en.wikipedia.org/wiki/OR_gate>`__
| `The NOR gate <https://en.wikipedia.org/wiki/NOR_gate>`__
| `The XOR gate <https://en.wikipedia.org/wiki/XOR_gate>`__
| `De Morgan duality <https://en.wikipedia.org/wiki/De_Morgan%27s_laws>`__

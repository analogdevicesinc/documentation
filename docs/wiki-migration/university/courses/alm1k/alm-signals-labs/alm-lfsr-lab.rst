...
| `XOR_gate <https://en.wikipedia.org/wiki/XOR_gate>`__
| `Shift_register <https://en.wikipedia.org/wiki/Shift_register>`__
| `Linear_feedback_shift_register <https://en.wikipedia.org/wiki/Linear_feedback_shift_register>`__

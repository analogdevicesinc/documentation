...
| `Noise\_(electronics) <https://en.wikipedia.org/wiki/Noise_(electronics)>`__
...
-  Our patient and thorough reviewers at `SciPy Proceedings Github <https://github.com/scipy-conference/scipy_proceedings>`__

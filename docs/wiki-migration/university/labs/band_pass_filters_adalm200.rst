...
You can see the solution by using this link to `Wolfram Alpha <https://www.wolframalpha.com/input/?i=x%5E2+-+%281%2F%2815.2*1000*0.000000047%29%29x+-+%281%2F%2839.4*0.01*0.000000047%29%29>`__. The solution (roots) to the equation are :math:`x_1=-6681` and :math:`x_2=8081` . The negative sign can be ignored and this gives the lower and upper cut-off frequency:

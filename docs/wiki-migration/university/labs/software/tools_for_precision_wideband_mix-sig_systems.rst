...
-  Clone or download zip of the Python code for this tutorial from: `Python Code for the Hardware and Software Tools for Precision Wideband Instrumentation Workshop <https://github.com/cristina-suteu/ftc23-hstpwi/>`__
...
| :doc:`Tools for Low Speed Mixed Signal System Design </wiki-migration/university/labs/software/tools_for_low_speed_mix-sig_systems>`
...
.. admonition:: Download
   ...
   `Tools for Low-Speed Mixed Signal System Design Slide Deck <https://wiki.analog.com/_media/university/labs/software/tools_for_precision_wideband_mix-sig_systems/tools_for_precision_wideband_instrumentation_workshop.pptx>`__

...
For those attending the :adi:`PlutoSDR` workshop at European GNU Radio Days 2019, hosted by `ADI <adi>>`__, thanks. In order to make your experience better (less installing software while others are using the hardware) please have the following software installed on your machine:
...
`Pluto Labs <https://wiki.analog.com/_media/plutotutorial.zip>`__

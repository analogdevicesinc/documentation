...
-  Download the latest release zip from `this page <https://github.com/juchong/ADIS16470-RoboRIO-Driver/releases>`__. The zip will be named adis16470_roborio-[releaseversion].zip.

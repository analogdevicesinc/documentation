...
| ===== Installing the Library ===== First you need to install the library so that you can use the IMU in your code. You can find the library on GitHub `here <https://github.com/juchong/ADIS16470-RoboRIO-Driver/tree/master/LabVIEW>`_. New for 2020, the ADIS16470 LabVIEW libraries can only be installed via the NI Package Manager.

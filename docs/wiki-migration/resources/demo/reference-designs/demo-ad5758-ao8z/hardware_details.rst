...
For a complete list of diagnostics, see the :adi:`AD5758` datasheet. The :adi:`AD5758` also incorporates a 12-bit ADC to provide diagnostic measurements on user-selectable nodes, such as internal supplies and grounds, internal die temperature monitors, internal references among other signals. The :adi:`AD5758` has a C\ :sub:`HART` pin, onto which a `HART <https://www.fieldcommgroup.org/technologies/hart>`__ signal can be capacitively coupled. Once HART connectivity is enabled, the HART signal appears on the VIOUT pin. This functionality is only available when VIOUT is configured to output current.

Schematic
~~~~~~~~~

`Schematic PDF <https://wiki.analog.com/_media/resources/demo/reference-designs/demo-ad5758-ao8z/demo-ad5757-ao8z/02_047243c_top.pdf>`__
...
`PDF <https://wiki.analog.com/_media/resources/demo/reference-designs/demo-ad5758-ao8z/demo-ad5758-ao8z/08-047243-01-b.pdf>`__

Bill of Materials
~~~~~~~~~~~~~~~~~

`PDF <https://wiki.analog.com/_media/resources/demo/reference-designs/demo-ad5758-ao8z/demo-ad5758-ao8z/05-047243-01-b.pdf>`__
...
`Top <https://wiki.analog.com/../ad5758_adp1031>`__ \| `Previous(Specifications) <https://wiki.analog.com/specifications>`__ \| `Next(Software) <https://wiki.analog.com/software>`__

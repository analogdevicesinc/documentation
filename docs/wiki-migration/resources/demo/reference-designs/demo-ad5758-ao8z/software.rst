...
-  Hold down S2 (Boot) button while briefly pressing the S1 (Reset) button. Then release S2. (See Figure 1) //This sequence is important//. \\ |Reset and Boot buttons| \\ //Figure 1 - **Reset** and **Boot** buttons//

...
If you want to use this CRC driver via the Linux kernel crypto API, please refer to the generic `Linux Kernel Crypto API <http://www.chronox.de/crypto-API/>`__ document . 

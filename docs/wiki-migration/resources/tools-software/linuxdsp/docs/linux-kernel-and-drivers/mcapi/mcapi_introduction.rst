...
The MCAPI example for ARM core (Running Linux) is included in the YOCTO, and you can get the MCAPI example for SHARC+ Cores from the gitbub `lnxdsp-examples <https://bitbucket.analog.com/projects/DTE/repos/lnxdsp-examples>`__

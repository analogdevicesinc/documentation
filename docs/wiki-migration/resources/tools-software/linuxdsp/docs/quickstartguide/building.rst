...
Linux for SC5xx uses `Yocto <https://www.yoctoproject.org/software-overview/>`__ to build and package all the components required for you to install Linux on your development board and build your own applications.

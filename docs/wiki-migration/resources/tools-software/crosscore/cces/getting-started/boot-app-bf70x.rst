...
`Creating Bootable Applications#.app|Creating Bootable Applications#boot-app-bf60x|Creating a Boot Image (ADSP-BF60x) <https://wiki.analog.com/_media/navigation CCES Getting Started#.app>`__

...
For background detail and theory, see `FIR Filter Algorithm <https://wiki.analog.com/resources/tools-software/sigmastudio/algorithminformation/firfilter>`__.

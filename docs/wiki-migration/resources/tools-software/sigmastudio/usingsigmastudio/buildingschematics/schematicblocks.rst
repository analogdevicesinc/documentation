...
| Some blocks include pop-up control windows providing advanced functionality, for example the `General (2nd Order) filter <https://wiki.analog.com/resources/tools-software/sigmastudio/filters/general2ndorder>`__. To open a block's advanced control window, click on the icon button.
| |schemblockpic9.png|

...
| To view/hide control parameter names for any schematic, the "View Control Parameters Names"/ "Hide Control Parameter Names" option in the Action menu has to selected as shown below. |image1|

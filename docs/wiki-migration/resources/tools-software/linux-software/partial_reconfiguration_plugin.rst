...
| The Partial Reconfiguration plugin works with the `IIO Oscilloscope <https://wiki.analog.com/iio_oscilloscope>`__. You always use the latest version if possible.

...
If you think the device has a setting that isn't managed by this tab, check out the `AD9371 Advanced Plugin <https://wiki.analog.com/ad9371_advanced_plugin>`__ for the IIO Oscilloscope.

...
If you think the device has a setting that isn't managed by this tab, check out the `AD936X Advanced Plugin <https://wiki.analog.com/fmcomms2_advanced_plugin>`__ for the IIO Oscilloscope.

...
The Colorimeter application has three main tabs `#automated_data_collection <https://wiki.analog.com/>`__, `absorbance_measurement <https://wiki.analog.com/>`__ and the `#sample_library <https://wiki.analog.com/>`__.
...
The source code for the Colorimeter application can be found on the `Analog Devices GitHub account <https://github.com/orgs/analogdevicesinc>`__ in the `colorimeter repository <https://github.com/analogdevicesinc/colorimeter>`__.
...
-  :adi:`CN0363` + `ZED Board <http://zedboard.org/product/zedboard>`__, Rev C or later

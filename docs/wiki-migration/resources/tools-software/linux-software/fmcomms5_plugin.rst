...
If you think the device has a setting that isn't managed by this tab, check out the `fmcomms5 Advanced Plugin <https://wiki.analog.com/fmcomms2_advanced_plugin>`__ for the IIO Oscilloscope.

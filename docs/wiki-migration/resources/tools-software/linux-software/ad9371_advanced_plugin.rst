...
The AD9371 Advanced Plugin allows testing of different device driver initialization options and values. In contrast to the controls on the `AD9371/AD9375 Main Plugin <https://wiki.analog.com/ad9371_plugin>`__ – the controls here are not part of the main driver API.

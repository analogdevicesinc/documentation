...
Devices specific examples are available in the :git-pyadi-iio:`source repo <examples>`, and the `sphinx doc <https://analogdevicesinc.github.io/pyadi-iio/>`__, but here is the basic idea
...
-  All PyADI-IIO documentation is available on `GitHub <https://analogdevicesinc.github.io/pyadi-iio>`__.

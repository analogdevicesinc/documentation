...
Currently the SigmaDSP Firmware Utility for Linux only runs on a Linux system and can be downloaded from `here <https://raw.githubusercontent.com/analogdevicesinc/sigmadsp-genfirmware/master/sigmadsp_fwgen>`__.

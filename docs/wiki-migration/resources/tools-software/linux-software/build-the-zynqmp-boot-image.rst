...
-  `Build PMU Firmware <http://www.wiki.xilinx.com/Build+PMU+Firmware>`__
...
-  Path to ``system_top.xsa`` and ``u-boot.elf`` are required parameters.
   ...
   -  To find ``system_top.xsa``, see `Building HDL <https://analogdevicesinc.github.io/hdl/user_guide/build_hdl.html>`__. After building a project in the HDL repository, it can be found inside a **<project>\_<board>.sdk** folder.

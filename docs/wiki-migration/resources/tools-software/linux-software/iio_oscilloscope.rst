...
-  Install the ``libiio-dev`` package in Debian or Ubuntu or build and install the libiio library from source, by following `these instructions <https://wiki.analog.com/libiio>`__. Make sure you do the final ``make install``.

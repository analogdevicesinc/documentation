...
``iio_info`` is part of the `Libiio <https://wiki.analog.com/../libiio>`__ package, a library that has been developed to ease the development of software interfacing Linux Industrial I/O (IIO) devices. There are four main userspace helper/utilities:

...
.. important::
   ...
   This software is `deprecated <https://en.wikipedia.org/wiki/Deprecation>`__ and is no longer supported/tested. It is described here for historical purposes only. If you have questions, please try things out with `IIO Scope <https://wiki.analog.com/../../iio_oscilloscope>`__, or ask questions on :ez:`EngineerZone <linux-device-drivers/linux-software-drivers>`.
...
.. admonition:: Download
   ...
   -  `IIO Plugin installer (old) <http://swdownloads.analog.com/cse/va/VA_IIOPluginSetup.exe>`__
   -  `IIO Plugin for Visual Analog <https://wiki.analog.com/_media/resources/tools-software/linux-software/libiio/clients/va_iiopluginsetup.zip>`__
...
-  Run the Visual Analog IIO Plugin installer available in the `Downloads <https://wiki.analog.com/>`__ section.

...
The source code for the diagnostic report tool can be downloaded from the `Analog Devices GitHub account <https://github.com/orgs/analogdevicesinc/dashboard>`__ `diagnostic_report repository <https://github.com/analogdevicesinc/diagnostic_report>`__.

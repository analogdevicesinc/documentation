...
-  Download the `audio_processing.zip <https://wiki.analog.com/_media/resources/tools-software/sharc-audio-module/baremetal/audio_processing.zip>`__ and extract it into the project you just created with the New Project Wizard. You should now have a folder called ``audio_processing/`` in your project.

...
`Bare Metal Framework#.|Bare Metal Framework#downloading-and-installing|Opening the Framework in CCES <https://wiki.analog.com/_media/navigation SHARC Audio Module#.>`__

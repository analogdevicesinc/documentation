...
`Hardware Reference#.|Faust and the SHARC Audio Module#ex-work-reverb|MIDI Controlled Referb <https://wiki.analog.com/_media/navigation SHARC Audio Module#..hardware>`__

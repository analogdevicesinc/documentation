...
`Application Examples - Ethernet Audio Static IP#.|Advanced Audio Projects#.examples-a2b-audio|Application Examples - A2B Audio <https://wiki.analog.com/_media/navigation Advanced Audio Projects#.examples-ethernet-audio>`__

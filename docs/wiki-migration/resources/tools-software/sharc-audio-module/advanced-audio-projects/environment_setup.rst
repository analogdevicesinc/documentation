...
`Prerequisites#.|Advanced Audio Projects#.program-flash|Bootloader and Application Flash <https://wiki.analog.com/_media/navigation Advanced Audio Projects#.prerequisites>`__

...
`Application Examples - USB Audio#.|Advanced Audio Projects#.examples-ethernet-audio|Application Examples - Ethernet Audio Static IP <https://wiki.analog.com/_media/navigation Advanced Audio Projects#.examples-usb-audio>`__

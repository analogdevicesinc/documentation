...
`Using Hardware Peripherals#..micropython|MicroPython Overview#.building|Building MicroPython with CCES <https://wiki.analog.com/_media/navigation SHARC Audio Module#.peripherals>`__

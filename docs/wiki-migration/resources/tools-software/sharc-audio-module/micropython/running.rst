...
`Faust and the SHARC Audio Module#..micropython|MicroPython Overview#.peripherals|Using Hardware Peripherals <https://wiki.analog.com/_media/navigation SHARC Audio Module#..faust>`__

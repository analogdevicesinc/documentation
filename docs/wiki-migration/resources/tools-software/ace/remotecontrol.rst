...
Download Python and Jupyter Notebook versions of this example: `large_capture_example.zip <https://wiki.analog.com/_media/resources/tools-software/ace/large_capture_example.zip>`__
...
`labview_2015_demo.zip <https://wiki.analog.com/_media/resources/tools-software/ace/remote-control/labview_2015_demo.zip>`__

Running the Basic Example for ADuCM302x EZ-Kit with IAR Embedded Workbench
==========================================================================
...
1. Select the **Add Existing Project** from the **Project Menu** and browse to the **FreeRTOSv10.0.0\\FreeRTOS\\Demo\\CORTEX_M3_ADuCM302x_IAR\\iar** folder within the FreeRTOS product directory and import the project

2. Choose Debug/Release mode to build the project.

.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-aducm302x-ez-kit/3029-iar-debug-release.png
   :width: 400px
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-aducm302x-ez-kit/infocentre.png
   :width: 600px
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-aducm302x-ez-kit/3029iar_output.png
   :width: 400px

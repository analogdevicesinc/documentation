Running the LwIP Example for ARM on ADSP-SC589 EZ-Kit with CrossCore Embedded Studio
====================================================================================
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc589-ez-kit/lwipsc589/hw.jpg
   :width: 400px
...
-  Browse the root folder where you previously installed the FreeRTOS product and then browse down into the **FreeRTOSv10.0.0\\FreeRTOS\\Demo\\CORTEX_A5_ADSP_SC589_CCES_LwIP** folder
-  Click **Finish** to close the file browser dialog
-  A single project should appear in the **Project Explorer**

.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc589-ez-kit/lwipsc589/import.png
   :width: 400px

2. Choose Debug/Release mode to build the project.

.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc589-ez-kit/lwipsc589/release.png
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc589-ez-kit/lwipsc589/debug.png
   :width: 1000px

3. Click the **Debug** button to close the **Debug Configuration** window

.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc589-ez-kit/lwipsc589/debug_2.png
   :width: 1000px

4. Click the **Run/Resume** button to start running your application

.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc589-ez-kit/lwipsc589/resume.png
   :width: 400px
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc589-ez-kit/lwipsc589/output.png
   :width: 600px

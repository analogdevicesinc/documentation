Running the LwIP Example for ARM on ADSP-SC584 EZ-Kit with CrossCore Embedded Studio
====================================================================================
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc584-ez-kit/lwip/584-lwip-hw.jpg
   :width: 400px
...
-  Browse the root folder where you previously installed the FreeRTOS product and then browse down into the \**FreeRTOSv10.0.0\\FreeRTOS\\Demo\\CORTEX_A5_ADSP_SC584_CCES_LwIP \*\* folder
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc584-ez-kit/lwip/lwip_import.png
   :width: 400px

2. Choose Debug/Release mode to build the project.

.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc584-ez-kit/lwip/3.png
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc584-ez-kit/lwip/584lwip_debug_conf.png
   :width: 1000px

3. Click the **Debug** button to close the **Debug Configuration** window

.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc584-ez-kit/lwip/584lwip_debug_conf2.png
   :width: 1000px

4. Click the **Run/Resume** button to start running your application

.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc584-ez-kit/lwip/584lwip_resume.png
   :width: 600px
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/freertos/rtos-user-guide/running-examples-adsp-sc584-ez-kit/lwip/584lwip_output.png
   :width: 600px

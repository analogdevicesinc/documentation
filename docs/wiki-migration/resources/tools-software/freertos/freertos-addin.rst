...
The **FreeRTOS Add-In** contains a custom built **UI** that users can easily use to configure values for :doc:`Supported FreeRTOS Configuration Macros </wiki-migration/resources/tools-software/freertos/freertos-addin/supported-macros>`, this can be seen in the image below.
...
-  `FreeRTOS Add-In From the Command Line <https://wiki.analog.com/resources/tools-software/freertos/freertos-addin/tools/freertos-add-in-from-the-command-line>`__

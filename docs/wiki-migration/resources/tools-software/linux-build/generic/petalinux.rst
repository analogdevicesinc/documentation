...
+===================+==============================================================================================+============================================================================+
| 2018.2            | `2018_R2 <https::`ADI Yocto repository </github.com/analogdevicesinc/meta-adi/tree/2018_R2>` | `README <https://github.com/meta-adi?2018_R2/meta-adi-xilinx/README.md>`__ |
+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| 2018.3            | :git-meta-adi:`tree/2019_R1`                                                                 | `README <https://github.com/meta-adi?2019_R1/meta-adi-xilinx/README.md>`__ |
+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| 2019.1            | :git-meta-adi:`tree/2019_R2`                                                                 | `README <https://github.com/meta-adi?2019_R2/meta-adi-xilinx/README.md>`__ |
+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| 2021.1            | :git-meta-adi:`tree/2021_R1`                                                                 | `README <https://github.com/meta-adi?2021_R1/meta-adi-xilinx/README.md>`__ |
+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| 2021.2            | :git-meta-adi:`tree/master`                                                                  | `README <https://github.com/meta-adi?master/meta-adi-xilinx/README.md>`__  |
+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+

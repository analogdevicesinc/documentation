...
| Function        | File                                                                                                                                         |
+=================+==============================================================================================================================================+
| RPI Device Tree | :git-linux:`arch/arm/boot/dts/overlays/rpi-adar1000-overlay.dts`                                                                             |
+-----------------+----------------------------------------------------------------------------------------------------------------------------------------------+
...
| in_voltage0\_[…]: targets RX1
| in_voltage1\_[…]: targets RX2
| out_voltage0\_[…]: targets TX1
| out_voltage1\_[…]: targets TX2
|

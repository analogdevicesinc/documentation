...
| Source                                                                                             | Mainlined?                                                                                        |
+====================================================================================================+===================================================================================================+
| :git-linux:`git <drivers/iio/adc/navassa/adrv9002.c>`                                              | :git-linux:`No <drivers/iio/adc/navassa/adrv9002.c>`                                              |
+----------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------+
...
| Function           | File                                                                                                                                              |
+====================+===================================================================================================================================================+
| driver             | :git-linux:`drivers/iio/adc/navassa/adrv9002.c`                                                                                                   |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| driver             | :git-linux:`drivers/iio/adc/navassa/adrv9002_conv.c`                                                                                              |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| driver             | :git-linux:`drivers/iio/adc/navassa/adrv9002_debugfs.c`                                                                                           |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| include            | :git-linux:`drivers/iio/adc/navassa/adrv9002.h`                                                                                                   |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| Navassa API driver | :git-linux:`drivers/iio/adc/navassa/devices/adrv9001/ <drivers/iio/adc/navassa/devices/adrv9001>`                                                 |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| Navassa API driver | :git-linux:`drivers/iio/adc/navassa/third_party`                                                                                                  |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| Navassa API driver | :git-linux:`drivers/iio/adc/navassa/common`                                                                                                       |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| Navassa API driver | :git-linux:`drivers/iio/adc/navassa/platforms`                                                                                                    |
+--------------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
...
+----------+---------------------------------------------------------------------------------------------------------------------------------+
| driver   | :git-linux:`drivers/iio/adc/ad_adc.c <drivers/iio/adc/cf_axi_adc_core.c>`                                                       |
+----------+---------------------------------------------------------------------------------------------------------------------------------+
...
-  :doc:`ADRV9001/ADRV9002 Device Driver Customization </wiki-migration/resources/tools-software/linux-drivers/iio-transceiver/adrv9002-customization>`
...
| Function | File                                                                                                                |
+==========+=====================================================================================================================+
| Stream   | :git-linux:`firmware/Navassa_Stream.bin`                                                                            |
+----------+---------------------------------------------------------------------------------------------------------------------+

For early versions of TES (before v0.14) streams were only made available in text form. However, the driver requires binary streams. To create the necessary binary stream, (1) generated the C Sample Code from TES and (2) pass the initialize.c file produced to this `python helper script <https://gist.github.com/tfcollins/c60f9d360454dfec3f87e3024a760d3f>`_. This python script will extract the stream array and convert it to a binary file for the driver to consume.
...
| Function     | File                                                                                                                              |
+==============+===================================================================================================================================+
| ARM firmware | `firmware/Navassa_EvaluationFw.bin <https://github.com/analogdevicesinc/linux/blob/adrv9001/firmware/Navassa_EvaluationFw.bin>`_  |
+--------------+-----------------------------------------------------------------------------------------------------------------------------------+
...
| Function                  | File                                                                                                                                          |
+===========================+===============================================================================================================================================+
| RX Gain Correction table  | :git-linux:`firmware/RxGainTable.csv`                                                                                                         |
+---------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
| RX Gain Compensated table | :git-linux:`firmware/RxGainTable_GainCompensated.csv`                                                                                         |
+---------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
| ORX Gain table            | :git-linux:`firmware/ORxGainTable.csv`                                                                                                        |
+---------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
| TX Gain table             | :git-linux:`firmware/TxAttenTable.csv`                                                                                                        |
+---------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
...
| Function                  | File                                                                                                                                                                   |
+===========================+========================================================================================================================================================================+
| ADRV9002 Device Tree      | :git-linux:`arch/arm64/boot/dts/xilinx/zynqmp-zcu102-rev10-adrv9002.dts`                                                                                               |
+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                           | :git-linux:`arch/arm/boot/dts/zynq-zed-adv7511-adrv9002.dts`                                                                                                           |
+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                           | :git-linux:`arch/arm/boot/dts/zynq-zc706-adv7511-adrv9002.dts`                                                                                                         |
+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ADRV9002 Device Tree MIMO | :git-linux:`arch/arm64/boot/dts/xilinx/zynqmp-zcu102-rev10-adrv9002-rx2tx2.dts`                                                                                        |
+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                           | :git-linux:`arch/arm/boot/dts/zynq-zed-adv7511-adrv9002-rx2tx2.dts`                                                                                                    |
+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                           | :git-linux:`arch/arm/boot/dts/zynq-zc706-adv7511-adrv9002-rx2tx2.dts`                                                                                                  |
+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                           | :git-linux:`arch/arm/boot/dts/socfpga_arria10_socdk_adrv9002_rx2tx2.dts`                                                                                               |
+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
compatible          Mode
=================== ===========
adi,adrv9002-rx2tx2 MIMO
adi,adrv9002        Independent
=================== ===========
...
.. tip::
   ...
   -  :doc:`ADRV9002 Control IIO Scope Plugin </wiki-migration/resources/tools-software/linux-software/adrv9002_plugin>`
...
out_voltage0\_[…]                 TX1
out_voltage1\_[…]                 TX2
out_altvoltage0\_[…]              RX1 LO
out_altvoltage1\_[…]              RX2 LO
out_altvoltage2\_[…]              TX1 LO
out_altvoltage3\_[…]              TX2 LO
================================= ==================
...
There are some constraints with the loaded profiles due to the architecture of the :git-hdl:`reference design <projects/adrv9001>`:

.. warning::

   TX cannot be enabled if the corresponding RX is also not enabled (eg: TX2 enabled and RX2 disabled). The driver will reject such a profile. The reason is that the TX SSI clock is derived from RX. This applies for all :doc:`device modes! </wiki-migration/resources/tools-software/linux-drivers/iio-transceiver/adrv9002>`\
...
+-----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| automatic | The AGC will determine when gain changes should be made. To setup the AGC block there are a vast number of properties the user can configure. This is done through devicetree. More info at :doc:`ADRV9001/ADRV9002 Device Driver Customization </wiki-migration/resources/tools-software/linux-drivers/iio-transceiver/adrv9002-customization>` |
+-----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| pin       | The gain is controlled trough external pins. The user can also select which pins to use through devicetree. More in :doc:`ADRV9001/ADRV9002 Device Driver Customization </wiki-migration/resources/tools-software/linux-drivers/iio-transceiver/adrv9002-customization>`                                                                         |
+-----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
The ADRV9002 driver supports advanced debug controls via the kernel `debugfs <https://en.wikipedia.org/wiki/debugfs>`_. These controls are mostly to debug which settings are currently configured in the device. How these device files/controls can be used is described here.

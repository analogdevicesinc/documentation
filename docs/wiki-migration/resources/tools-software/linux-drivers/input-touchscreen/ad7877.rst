...
|ad7877_block_dia.png| |ad7877_input_structure.png|

*See also:* `uclinux-dist:tslib <https://analogdevicesinc.github.io/uclinux-dist:tslib>`__

*See also:* `AD7879 Touchscreen Device Driver <https://wiki.analog.com/ad7879>`__
...
| Source                                                                                                               | Mainlined?                                                                                                           |
+======================================================================================================================+======================================================================================================================+
| `git <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/input/touchscreen/ad7877.c>`__ | `Yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/input/touchscreen/ad7877.c>`__ |
+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
...
| Function | File                                                                                                                      |
+==========+===========================================================================================================================+
| driver   | `ad7877.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/input/touchscreen/ad7877.c>`__ |
+----------+---------------------------------------------------------------------------------------------------------------------------+
| include  | `ad7877.h <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/include/linux/spi/ad7877.h>`__         |
+----------+---------------------------------------------------------------------------------------------------------------------------+
...
<source trunk/arch/blackfin/mach-bf537/boards/pnav10.c:spi_ad7877_chip_info{} c linux-kernel> <source trunk/arch/blackfin/mach-bf537/boards/pnav10.c:bfin_ad7877_ts_info{} c linux-kernel>
...
.. image:: https://wiki.analog.com/_media/software/driver/linux/ad7877_example_schematic.png
   :alt: ad7877_example_schematic.png
   :width: 800px
...
See the `uclinux-dist:tslib <https://analogdevicesinc.github.io/uclinux-dist:tslib>`__ page for information on testing the touchscreen from userspace.
...
.. |ad7877_block_dia.png| image:: https://wiki.analog.com/_media/software/driver/linux/ad7877_block_dia.png
.. |ad7877_input_structure.png| image:: https://wiki.analog.com/_media/software/driver/linux/ad7877_input_structure.png

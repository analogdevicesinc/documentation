...
-  :doc:`AD9081/AD9082 Prototyping Platform User Guide </wiki-migration/resources/eval/user-guides/ad9081_fmca_ebz>`
-  :doc:`Quad-MxFE Prototyping Platform User Guide </wiki-migration/resources/eval/user-guides/quadmxfe>`
...
For more information about the AD9081 or AD9082, contact Analog Devices, Inc., at: `mxfesupport@analog.com <https://wiki.analog.com/mxfesupport@analog.com>`__.
...
| Source                                                                                                        | Mainlined?                                                                                                |
+===============================================================================================================+===========================================================================================================+
| :git-linux:`drivers/iio/adc/ad9081.c`                                                                         | `No <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/adc/ad9081.c>`__ |
+---------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
...
| 
| .. include:: ../../../eval/user-guides/ad9081_fmca_ebz/quickstart/zynq.rst

.. include:: ../../../eval/user-guides/ad9081_fmca_ebz/quickstart/microblaze.rst
...
**Documentation:** :doc:`AXI DAC HDL Linux Driver </wiki-migration/resources/tools-software/linux-drivers/iio-dds/axi-dac-dds-hdl>`
...
-  `JESD204B/C Transmit Linux Driver <https://wiki.analog.com/[resources/tools-software/linux-drivers/jesd204/axi_jesd204_tx>`__
...
.. _main-data-paths-adimain-data-paths-1:
...
.. _channelizer-paths-adichannelizer-paths-1:
...
.. _per-channel-properties-channeln-1:
...
Please see also :doc:`NCO Frequency Control </wiki-migration/resources/tools-software/linux-drivers/iio-mxfe/ad9081>` section.
...
The parser can be found here: :git-linux:`ad9081_parse_fir <drivers/iio/adc/ad9081.c#L2430-L2647>`
...
Writing ``bist_prbs_select_jrx`` selects the `PRBS <https://en.wikipedia.org/wiki/PRBS>`__ type. (accepted values depend on the GT architecture). Reading returns the selected type.

.. tip::

   When testing this feature make sure :doc:`axi_adxcvr-tx prbs_select </wiki-migration/resources/tools-software/linux-drivers/jesd204/axi_adxcvr>` is configured with a matching PRBS.
...
Writing ``bist_prbs_select_jtx`` selects the `PRBS <https://en.wikipedia.org/wiki/PRBS>`__ type. (accepted values depend on the GT architecture). Reading returns the selected type.
...
.. tip::
   ...
   When using HALF_RATE mode make sure :doc:`axi_adxcvr-tx prbs_select </wiki-migration/resources/tools-software/linux-drivers/jesd204/axi_adxcvr>` is configured with a matching PRBS.
...
Example from: `pyadi-iio <https://github.com/pyadi-iio>`__

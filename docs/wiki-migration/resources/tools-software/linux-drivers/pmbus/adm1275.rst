...
The `PMBus Core Driver <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/hwmon/pmbus/pmbus_core.c?id=HEAD>`__ provides a common driver for PMBus compliant devices. The adm1275 Linux driver is built on top of this core driver and provides adm1xxx specific functions and attributes on top of the ones provided by the core.

Other PMBus related references include, but not limited to, the following:

`PMBus Core API <https://www.kernel.org/doc/html/v5.7/hwmon/pmbus-core.html>`__

`PMBus Source <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/hwmon/pmbus/pmbus.c?id=HEAD>`__

`PMBus Header <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/hwmon/pmbus/pmbus.h?id=HEAD>`__

`PMBus Documentation <https://docs.kernel.org/hwmon/pmbus.html>`__
...
| Source                                                                                                                                    | Mainlined?                                                                                                      |
+===========================================================================================================================================+=================================================================================================================+
| `drivers/hwmon/pmbus/adm1275.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/hwmon/pmbus/adm1275.c>`__ | `yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/hwmon/pmbus/adm1275.c>`__ |
+-------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
...
| Function | File                                                                                                                                      |
+==========+===========================================================================================================================================+
| driver   | `drivers/hwmon/pmbus/adm1275.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/hwmon/pmbus/adm1275.c>`__ |
+----------+-------------------------------------------------------------------------------------------------------------------------------------------+

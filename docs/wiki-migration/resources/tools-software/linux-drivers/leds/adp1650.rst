...
.. image:: https://wiki.analog.com/_media/scrape>adi>ADP1650#additional-details__paragraph
   :alt: scrape>adi>ADP1650#additional-details\__paragraph

-  :adi:`Product Page <ADP1650>`
...
| Source                                                                                 | Mainlined?                                                                                                            |
+========================================================================================+=======================================================================================================================+
| :git-linux-kernel?drivers:`git <leds/leds-adp1650.c>`                                  | `In Progress <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/leds/leds-adp1650.c>`__ |
+----------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------+
...
| Function | File                                                                                                                                 |
+==========+======================================================================================================================================+
| driver   | `drivers/leds/leds-adp1650.c <http://blackfin.uclinux.org/git/?p=linux-kernel;a=blob_plain;f=drivers/leds/leds-adp1650.c;hb=HEAD>`__ |
+----------+--------------------------------------------------------------------------------------------------------------------------------------+
| include  | `include/linux/i2c/adp1650.h <http://blackfin.uclinux.org/git/?p=linux-kernel;a=blob_plain;f=include/linux/i2c/adp1650.h;hb=HEAD>`__ |
+----------+--------------------------------------------------------------------------------------------------------------------------------------+
...
.. note::
   ...
   **platform_data: Platform data specific to the ADP1650 device.**
   ...
   Please see `include/linux/i2c/adp1650.h <http://blackfin.uclinux.org/git/?p=linux-kernel;a=blob_plain;f=include/linux/i2c/adp1650.h;hb=HEAD>`__ for details.
...
For more information read `leds-class.txt <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/linux/Documentaion/leds-class.txt>`__

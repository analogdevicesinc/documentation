...
-  `MAX11205 <https://www.maximintegrated.com/MAX11205>`__
...
| Source                                                                                                                        | Mainlined?                                                                                                                                                  |
+===============================================================================================================================+=============================================================================================================================================================+
| `git <https://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git/tree/drivers/iio/adc/max11205.c?h=next-20220923>`__ | `Accepted, waiting for integration <https://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git/tree/drivers/iio/adc/max11205.c?h=next-20220923>`__ |
+-------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| Function      | File                                                                                                                                                                             |
+===============+==================================================================================================================================================================================+
| driver        | `drivers/iio/adc/max11205.c <https://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git/tree/drivers/iio/adc/max11205.c?h=next-20220923>`__                             |
+---------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Documentation | `maxim,max11205.yaml <https://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git/tree/Documentation/devicetree/bindings/iio/adc/maxim,max11205.yaml?h=next-20220923>`__ |
+---------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| **Description:**
| Raw measurement of voltage on channel 0.
...
| **Description:**
| Scale to be applied to the raw measurement of voltage on channel 0 in order to obtain the actual voltage.

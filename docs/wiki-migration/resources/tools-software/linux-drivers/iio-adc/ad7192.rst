...
| Function | File                                                                                                                     |
+==========+==========================================================================================================================+
| driver   | `ad7192.c <https://git.kernel.org/pub/scm/linux/kernel/git/staging/staging.git/tree/drivers/staging/iio/adc/ad7192.c>`_  |
+----------+--------------------------------------------------------------------------------------------------------------------------+
| include  | `ad7192.h <https://git.kernel.org/pub/scm/linux/kernel/git/staging/staging.git/tree/drivers/staging/iio/adc/ad7192.h>`_  |
+----------+--------------------------------------------------------------------------------------------------------------------------+

...
| Source                                                                            | Mainlined? |
+===================================================================================+============+
| :git-linux:`git <iio/adc/ad738x.c>`                                               | Yes        |
+-----------------------------------------------------------------------------------+------------+
...
| Function            | File                                                                                                                                                                       |
+=====================+============================================================================================================================================================================+
| driver              | `ad7380.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/adc/ad7380.c>`__                                                            |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| devicetree bindings | `adi,ad7380.yaml <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/devicetree/bindings/iio/adc/adi,ad7380.yaml>`__                    |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| documentation       | `ad7380.rst <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/iio/ad7380.rst>`__ (`html <https://docs.kernel.org/iio/ad7380.html>`__) |
+---------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
| **Description:**
| offset to be applied to in_voltage0_raw in order to obtain the measured voltage in millivolts.
...
This driver can be used in two different ways. In order to be able to achieve the maximum sample rate (e.g. 4 MSPS), it needs to be used with a specialized SPI controller that supports offloading. And example of such a SPI controller can be found in the `example AD738x-FMC HDL project <https://analogdevicesinc.github.io/hdl/projects/ad738x_fmc/index.html>`__. It can also be used with conventional SPI controllers, but sampling rate will be limited by the software and hardware capabilities of the system it is running on.

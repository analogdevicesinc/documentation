ADF4030 IIO 10-Channel Precision Synchronizer Linux Driver
==========================================================
...
.. image:: https://wiki.analog.com/_media/scrape>adi>ADF4030#additional-details__paragraph
   :alt: scrape>adi>ADF4030#additional-details\__paragraph
...
| Source                                                                                                                      | Mainlined?                                                                                                        |
+=============================================================================================================================+===================================================================================================================+
| :git-linux:`drivers/iio/frequency/adf4030.c`                                                                                | `WIP <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/frequency/adf4030.c>`__ |
+-----------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------+
...
| Function          | File                                                                                                                                                  |
+===================+=======================================================================================================================================================+
| driver            | :git-linux:`drivers/iio/frequency/adf4030.c`                                                                                                          |
+-------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------+
| Documentation     | :git-linux:`Documentation/devicetree/bindings/iio/frequency/adi,adf4030.yaml`                                                                         |
+-------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------+
| ABI documentation | :git-linux:`Documentation/ABI/testing/sysfs-bus-iio-frequency-adf4030`                                                                                |
+-------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------+
...
Value Mode
===== ======================
``0`` Run 1 alignment cycle
``1`` Run 2 alignment cycles
``2`` Run 3 alignment cycles
``3`` Run 4 alignment cycles
``4`` Run 5 alignment cycles
``5`` Run 6 alignment cycles
``6`` Run 7 alignment cycles
``7`` Run 8 alignment cycles
===== ======================

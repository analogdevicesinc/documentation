...
| Source                                                                                                  | Mainlined?                                                                                              |
+=========================================================================================================+=========================================================================================================+
| `git <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/mfd/adp5520.c>`__ | `Yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/mfd/adp5520.c>`__ |
+---------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+
...
| Function  | File                                                                                                                                      |
+===========+===========================================================================================================================================+
| MFD-CORE  | `adp5520.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/mfd/adp5520.c>`__                             |
+-----------+-------------------------------------------------------------------------------------------------------------------------------------------+
| include   | `adp5520.h <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/include/linux/mfd/adp5520.h>`__                       |
+-----------+-------------------------------------------------------------------------------------------------------------------------------------------+
| BACKLIGHT | `adp5520_bl.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/video/backlight/adp5520_bl.c>`__           |
+-----------+-------------------------------------------------------------------------------------------------------------------------------------------+
| LED       | `leds-adp5520.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/led/leds-adp5520.c>`__                   |
+-----------+-------------------------------------------------------------------------------------------------------------------------------------------+
| GPIO      | `adp5520-gpio.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/gpio/adp5520-gpio.c>`__\  [3]_           |
+-----------+-------------------------------------------------------------------------------------------------------------------------------------------+
| KEYPAD    | `adp5520-keys.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/input/keyboard/adp5520-keys.c>`__\  [4]_ |
+-----------+-------------------------------------------------------------------------------------------------------------------------------------------+
...
.. tip::
   ...
   Please refer to `adp5520.h <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/include/linux/mfd/adp5520.h>`__ for detailed configuration defines.
...
<source trunk/arch/blackfin/mach-bf537/boards/stamp.c:adp5520_keymap[] c linux-kernel> <source trunk/arch/blackfin/mach-bf537/boards/stamp.c:adp5520_keys_data{} c linux-kernel>
...
<source trunk/arch/blackfin/mach-bf537/boards/stamp.c:adp5520_pdev_data{} c linux-kernel> <source trunk/arch/blackfin/mach-bf537/boards/stamp.c:/CONFIG_PMIC_ADP5520/2-/#if/ c linux-kernel>
...
.. image:: https://wiki.analog.com/_media/software/driver/linux/adp5520_brd.jpg
...
*For more information on Backlight handling in Linux read:* `sysfs-class-backlight <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/ABI/stable/sysfs-class-backlight>`__
...
*For more information on LEDs handling in Linux read:* `leds-class.txt <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/leds-class.txt>`__
...
*For more information on GPIO handling in Linux read:* `gpio.txt <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/gpio.txt>`__
...
*For more information on Input handling in Linux read:* `input.txt <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/input/input.txt>`__

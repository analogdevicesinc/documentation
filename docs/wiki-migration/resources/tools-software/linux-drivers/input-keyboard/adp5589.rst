...
-  :adi:`ADP5589CP-EVALZ`
-  :adi:`ADP5585CP-EVALZ`
-  `PMOD-IOXP <http://digilentinc.com/Products/Detail.cfm?NavPath=2,401,960&Prod=PMOD-IOXP>`__
...
.. image:: https://wiki.analog.com/_media/scrape>adi>adp5589#additional-details__paragraph
   :alt: scrape>adi>adp5589#additional-details\__paragraph

ADP5585
~~~~~~~

.. image:: https://wiki.analog.com/_media/scrape>adi>adp5585#additional-details__paragraph
   :alt: scrape>adi>adp5585#additional-details\__paragraph
...
| Source                                                                                                                  | Mainlined?                                                                                                              |
+=========================================================================================================================+=========================================================================================================================+
| `git <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/input/keyboard/adp5589-keys.c>`__ | `Yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/input/keyboard/adp5589-keys.c>`__ |
+-------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
...
| Function | File                                                                                                                               |
+==========+====================================================================================================================================+
| driver   | `adp5589-keys.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/input/keyboard/adp5589-keys.c>`__ |
+----------+------------------------------------------------------------------------------------------------------------------------------------+
| include  | `adp5589.h <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/include/linux/input/adp5589.h>`__              |
+----------+------------------------------------------------------------------------------------------------------------------------------------+
...
.. code:: c
   ...
   static struct adp5589_kpad_platform_data adp5589_kpad_data = {
       /* KEYPAD Config */
       .keypad_en_mask = ADP_COL(0) | ADP_COL(1) | ADP_COL(2)
       ...
       /* PULL Config */
       .pullup_en_300k =  ADP_COL(4) | ADP_COL(5) | ADP_COL(6)
...
.. image:: https://wiki.analog.com/_media/software/driver/linux/adp5589_demo_brd_and_stamp.jpg
   :width: 600px
...
`evtest.c <http://cgit.freedesktop.org/~whot/evtest/tree/evtest.c>`__
...
In this particular configuration example, GPIO50 will map to ROW3. For more information read `GPIO Kernel Documentation <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/gpio.txt>`__
...
.. _hardware-configuration-1:

Hardware configuration
~~~~~~~~~~~~~~~~~~~~~~

.. image:: https://wiki.analog.com/_media/resources/tools-software/linux-drivers/input-keyboard/pmodioxp.jpg
   :width: 300px
...
-  `Linux Input drivers kernel documentation <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/input/input.txt>`__
-  `GPIO kernel documentation <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/gpio.txt>`__
-  `How to instantiate I2C devices kernel documentation <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/i2c/instantiating-devices>`__

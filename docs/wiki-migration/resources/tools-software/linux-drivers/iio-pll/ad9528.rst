...
Please see also here: :doc:`Changing the VCXO frequency </wiki-migration/resources/eval/user-guides/rf-trx-vcxo-and-profiles>`

.. image:: https://wiki.analog.com/_media/resources/tools-software/linux-drivers/iio-pll/ad9528.jpg
   :align: center
   :width: 900px
...
| Source                                                                                                                    | Mainlined? |
+===========================================================================================================================+============+
| :git-linux:`drivers/iio/frequency/ad9528.c`                                                                               | No         |
+---------------------------------------------------------------------------------------------------------------------------+------------+
...
| Function | File                                                                                                                                              |
+==========+===================================================================================================================================================+
| driver   | :git-linux:`drivers/iio/frequency/ad9528.c`                                                                                                       |
+----------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| include  | :git-linux:`include/linux/iio/frequency/ad9528.h`                                                                                                 |
+----------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| include  | :git-linux:`include/dt-bindings/iio/frequency/ad9528.h`                                                                                           |
+----------+---------------------------------------------------------------------------------------------------------------------------------------------------+
...
-  **adi,ref-mode**: Must be one of:
   ...
   -  "REF_MODE_REVERT_TO_REFA": Revert to REFA
   -  "REF_MODE_SELECT_REFA": Select REFA
   -  "REF_MODE_SELECT_REFB": Select REFB

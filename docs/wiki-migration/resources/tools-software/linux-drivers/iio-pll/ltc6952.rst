...
The :adi:`LTC6952` is a high performance, ultralow jitter, JESD204B/C clock generation and distribution IC. It includes a Phase Locked Loop (PLL) core, consisting of a reference divider, phase-frequency detector (PFD) with a phase-lock indicator, ultralow noise charge pump and integer feedback divider.
...
| Source                                                                                                                      | Mainlined? |
+=============================================================================================================================+============+
| :git-linux:`drivers/iio/frequency/ltc6952.c`                                                                                | No         |
+-----------------------------------------------------------------------------------------------------------------------------+------------+
...
| Function      | File                                                                                                                                                                                          |
+===============+===============================================================================================================================================================================================+
| driver        | :git-linux:`drivers/iio/frequency/ltc6952.c`                                                                                                                                                  |
+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Documentation | :git-linux:`Documentation/devicetree/bindings/iio/frequency/adi,ltc6952.yaml`                                                                                                                 |
+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

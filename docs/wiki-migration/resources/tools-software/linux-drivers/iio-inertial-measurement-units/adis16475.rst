...
| Source                                                                                      | Mainlined?                                                                                                    |
+=============================================================================================+===============================================================================================================+
| :git-linux:`git <drivers/iio/imu/adis16475.c>`                                              | `yes <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/iio/imu/adis16475.c>`__ |
+---------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------+
...
For a detailed description please see: `sysfs-bus-iio <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/ABI/testing/sysfs-bus-iio>`__
...
|         __overlay__ {                                                    |         __overlay__ {                                      |
|             adis16475_pins: adis16475_pins {                             |             adis16480_pins: adis16480_pins {               |
|                 brcm,pins = <4 12>; // interrupt and reset               |                 brcm,pins = <6 12>; // interrupt and reset |
|                 brcm,function = <0 1>; // in out                         |                 brcm,function = <0 1>; // in out           |
|             };                                                           |             };                                             |
|         };                                                               |         };                                                 |
|     };                                                                   |     };                                                     |
|                                                                          |     fragment@4 {                                           |
|     fragment@4 {                                                         |         target = <&spi0>;                                  |
|         target-path = "/";                                               |         __overlay__ {                                      |
|         __overlay__ {                                                    |             /* needed to avoid dtc warning */              |
|             clocks {                                                     |             #address-cells = <1>;                          |
|                 adis16475_ref_clk: clock@0 {                             |             #size-cells = <0>;                             |
|                          #clock-cells = <0>;                             |                                                            |
|                          compatible = "fixed-clock";                     |             adis16480: adis16480@0 {                       |
|                 };                                                       |                 reg = <0>;                                 |
|             };                                                           |                 pinctrl-names = "default";                 |
|         };                                                               |                 pinctrl-0 = <&adis16480_pins>;             |
|     };                                                                   |                 spi-cpha;                                  |
|                                                                          |                 spi-cpol;                                  |
|     fragment@5 {                                                         |                 reset-gpios = <&gpio 12 GPIO_ACTIVE_LOW>;  |
|         target = <&spi0>;                                                |                 spi-max-frequency = <15000000>;            |
|         __overlay__ {                                                    |                 /* use DIO1 as data ready by default */    |
|             /* needed to avoid dtc warning */                            |                 interrupts = <6 IRQ_TYPE_EDGE_RISING>;     |
|             #address-cells = <1>;                                        |                 interrupt-parent = <&gpio>;                |
|             #size-cells = <0>;                                           |             };                                             |
|                                                                          |         };                                                 |
|             adis16475: adis16475@0 {                                     |     };                                                     |
|                 reg = <0>;                                               |                                                            |
|                 pinctrl-names = "default";                               |     __overrides__ {                                        |
|                 pinctrl-0 = <&adis16475_pins>;                           |         device = <&adis16480>,"compatible";                |
|                 spi-cpha;                                                |         drdy_dio2 = <&adis16480_pins>,"brcm,pins:0=25",    |
|                 spi-cpol;                                                |                 <&adis16480>,"interrupts:0=25",            |
|                 reset-gpios = <&gpio 12 GPIO_ACTIVE_LOW>;                |                 <&adis16480>,"interrupt-names=DIO2";       |
|                 spi-max-frequency = <2000000>;                           |         drdy_dio3 = <&adis16480_pins>,"brcm,pins:0=4",     |
|                 interrupts = <4 IRQ_TYPE_EDGE_RISING>;                   |                 <&adis16480>,"interrupts:0=4",             |
|                 interrupt-parent = <&gpio>;                              |                 <&adis16480>,"interrupt-names=DIO3";       |

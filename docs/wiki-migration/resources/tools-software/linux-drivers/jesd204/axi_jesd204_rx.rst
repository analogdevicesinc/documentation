...
This driver provides advanced diagnostics, status and via `sysfs <https://en.wikipedia.org/wiki/sysfs>`__. A brief summary is with examples are provided below.

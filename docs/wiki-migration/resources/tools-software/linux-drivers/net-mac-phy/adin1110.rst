...
| Source                                                                                                     | Mainlined? |
+------------------------------------------------------------------------------------------------------------+------------+
| :git-linux:`drivers/net/ethernet/adi/adin1110.c`                                                           | Yes        |
+------------------------------------------------------------------------------------------------------------+------------+
...
-  Type ADIN1110, then hit Enter; if nothing shows up, the driver is not available in your kernel tree, please use `the ADI linux tree <https://github.com/analogdevicesinc/linux/>`__
...
:doc:`ADIN1110 Quick Start Guide </wiki-migration/resources/quick-start/adin1110_linux_quick_start_guide>`

...
Download and unzip `opampltspicetestcircuits.zip <https://wiki.analog.com/_media/resources/tools-software/ltspice/opampltspicetestcircuits.zip>`_ to open and simulate test circuits in LTspice.

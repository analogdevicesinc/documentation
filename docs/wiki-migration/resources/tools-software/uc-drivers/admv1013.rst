...
-  The driver for the :adi:`ADMV1013` part, which may be used, without modifications, with any microcontroller.
...
The Communication Driver has a standard interface, so the :adi:`ADMV1013` driver can be used exactly as it is provided.

The Communication Drivers must include the SPI transmission methods.

For the SPI method, the :adi:`ADMV1013` driver calls three functions:
...
-  `ADMV1013 Header file <http://analogdevicesinc.github.io/no-OS/doxygen/admv1013_8h.html>`__
-  `ADMV1013 Source file <http://analogdevicesinc.github.io/no-OS/doxygen/admv1013_8c.html>`__
...
.. admonition:: Download
   ...
   |Implementation of ADMV1013 Driver.|

   -

   |Header file of ADMV1013 Driver.|

.. |Implementation of ADMV1013 Driver.| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/frequency/admv1013/admv1013`.c
.. |Header file of ADMV1013 Driver.| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/frequency/admv1013/admv1013`.h

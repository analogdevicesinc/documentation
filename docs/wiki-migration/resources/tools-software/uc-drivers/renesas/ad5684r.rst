...
The :adi:`AD5684`/:adi:`AD5686`, members of the nanoDAC+™ family are low power, quad, 12/16-bit buffered voltage output DACs. The devices include a gain select pin giving a full-scale output of 0V to VREF (gain = 1) or 0V to 2VREF (gain = 2).

The :adi:`AD5684R`/:adi:`AD5685R`/:adi:`AD5686R` nanoDAC+TM are quad, 12/14/16-bit, rail-to-rail, voltage output DACs. The devices include a 2.5V, 2ppm/˚C internal reference (enabled by default) and a gain select pin giving a full-scale output of 2.5V (gain=1) or 5V (gain=2).
...
.. admonition:: Download
   ...
   -  `AD568X Generic Driver <https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad568x_generic.zip>`__
   -  `AD5684R RL78G13 Driver <https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad5684r_rl78g13.zip>`__
...
-  `Renesas Demo Kit for RL78G13 (Renesas) <https://www.renesas.com/us/en/products/microcontrollers-microprocessors/rl78-low-power-8-16-bit-mcus/yrdkrl78g13-yrdkrl78g13-demonstration-kit-rl78g13>`__
-  :adi:`EVAL-AD5684RSDZ (ADI) <EVAL-AD5684RSDZ>`
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad5684r_rl78g13.jpg
   :align: center
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad5684r_rl78g13_screen.jpg
   :align: center

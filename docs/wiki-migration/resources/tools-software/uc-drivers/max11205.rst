...
-  `MAX11205 <https://www.maximintegrated.com/en/products/analog/data-converters/analog-to-digital-converters/MAX11205.html>`__
...
.. admonition:: Download
   ...
   |Header file of MAX11205 Driver|

   -

   |Implementation of MAX11205 Driver|
...
.. admonition:: Download
   ...
   |Generic header file for IRQ APIs|
...
-  `MAX11205 Header file <http://analogdevicesinc.github.io/no-OS/doxygen/max11205_8h.html>`__
-  `MAX11205 Source file <http://analogdevicesinc.github.io/no-OS/doxygen/max11205_8c.html>`__
...
Below you can find Application Example Projects for MAX11205 driver: :doc:`Evaluating the MAX11205 </wiki-migration/resources/eval/user-guides/max11205pmb1/no-os-setup>`
...
.. admonition:: Download
   ...
   |Header file of MAX11205 IIO Driver|

   -

   |Implementation of MAX11205 IIO Driver|
...
-  `MAX11205 IIO Header file <http://analogdevicesinc.github.io/no-OS/doxygen/iio__max11205_8h.html>`__
-  `MAX11205 IIO Source file <http://analogdevicesinc.github.io/no-OS/doxygen/iio__max11205_8c.html>`__
...
Below you can find an Application Example Project for MAX11205 IIO driver: :doc:`Evaluating the MAX11205 </wiki-migration/resources/eval/user-guides/max11205pmb1/no-os-setup>`

.. |Header file of MAX11205 Driver| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/adc/max11205/max11205`.h
.. |Implementation of MAX11205 Driver| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/adc/max11205/max11205`.c
...
.. |Generic header file for IRQ APIs| image:: https://wiki.analog.com/_media/:git-no-OS:`include/no_os_irq`.h
.. |Generic header file for GPIO APIs| image:: https://wiki.analog.com/_media/:git-no-OS:`include/no_os_gpio`.h
.. |Header file of MAX11205 IIO Driver| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/adc/max11205/iio_max11205`.h
.. |Implementation of MAX11205 IIO Driver| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/adc/max11205/iio_max11205`.c

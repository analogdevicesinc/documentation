...
-  The driver for the :adi:`ADMV8818` part, which may be used, without modifications, with any microcontroller.
...
The Communication Driver has a standard interface, so the :adi:`ADMV8818` driver can be used exactly as it is provided.

The Communication Drivers must include the SPI transmission methods.

For the SPI method, the :adi:`ADMV8818` driver calls three functions:
...
-  `ADMV8818 Header file <http://analogdevicesinc.github.io/no-OS/admv8818_8h.html>`__
-  `ADMV8818 Source file <http://analogdevicesinc.github.io/no-OS/admv8818_8c.html>`__
...
.. admonition:: Download
   ...
   |Header file of ADMV8818 Driver.|

.. |Implementation of ADMV8818 Driver.| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/filter/admv8818/admv8818`.c
.. |Header file of ADMV8818 Driver.| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/filter/admv8818/admv8818`.h

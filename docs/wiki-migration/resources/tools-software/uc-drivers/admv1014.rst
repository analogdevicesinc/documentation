...
-  The driver for the :adi:`ADMV1014` part, which may be used, without modifications, with any microcontroller.
...
The Communication Driver has a standard interface, so the :adi:`ADMV1014` driver can be used exactly as it is provided.

The Communication Drivers must include the SPI transmission methods.

For the SPI method, the :adi:`ADMV1014` driver calls three functions:
...
-  `ADMV1014 Header file <http://analogdevicesinc.github.io/no-OS/admv1014_8h.html>`__
-  `ADMV1014 Source file <http://analogdevicesinc.github.io/no-OS/admv1014_8c.html>`__
...
.. admonition:: Download
   ...
   |Implementation of ADMV1014 Driver.|

   -

   |Header file of ADMV1014 Driver.|

.. |Implementation of ADMV1014 Driver.| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/frequency/admv1014/admv1014`.c
.. |Header file of ADMV1014 Driver.| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/frequency/admv1014/admv1014`.h

...
-  The driver for the :adi:`AD7799` part, which may be used, without modifications, with any microcontroller.
...
The Communication Driver has a standard interface, so the :adi:`AD7799` driver can be used exactly as it is provided.

The Communication Drivers must include SPI transmission methods.

For the SPI method, the :adi:`AD7799` driver calls three functions:
...
-  `AD7799 Header file <http://analogdevicesinc.github.io/no-OS/ad7799_8h.html>`__
-  `AD7799 Source file <http://analogdevicesinc.github.io/no-OS/ad7799_8c.html>`__
...
.. admonition:: Download
   ...
   |Implementation of AD7799 Driver.|

   -

   |Header file of AD7799 Driver.|

.. |Implementation of AD7799 Driver.| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/adc/ad7799/ad7799`.c
.. |Header file of AD7799 Driver.| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/adc/ad7799/ad7799`.h

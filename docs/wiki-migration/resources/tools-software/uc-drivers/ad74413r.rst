...
-  :adi:`AD74412R <en/products/ad74413r.html>`
-  :adi:`AD74413R <en/products/ad74413r.html>`

Overview
--------

The :adi:`AD74413R <en/products/ad74413r.html>` is a quad-channel software configurable input/output solution for building and process control applications. The :adi:`AD74413R <en/products/ad74413r.html>` contains functionality for analog output, analog input, digital input, resistance temperature detector (RTD), and thermocouple measurements integrated into a single chip solution with a serial peripheral interface (SPI). The device features a 16-bit, Σ-Δ analog-to-digital converter (ADC) and four configurable, 13-bit digital-to-analog converters (DACs) to provide four configurable input/output channels and a suite of diagnostic functions. There are several modes related to the :adi:`AD74413R <en/products/ad74413r.html>`. These modes are voltage output, current output, voltage input, externally powered current input, loop powered current input, external RTD measurement, digital input logic, and loop powered digital input.

The :adi:`AD74412R <en/products/ad74412r.html>` is functionally almost the same as the :adi:`AD74413R <en/products/ad74413r.html>`, but it lacks HART slew rate compatibility modes.
...
.. admonition:: Download
   ...
   |Header file of the AD74413R driver|

   -

   |Implementation of AD74413R driver|
...
-  `AD74413R Header file <http://analogdevicesinc.github.io/no-OS/ad74413r_8h.html>`__
-  `AD74413R Source file <http://analogdevicesinc.github.io/no-OS/ad74413r_8c.html>`__
...
-  20 Hz, 4800Hz for the :adi:`AD74412R <en/products/ad74413r.html>`.
-  20 Hz, 4800Hz, 10 Hz, 1200Hz (the last 2 are HART compatible) for the :adi:`AD74413R <en/products/ad74413r.html>`.
...
Before this may be done, the a channel must be enabled, using the **ad74413r_set_adc_channel_enable** function. The :adi:`AD74412R <en/products/ad74413r.html>` has several operation modes, which can be set using the **ad74413r_set_channel_function** API. Depending on these, the ADC results may be interpreted in a different way:
...
.. admonition:: Download
   ...
   |AD74413R IIO driver source file|

   -

   |AD74413R IIO driver header file|
...
-  `AD74413R IIO Header file <http://analogdevicesinc.github.io/no-OS/iio__ad74413r_8h.html>`__
-  `AD74413R IIO Source file <http://analogdevicesinc.github.io/no-OS/iio__ad74413r_8c.html>`__
...
.. |Header file of the AD74413R driver| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/adc-dac/ad74413r/ad74413r`.h
.. |Implementation of AD74413R driver| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/adc-dac/ad74413r/ad74413r`.c
...
.. |AD74413R IIO driver source file| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/adc-dac/ad74413r/iio_ad74413r`.c
.. |AD74413R IIO driver header file| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/adc-dac/ad74413r/iio_ad74413r`.h

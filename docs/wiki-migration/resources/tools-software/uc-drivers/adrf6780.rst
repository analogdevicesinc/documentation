...
-  The driver for the :adi:`ADRF6780` part, which may be used, without modifications, with any microcontroller.
...
The Communication Driver has a standard interface, so the :adi:`ADRF6780` driver can be used exactly as it is provided.

The Communication Drivers must include the SPI transmission methods.

For the SPI method, the :adi:`ADRF6780` driver calls three functions:
...
-  `ADRF6780 Header file <http://analogdevicesinc.github.io/no-OS/adrf6780_8h.html>`__
-  `ADRF6780 Source file <http://analogdevicesinc.github.io/no-OS/adrf6780_8c.html>`__
...
.. admonition:: Download
   ...
   |Header file of ADRF6780 Driver.|

.. |Implementation of ADRF6780 Driver.| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/frequency/adrf6780/adrf6780`.c
.. |Header file of ADRF6780 Driver.| image:: https://wiki.analog.com/_media/:git-no-OS:`drivers/frequency/adrf6780/adrf6780`.h

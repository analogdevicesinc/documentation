...
This document describes the **No-OS** software used to control the :adi:`AD7134` and :adi:`AD4134` parts and includes an example of how to initialize a :adi:`AD7134` part.
...
+=================================================================+=====================================================+
| ``int32_t ad713x_spi_reg_read(struct ad713x_dev *dev,           | Read from device.                                   |
|        uint8_t reg_addr,                                        |                                                     |
|        uint8_t *reg_data)``                                     |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_spi_reg_write(struct ad713x_dev *dev,          | Write to device.                                    |
|         uint8_t reg_addr,                                       |                                                     |
|         uint8_t reg_data)``                                     |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_spi_write_mask(struct ad713x_dev *dev,         | SPI write to device using a mask.                   |
|         uint8_t reg_addr,                                       |                                                     |
|         uint32_t mask,                                          |                                                     |
|         uint8_t data)``                                         |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_set_power_mode(struct ad713x_dev *dev,         | Device power mode control.                          |
|         enum ad713x_power_mode mode)``                          |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_set_out_data_frame(struct ad713x_dev *dev,     | ADC conversion data output frame control.           |
|         enum ad713x_adc_data_len adc_data_len,                  |                                                     |
|         enum ad713x_crc_header crc_header)``                    |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_dout_format_config(struct ad713x_dev *dev,     | DOUTx output format configuration.                  |
|         enum ad713x_doutx_format format)``                      |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_mag_phase_clk_delay(struct ad713x_dev *dev,    | Magnitude and phase at 2 clock delay.               |
|         bool clk_delay_en)``                                    |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_dig_filter_sel_ch(struct ad713x_dev *dev,      | Digital filter type selection for each channel.     |
|         enum ad713x_dig_filter_sel filter,                      |                                                     |
|         enum ad713x_channels ch)``                              |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_clkout_output_en(struct ad713x_dev *dev,       | Enable/Disable CLKOUT output.                       |
|         bool enable)``                                          |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_ref_gain_correction_en(struct ad713x_dev *dev, | Enable/Disable reference gain correction.           |
|         bool enable)``                                          |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_wideband_bw_sel(struct ad713x_dev *dev,        | Select the wideband filter bandwidth for a channel. |
|         enum ad713x_channels ch,                                |                                                     |
|         uint8_t wb_opt)``                                       |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_init(struct ad713x_dev **device,               | Initialize the device.                              |
|         struct ad713x_init_param *init_param)``                 |                                                     |
+-----------------------------------------------------------------+-----------------------------------------------------+
| ``int32_t ad713x_remove(struct ad713x_dev *dev)``               | Free the resources allocated by ad713x_init().      |
+-----------------------------------------------------------------+-----------------------------------------------------+
...
.. admonition:: Download
   ...
   -  :git-no-OS:`AD7134/AD4134 driver <drivers/adc/ad713x>`
   -  :git-no-OS:`Supported platform drivers <drivers/platform>`
   -  :git-no-OS:`Platform includes <include>`
...
The following link shows an example of using the driver with two devices working in tandem with a Xilinx platform: :git-no-OS:`projects/ad713x_fmcz/src/ad713x_fmc`.c
...
.. |image1| image:: https://wiki.analog.com/_media/resources/tools-software/uc-drivers/ad7134_platform_drv.png

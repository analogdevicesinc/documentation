AD5629R - Microcontroller No-OS Driver
======================================
...
-  The driver for the AD5629R part, which may be used, without modifications, with any microcontroller.
...
+============================================================+================================================================+
| unsigned char AD5629R_Init(void)                           | Resets the device and performs several initializations.        |
+------------------------------------------------------------+----------------------------------------------------------------+
...
-  `AD5629R Generic Driver <https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad5629R_generic.zip>`__
-  `AD5629R RL78G13 Driver <https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad5629R_rl78g13.zip>`__
-  `AD5629R RX62N Driver <https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad5629R_rx62n.zip>`__
...
-  `Renesas Demo Kit for RL78G13 (Renesas) <https://www.renesas.com/us/en/products/microcontrollers-microprocessors/rl78-low-power-8-16-bit-mcus/yrdkrl78g13-yrdkrl78g13-demonstration-kit-rl78g13>`__
-  :adi:`EVAL-AD5629RSDZ(ADI) <AD5629R>`
...
::
     ...
     EVAL-AD5629RSDZ J6 connector Pin SCL   (SCL)    → YRDKRL78G13 J9  connector Pin 1
     EVAL-AD5629RSDZ J7 connector Pin SDA   (SDA)    → YRDKRL78G13 J9  connector Pin 3
     EVAL-AD5629RSDZ J8 connector Pin \LDAC (LDAC)   → YRDKRL78G13 J11 connector Pin 9
     EVAL-AD5629RSDZ J9 connector Pin \CLR  (CLR)    → YRDKRL78G13 J11 connector Pin 10

.. image:: https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad5629R_rl78g13.jpg
   :align: center
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad5629R_rl78g13_screen.jpg
   :align: center
...
-  :adi:`EVAL-AD5629REBZ (ADI) <EVAL-AD5629R>`
...
::
     ...
     EVAL-AD5629RSDZ J6 connector Pin SCL   (SCL)    → YRDKRX62N J2  connector Pin 1
     EVAL-AD5629RSDZ J7 connector Pin SDA   (SDA)    → YRDKRX62N J2  connector Pin 3
     EVAL-AD5629RSDZ J8 connector Pin \LDAC (LDAC)   → YRDKRX62N J8 connector Pin 17
     EVAL-AD5629RSDZ J9 connector Pin \CLR  (CLR)    → YRDKRX62N J8 connector Pin 25
     

.. image:: https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad5629R_rx62n.jpg
   :align: center
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/uc-drivers/renesas/ad5629R_rx62n_screen.jpg
   :align: center

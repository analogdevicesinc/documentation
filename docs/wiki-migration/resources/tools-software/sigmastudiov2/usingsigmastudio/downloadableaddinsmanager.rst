...
| ======Downloadable Addins Manager====== SigmaStudio+ allows option to install and uninstall the addins ,which are developed and uploaded in the SigmaStudio+ addins server.The user can download the addins and use them in the SigmaStudio+.The addins manager supports browse,install and upgrade options.
| **1.Browse**
...
.. |image1| image:: https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/usingsigmastudio/browseimage.png
   :width: 700px
.. |image2| image:: https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/usingsigmastudio/licenseimage.png
   :width: 450px
.. |image3| image:: https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/usingsigmastudio/installedaddins.png
   :width: 700px

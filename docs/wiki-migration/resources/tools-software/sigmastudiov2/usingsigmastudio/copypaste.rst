...
| =====Copy/Paste===== SigmaStudio+ tool supports the option of cut, copy and paste of elements on the canvas. In SigmaStudio+ it is possible to copy content from one instance and paste it onto the canvas of another instance. These actions can be achived through different ways. In the first method, a group of elements are selected and through the use of shortcut keys on the keyboard i.e. ctrl+c or ctrl+x for copy and cut respectively and ctrl+v for paste.

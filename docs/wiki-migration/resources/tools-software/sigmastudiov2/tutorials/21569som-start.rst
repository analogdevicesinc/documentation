...
This is the modified loader file: `ss_app_21569_leds <https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/tutorials/ss_app_21569_leds_.zip>`__
...
-  download and unzip an example project (available from: :doc:`Tutorials and Examples </wiki-migration/resources/tools-software/sigmastudiov2/tutorials>`)
   ...
   -  for example: `adsp-21569_example.zip <https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/adsp-21569_example.zip>`__

...
| =====Target Application===== This section provides an overview of the implementation and configuration details for various components of the SigmaStudio+ for SHARC (ADSP-SC5xx/ADSP-215xx) Target Framework.

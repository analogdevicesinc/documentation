...
| ===== Variants ===== General Equalizer module with Single Ext blend factor(General Eq Ext Blend).
| ===== Targets Supported =====
...
.. |singleeqblendfiltsettings.png| image:: https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/modules/filters/singleeqblendfiltsettings.png

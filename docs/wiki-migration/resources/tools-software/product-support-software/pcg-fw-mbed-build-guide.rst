...
-  Visit Arm Keil website to create an user account for accessing the web based Keil Studio IDE. `Keil Arm <https://www.keil.arm.com/>`__
-  Open `Keil Studio Web IDE <https://studio.keil.arm.com/>`__ with registered user account

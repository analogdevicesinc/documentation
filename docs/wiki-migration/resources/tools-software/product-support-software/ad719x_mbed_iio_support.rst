...
This page gives an overview of using the ARM platforms supported (default is Mbed) firmware application with Analog Devices AD719x Evaluation board(s) and SDP-K1 controller board. This example code leverages the ADI developed IIO (Industrial Input Output) ecosystem to evaluate the AD719x family devices by providing a device debug and data capture support.
...
-  `no-OS Drivers for AD719x Family <https://github.com/analogdevicesinc/​no-OS>`__
-  :adi:`AD7193 <​en/​products/​ad7193.html>` :adi:`AD4112 <​en/​products/​ad4112.html>` :adi:`AD4114 <​en/​products/​ad4114.html>` :adi:`AD4115 <​en/​products/​ad4115.html>` :adi:`AD4116 <​en/​products/​ad4116.html>`

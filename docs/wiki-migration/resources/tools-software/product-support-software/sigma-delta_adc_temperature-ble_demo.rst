...
.. admonition:: Download
   ...
   -  `Sigma Delta ADC Temperature-BLE Demo Firmware Example <https://wiki.analog.com/https/github.com/analogdevicesinc/ev-cog-ad3029lz/tree/master/sd-adc_cces_temperature-to-ble%20example>`__
...
For observing data using UART link using serial terminal (e.g. `Tera Term <https://osdn.net/projects/ttssh2/releases/>`__), use below serial settings:

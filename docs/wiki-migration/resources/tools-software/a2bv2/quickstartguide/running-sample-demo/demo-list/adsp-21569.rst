...
-  Flash the SigmaStudio target framework on ADSP-21569 following steps in :doc:`section 5.1.1.2 (Flashing target framework on ADZS-21569 EZ-KIT) </wiki-migration/resources/tools-software/a2bv2/quickstartguide/adsp-21569_ez-kit_as_a2b_main>`
...
-  Make sure that .xml files are provided for programming codecs on sub A2B evaluation boards as described in step :doc:`2 in section 4.1.3(Running sample demo) </wiki-migration/resources/tools-software/a2bv2/quickstartguide/running-sample-demo>`

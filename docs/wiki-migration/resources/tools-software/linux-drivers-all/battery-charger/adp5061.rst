...
| Source                                                                                         | Mainlined? |
+================================================================================================+============+
| :git-linux:`git <drivers/power/supply/adp5061.c>`                                              | [No]       |
+------------------------------------------------------------------------------------------------+------------+
...
| Function | File                                                                                 |
+==========+======================================================================================+
| driver   | :git-linux:`drivers/power/supply/adp5061`.c                                          |
+----------+--------------------------------------------------------------------------------------+
...
-  :adi:`ADP5061 Datasheet <media/en/technical-documentation/data-sheets/ADP5061.pdf>`
-  `Linux Kernel Documentation <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/Documentation/ABI/testing>`__
-  :git-linux:`Linux Kernel Documentation sysfs_class_power <Documentation/ABI/testing/sysfs-class-power>`
-  `Power Supply Documentation <https://www.kernel.org/doc/Documentation/power/power_supply_class.txt>`__

Need help?
^^^^^^^^^^

-  :ez:`Analog Devices Linux Device Drivers Help Forum <community/linux-device-drivers/linux-software-drivers>`

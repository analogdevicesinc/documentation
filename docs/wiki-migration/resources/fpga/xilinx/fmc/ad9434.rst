...
-  `ZEDBOARD <https://digilent.com/reference/programmable-logic/zedboard/start>`__ LPC Slot
...
The design is built upon ADI's generic HDL reference design framework. ADI does not distribute the bit/elf files of these projects so they must be built from the sources available :git-hdl>`__. To get the source you must clone the HDL repository, and then build the project as follows.

On Linux:`here <Cygwin/WSL:
...
A more comprehensive build guide can be found in the `build_hdl <https://github.com/analogdevicesinc/hdl/blob/master/docs/user_guide/build_hdl.rst>` user guide.
...
.. admonition:: Download
   ...
   -  `ad9434_fmc_schematic_wiki.pdf <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9434_fmc_schematic_wiki.pdf>`__
   -  `ad9434_fmc_bom_WIKI.xlsx <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9434_fmc_bom_WIKI.xlsx>`__
   -  `ad9434_fmc_gerbers_wiki.zip <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9434_fmc_gerbers_wiki.zip>`__
...
For the ZC706 to boot from the SD card, the SW11 switch should be configured like this: **0110**, from left to right(see `ZC706 user guide <https://docs.xilinx.com/v/u/en-US/ug954-zc706-eval-board-xc7z045-ap-soc>`__, Device Configuration section). The VADJ required: 2.5V.
...
:git-hdl:`AD9434_fmc HDL project <projects/ad9434_fmc>`
...
.. container:: box
   ...
   +==============+===================================================================================================================================+===============================================================================+
   | axi_ad9434   | :git-hdl:`axi_ad9434 HDL <library/axi_ad9434>`     | -                                                                             |
   +--------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+
   | axi_dmac     | :git-hdl:`axi_dmac HDL <library/axi_dmac>`         | `axi_dmac doc <:doc:`/wiki-migration/resources/fpga/docs/axi_dmac`>`__       |
   +--------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+
   | axi_clkgen   | :git-hdl:`axi_clkgen HDL <library/axi_clkgen>`     | `axi_clkgen doc <:doc:`/wiki-migration/resources/fpga/docs/axi_clkgen`>`__   |
   +--------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+
   | axi_hdmi_tx  | :git-hdl:`axi_hdmi_tx HDL <library/axi_hdmi_tx>`   | `axi_hdmi_tx doc <:doc:`/wiki-migration/resources/fpga/docs/axi_hdmi_tx`>`__ |
   +--------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+
   | axi_spdif_tx | :git-hdl:`axi_spdif_tx HDL <library/axi_spdif_tx>` | -                                                                             |
   +--------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+
   | axi_sysid    | :git-hdl:`axi_sysid HDL <library/axi_sysid>`       | `System ID doc <:doc:`/wiki-migration/resources/fpga/docs/axi_sysid`>`__     |
   +--------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+
   | sysid_rom    | :git-hdl:`sysid_rom HDL <library/sysid_rom>`       | `System ID doc <:doc:`/wiki-migration/resources/fpga/docs/axi_sysid`>`__     |
   +--------------+-----------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+
...
.. container:: box
   ...
   -  :git-linux:`AD9434 driver <drivers/iio/adc/ad9467.c#L143>`

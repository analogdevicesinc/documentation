...
.. important::
   ...
   We are in the process of migrating our documentation to GitHubIO. This page is outdated and the new one can be found at https://analogdevicesinc.github.io/hdl/projects/ad9739a_fmc/index.html\


.. warning::

   \ **NOTE:** Support for the eval-ad9739a was discontinued starting with 2022_R2 Kuiper Linux release and it is not supported in future releases. Last release in which pre-build files can be found is 2021_r2. Check this :doc:`link </wiki-migration/resources/tools-software/linux-software/adi-kuiper_images/release_notes>` to see all Kuiper releases. The HDL project source code can be found on `hdl_2021_r2 <https://github.com/analogdevicesinc/hdl/tree/hdl_2021_r2/projects/ad9739a_fmc>`_ release branch.
...
-  :adi:`AD9739A-FMC <EVAL-AD9739A>`

.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_fmc.jpg
   :width: 400px
...
-  `ML605 <https://www.xilinx.com/ML605>`_ Legacy (limited support)
-  `KC705 <https://www.xilinx.com/KC705>`_ Legacy (limited support)
-  `VC707 <https://www.xilinx.com/VC707>`_ Legacy (limited support)
-  `AC701 <https://www.xilinx.com/AC701>`_ Legacy (limited support)
...
-  :doc:`DAC Software Suite (optional) </wiki-migration/resources/eval/dpg/dacsoftwaresuite>`
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/cf_ad9739a_setup.jpg
   :alt: Hardware setup
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/ad9739a_fmc_xilinx.svg
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/ad9739a_fmc_card_1.svg
   :alt: Xilinx HDL Block Diagram
   :width: 400px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/src_files.png
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/project_explorer.png
...
.. image:: https://wiki.analog.com/_media/section>resources/eval/dpg/ad9739a-ebz#AD9739A USB SPI Software&nofooter
   :alt: ad9739a-ebz#AD9739A USB SPI Software&nofooter
...
.. admonition:: Download
   ...
   -  **ML605 HDL Reference Design:** `cf_ad9739a_mb_edk_14_4_2013_02_11.tar.gz <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/cf_ad9739a_mb_edk_14_4_2013_02_11.tar.gz>`_
   -  **KC705 HDL Reference Design:** `cf_ad9739a_kc705_edk_14_4_2013_02_11.tar.gz <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/cf_ad9739a_kc705_edk_14_4_2013_02_11.tar.gz>`_
   -  **VC707 HDL Reference Design:** `cf_ad9739a_vc707_edk_14_4_2013_02_11.tar.gz <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/cf_ad9739a_vc707_edk_14_4_2013_02_11.tar.gz>`_
   -  **AC701 HDL Reference Design:** `cf_ad9739a_ac701_edk_14_4_2013_07_30.tar.gz <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/cf_ad9739a_ac701_edk_14_4_2013_07_30.tar.gz>`_
...
.. admonition:: Download
   ...
   -  **ZC706 HDL Reference Design:**\ :git-hdl:`projects/ad9739a_fmc/zc706`
...
.. admonition:: Download
   ...
   -  **AD9739A Driver:** :git-no-OS:`drivers/dac/ad9739a`
   -  **ADF4350 Driver:** :git-no-OS:`drivers/frequency/adf4350`
   -  **AD9739A-FMC-EBZ Reference Design:** :git-no-OS:`ad9739a-fmc-ebz`
...
.. admonition:: Download
   ...
   -  `AD9739A-FMC-EBZ Schematic RevB <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/ad9739a-fmc-ebz_revb_schematic.pdf>`_
   -  `AD9739A-FMC-EBZ Schematic RevC <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a-fmc-ebz_revc_schematic.pdf>`_
   -  `AD9739A-FMC-EBZ Gerber Files RevB <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/ad9739a-fmc-ebz_revb_gerber_files.zip>`_
   -  `AD9739A-FMC-EBZ Gerber Files RevC <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a-fmc-ebz_revc_gerber_files.zip>`_
   -  `AD9739A-FMC-EBZ Layout RevB <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/ad9739a-fmc-ebz_revb_layout.pdf>`_
   -  `AD9739A-FMC-EBZ Layout RevC <https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a-fmc-ebz_revc_layout.pdf>`_
   -  :doc:`AD9739A Evaluation Board and DPG Software </wiki-migration/resources/eval/dpg/eval-ad9739a>`
...
-  `4 x independent DVB-T channels, RF output (0 to 1.250 GHz) from MVD Cores <http://www.mvd-fpga.com/cores/en/digilent_AD9739A_xilinx_eval.html>`_
-  `4 x independent ATSC channels, RF output (0 to 1.250 GHz)from MVD Cores <http://www.mvd-fpga.com/cores/en/digilent_AD9739A_xilinx_eval.html>`_
-  `4 x independent J.83B channels, RF output (0 to 1.250 GHz) from MVD Cores <http://www.mvd-fpga.com/cores/en/digilent_AD9739A_xilinx_eval.html>`_
-  `4 x independent DVB-C J.83A/C channels, RF output (0 to 1.250 GHz) from MVD Cores <http://www.mvd-fpga.com/cores/en/digilent_AD9739A_xilinx_eval.html>`_
...
.. hint::
   ...
   -  :adi:`Purchase AD9739A-FMC-EBZ <en/digital-to-analog-converters/high-speed-da-converters/ad9739a/products/product.html>`
   -  `VITA's FMC info <http://www.vita.com/fmc>`_
   -  :ez:`Ask questions about the FPGA reference design <community/fpga>`
   -  :ez:`Ask questions about the AD9739A <community/data_converters/high-speed_dacs>`
   


.. |analogTV>1423927819001| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/analogTV>1423927819001
.. |image1| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/direct_clock_980_1c_aclr.png
   :width: 200px
.. |image2| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/direct_clock_980_1c_spectrum.png
   :width: 200px
.. |image3| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/direct_clock_980_4c_aclr.png
   :width: 200px
.. |image4| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/direct_clock_980_4c_spectrum.png
   :width: 200px
.. |image5| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/direct_clock_980_8c_aclr.png
   :width: 200px
.. |image6| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad9739a_ebz/direct_clock_980_8c_spectrum.png
   :width: 200px

...
This document presents the steps to setup an environment for using the :adi:`EVAL-AD9833SDZ <AD9833>` evaluation board together with the Xilinx KC705 FPGA board and the Xilinx Embedded Development Kit (EDK). Below is presented a picture of the EVAL-AD9833SDZ Evaluation Board with the Xilinx KC705 board.

.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/img_ad9833.jpg
   :alt: img_ad9833.jpg
   :align: center
...
.. admonition:: Download
   ...
   | \* **AD9833 Driver:** :git-no-OS:`drivers/frequency/ad9833`
   
   -  **AD9833 Commands:** :git-no-OS:`device_commands/AD9833`
...
-  :doc:`AD9833 IIO Direct Digital Synthesis Linux Driver </wiki-migration/resources/tools-software/linux-drivers/iio-dds/ad9834>`

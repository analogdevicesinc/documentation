...
This document presents the steps to setup an environment for using the :adi:`EVAL-AD7091RSDZ <AD7091R>` evaluation board together with the Xilinx KC705 FPGA board and the Xilinx Embedded Development Kit (EDK). Below is presented a picture of the EVAL-AD7091RSDZ Evaluation Board with the Xilinx KC705 board.

.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/ad7091r_ac701.jpg
   :alt: ad7091r_ac701.jpg
   :align: center
   :width: 400px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/ad7091R_sdp1z.jpg
...
-  :adi:`EVAL-AD7091RSDZ evaluation board user guide <static/imported-files/user_guides/UG-409.pdf>`
-  `Xilinx AC705 FPGA board <https://www.xilinx.com/products/boards-and-kits/EK-A7-AC701-G.htm>`__
...
.. admonition:: Download
   ...
   -  **AD7091R Drivers:** :git-no-OS:`drivers/adc/ad7091r`

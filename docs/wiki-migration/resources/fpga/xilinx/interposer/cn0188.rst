CN0188 FMC-SDP Interposer & Evaluation Board / Xilinx KC705 Reference Design
============================================================================
...
This document presents the steps to setup an environment for using the :adi:`EVAL-CN0188-SDPZ` evaluation board together with the Xilinx KC705 FPGA board and the Xilinx Embedded Development Kit (EDK). Below is presented a picture of the EVAL-CN0188-SDPZ Evaluation Board with the Xilinx KC705 board.

.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/cn0188.jpg
   :alt: cn0188.jpg
   :align: center
   :width: 600px
...
-  The EVAL-CN0188 reference project for Xilinx KC705 FPGA.
...
.. admonition:: Download
   ...
   -  **CN0188 Commands:** :git-no-OS:`device_commands/CN0188`
...
The following commands were implemented in this version of EVAL-CN0188 reference project for Xilinx KC705 FPGA board.

...
-  `Nexys™3 Spartan-6 FPGA Board (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?NavPath=2,400,897&Prod=NEXYS3>`__
-  `Avnet ZedBoard <http://www.em.avnet.com/en-us/design/drc/Pages/Zedboard.aspx>`__
   \* `PmodIA (Digilent) <https://store.digilentinc.com/pmod-ia-impedance-analyzer>`__
...
Extract the project from the archive file (AD5933\_<board_name>.zip) to the location you desire.
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodia.jpg
   :alt: PmodIA and LX-9
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodia_nexys3.jpg
   :alt: PmodIA and Nexys™3
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodia_zed.jpg
   :alt: PmodIA and ZedBoard
   :width: 400px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/PmodIAImpact.jpg
...
.. admonition:: Download
   ...
   | \**Avnet LX-9 MicroBoard: **
     \*** `Reference design source code for Avnet LX9 MicroBoard. <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/ad5933_lx9.zip>`__\ **
     **\ Digilent Nexys™3:**
     \*** `Reference design source code for Digilent Nexys™3 Spartan-6 FPGA Board. <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/ad5933_nexys3.zip>`__\ **
     **\ Avnet ZedBoard:\*\*
   | \* :git-fpgahdl_xilinx:`XPS Project <cf_adv7511_zed>`
   | \* :git-no-OS:`PmodIA Driver Files <Pmods/PmodIA>`
   | \* :git-no-OS:`ZYNQ SoC Peripherals Driver Files <Pmods/Common/sw>`
   | \* :git-no-OS:`Programming Script <Pmods/PmodIA/bin>`
   |
...
.. container:: hide
   ...
   -  Download the device tree: :git-no-OS:`PmodIA Linux devicetree <Pmods/PmodIA/dts>`
...
.. |UART messeges| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodia_menu1.jpg
   :width: 600px
.. |image1| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodia_menu2.jpg
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodia_menu3.jpg
   :width: 600px

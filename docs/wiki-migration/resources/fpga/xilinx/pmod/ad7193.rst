...
-  `Nexys™3 Spartan-6 FPGA Board (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?NavPath=2,400,897&Prod=NEXYS3>`__
-  `Avnet ZedBoard <http://www.em.avnet.com/en-us/design/drc/Pages/Zedboard.aspx>`__
-  `PmodAD5 (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?Prod=PMOD-AD5>`__
...
Extract the project from the archive file (AD7193\_<board_name>.zip) to the location you desire.
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodad5.jpg
   :alt: PmodAD5 and LX-9
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodad5_nexys3.jpg
   :alt: PmodAD5 and Nexys™3
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodad5_zed.jpg
   :alt: PmodAD5 and ZedBoard
   :width: 200px
...
.. admonition:: Download
   ...
   | \**Avnet LX-9 MicroBoard: **
     \*** `Reference design source code for Avnet LX9 MicroBoard. <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/ad7193_lx9.zip>`__\ **
     **\ Digilent Nexys™3:**
     \*** `Reference design source code for Digilent Nexys™3 Spartan-6 FPGA Board. <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/ad7193_nexys3.zip>`__\ **
     **\ Avnet ZedBoard:\*\*
...
.. |Display internal registers values| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodad5_menu1.jpg
   :width: 600px
.. |Demo mode 1| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodad5_menu2.jpg
   :width: 600px
.. |Demo mode 2| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodad5_menu3.jpg
   :width: 600px
.. |Demo mode 3| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodad5_menu4.jpg
   :width: 600px
.. |Demo mode 4| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodad5_menu5.jpg
   :width: 600px
.. |Demo mode 5| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodad5_menu6.jpg
   :width: 600px

...
The :adi:`AD7156` delivers a complete signal processing solution for capacitive sensors, featuring an ultralow power converter with fast response time. The AD7156 uses an Analog Devices, Inc., capacitance-to-digital converter (CDC) technology, which combines features important for interfacing to real sensors, such as high input sensitivity and high tolerance of both input parasitic ground capacitance and leakage current. The integrated adaptive threshold algorithm compensates for any variations in the sensor capacitance due to environmental factors like humidity and temperature or due to changes in the dielectric material over time.
...
-  `Nexys™3 Spartan-6 FPGA Board (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?NavPath=2,400,897&Prod=NEXYS3>`__
-  `Avnet ZedBoard <http://www.em.avnet.com/en-us/design/drc/Pages/Zedboard.aspx>`__
   \* `PmodCDC1 (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?Prod=PMOD-CDC1>`__
...
Extract the project from the archive file (AD7156\_<board_name>.zip) to the location you desire.
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodCDC1_lx9.jpg
   :alt: PmodCDC1 and LX-9
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_nexys3.jpg
   :alt: PmodCDC1 and Nexys™3
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_zed.jpg
   :alt: PmodCDC1 and ZedBoard
   :width: 400px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/PmodCDCImpact.jpg
...
.. admonition:: Download
   ...
   | \**Avnet LX-9 MicroBoard: **
     \*** `Reference design source code for Avnet LX9 MicroBoard. <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/ad7156_lx9.zip>`__\ **
     **\ Digilent Nexys™3:**
     \*** `Reference design source code for Digilent Nexys™3 Spartan-6 FPGA Board. <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/ad7156_nexys3.zip>`__\ **
     **\ Avnet ZedBoard:\*\*
   | \* :git-fpgahdl_xilinx:`XPS Project <cf_adv7511_zed>`
   | \* :git-no-OS:`PmodCDC1 Driver Files <legacy/Pmods/PmodCDC1>`
   | \* :git-no-OS:`ZYNQ SoC Peripherals Driver Files <legacy/Pmods/Common/sw>`
   | \* :git-no-OS:`Programming Script <legacy/Pmods/PmodCDC1/bin>`
   |
...
.. container:: hide
   ...
   -  Download the device tree: :git-no-OS:`PmodCDC1 Linux devicetree <legacy/Pmods/PmodCDC1/dts>`
   ...
   .. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/ad7156_linaro_terminal.jpg
      :alt: AD7156 Set Voltage from Terminal
      :width: 600px
   ...
   .. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/ad7156_linux_serial.jpg
      :alt: AD7156 Read Voltage from Serial Terminal
      :width: 600px
...
.. |Main Menu| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu1.jpg
   :width: 600px
.. |Select Channels for display| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu2.jpg
   :width: 600px
.. |Display Capacitance| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu3.jpg
   :width: 600px
.. |Display Average Capacitance| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu4.jpg
   :width: 600px
.. |Set Threshold| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu5.jpg
   :width: 600px
.. |Set Sensitivity| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu6.jpg
   :width: 600px
.. |Set Timeout| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu7.jpg
   :width: 600px
.. |Set Input Range| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu8.jpg
   :width: 600px
.. |Threshold menu| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu9.jpg
   :width: 600px
.. |image1| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu10.jpg
   :width: 600px
.. |Display current settings| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu11.jpg
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu12.jpg
   :width: 600px
.. |Stop and return to menu| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodcdc1_menu13.jpg
   :width: 600px

...
-  `Nexys™3 Spartan-6 FPGA Board (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?NavPath=2,400,897&Prod=NEXYS3>`__
-  `Avnet ZedBoard <http://www.em.avnet.com/en-us/design/drc/Pages/Zedboard.aspx>`__
-  `PmodDA4 (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?Prod=PMOD-DA4>`__
...
Extract the project from the archive file (AD5628\_<board_name>.zip) to the location you desire.
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4.jpg
   :alt: PmodDA4 and LX-9
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_nexys3.jpg
   :alt: PmodDA4 and Nexys™3
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_zed.jpg
   :alt: PmodDA4 and ZedBoard
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/PmodDA4Impact.jpg
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu1.jpg
   :alt: Main Menu
   :width: 600px

When entering **Fixed Value Mode**, DAC selection is automatically activated. Selecting the DAC is done by pressing **[1]** to **[9]**.

.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu2.jpg
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu3.jpg
   :alt: UART messeges
   :width: 600px

Pressing the **[q]** key at any time exits the Fixed Value (or Waveform Generation) Mode and displays the **Main Menu** again.

.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu4.jpg
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu5.jpg
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu6.jpg
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu7.jpg
   :alt: Ramp Signal Generator Menu
   :width: 600px

**Enter time step** allows setting a time step between **100** and **5000** ms.

.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu8.jpg
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu9.jpg
   :alt: Setting step size
   :width: 600px

**Select DAC** allows selecting which DAC Output will be used for the Ramp Signal Generation.

.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu10.jpg
   :alt: Selecting DAC
   :width: 600px

**Run Ramp Signal Generator** will start generating the desired output.

.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodda4_menu11.jpg
...
.. admonition:: Download
   ...
   | \**Avnet LX-9 MicroBoard: **
     \*** `Reference design source code for Avnet LX9 MicroBoard. <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/AD5628_LX9.zip>`__\ **
     **\ Digilent Nexys™3:**
     \*** `Reference design source code for Digilent Nexys™3 Spartan-6 FPGA Board. <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/AD5628_NEXYS3.zip>`__\ **
     **\ Avnet ZedBoard:\*\*
   | \* :git-fpgahdl_xilinx:`XPS Project <cf_adv7511_zed>`
   | \* :git-no-OS:`PmodDA4 Driver Files <Pmods/PmodDA4>`
   | \* :git-no-OS:`ZYNQ SoC Peripherals Driver Files <Pmods/Common/sw>`
   | \* :git-no-OS:`Programming Script <Pmods/PmodDA4/bin>`
   |
...
.. container:: hide
   ...
   -  Download the device tree: :git-no-OS:`PmodDA4 Linux devicetree <Pmods/PmodDA4/dts>`
   ...
   .. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/ad5628_linaro_terminal.jpg
      :alt: AD5628 Set Voltage from Terminal
      :width: 600px
   ...
   |AD5628 Read Voltage from Serial Terminal|
...
.. |AD5628 Read Voltage from Serial Terminal| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/ad5628_linux_serial.jpg
   :width: 600px

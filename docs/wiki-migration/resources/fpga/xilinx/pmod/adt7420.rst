...
-  `Nexys™3 Spartan-6 FPGA Board (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?NavPath=2,400,897&Prod=NEXYS3>`__
-  `Avnet ZedBoard <http://www.em.avnet.com/en-us/design/drc/Pages/Zedboard.aspx>`__
-  `PmodTMP2 (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?Prod=PMOD-TMP2>`__
...
Extract the project from the archive file (ADT7420\_<board_name>.zip) to the location you desire.
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodTMP2.jpg
   :alt: PmodTMP2 and LX-9
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_nexys3.jpg
   :alt: PmodTMP2 and Nexys™3
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_zed.jpg
   :alt: PmodTMP2 and ZedBoard
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/PmodTMP2Impact.jpg
...
.. admonition:: Download
   ...
   | \**Avnet LX-9 MicroBoard: **
     \*** `Reference design source code for Avnet LX9 MicroBoard. <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/adt7420_lx9.zip>`__\ **
     **\ Digilent Nexys™3:**
     \*** `Reference design source code for Digilent Nexys™3 Spartan-6 FPGA Board. <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/adt7420_nexys3.zip>`__\ **
     **\ Avnet ZedBoard:\*\*
   | \* :git-fpgahdl_xilinx:`XPS Project <cf_adv7511_zed>`
   | \* :git-no-OS:`PmodTMP2 Driver Files <legacy/Pmods/PmodTMP2>`
   | \* :git-no-OS:`ZYNQ SoC Peripherals Driver Files <legacy/Pmods/Common/sw>`
   | \* :git-no-OS:`Programming Script <legacy/Pmods/PmodTMP2/bin>`
   |
...
.. |Main Menu| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_menu1.jpg
   :width: 600px
.. |Read Temperature| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_menu2.jpg
   :width: 600px
.. |Set Resolution| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_menu3.jpg
   :width: 600px
.. |Set T High| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_menu4.jpg
   :width: 600px
.. |Set T Low| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_menu5.jpg
   :width: 600px
.. |Set T Crit| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_menu6.jpg
   :width: 600px
.. |Set T Hyst| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_menu7.jpg
   :width: 600px
.. |Set fault queue| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_menu8.jpg
   :width: 600px
.. |Display current settings| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/pmodtmp2_menu9.jpg
   :width: 600px

...
-  `Nexys™3 Spartan-6 FPGA Board (Digilent) <http://digilentinc.com/Products/Detail.cfm?NavPath=2,400,897&Prod=NEXYS3>`__
-  `Pmod-AD1 (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?Prod=PMOD-AD1>`__
-  `Pmod-DA1 (Digilent) <http://www.digilentinc.com/Products/Detail.cfm?Prod=PMOD-DA1>`__

Required Software
-----------------

-  Xilinx 13.2 Design Suite (contains ISE, XPS, SDK and ChipScope Pro).
-  `Digilent Adept Runtime <http://digilentinc.com/Products/Detail.cfm?NavPath=2,66,828&Prod=ADEPT2>`__.
-  `Digilent Plugin for Xilinx Tools <http://digilentinc.com/Products/Detail.cfm?NavPath=2,66,768&Prod=DIGILENT-PLUGIN>`__.
...
.. admonition:: Download
   ...
   | `Reference design source code <https://wiki.analog.com/_media/resources/fpga/xilinx/pmod/AD7303_AD7476.zip>`__

...
| Exampele of terminal emulators on Windows `TeraTerm <https://ttssh2.osdn.jp/index.html.en>`__ or `PuTTy <https://www.putty.org/>`__
...
`GTKterm <https://elinux.org/Communicate_with_hardware_using_USB_cable_for_Ubuntu>`__ `Minicom <https://help.ubuntu.com/community/Minicom>`__

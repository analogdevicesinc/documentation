...
.. note::
   ...
   Such a parametrizable block design was built for the :doc:`ADRV9009 Prototyping Platform </wiki-migration/resources/eval/user-guides/adrv9009>` and can be found `here <https://wiki.analog.com/https/github.com/analogdevicesinc/hdl/blob/master/projects/adrv9009/common/adrv9009_bd.tcl>`__.

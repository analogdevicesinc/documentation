...
.. important::
   ...
   We are in the process of migrating our documentation to GitHubIO. This page is outdated and the new one can be found at https://analogdevicesinc.github.io/hdl/library/axi_ad7768/index.html


| The :git-hdl:`library/axi_ad7768` IP core can be used to interface the :adi:`AD7768` and :adi:`AD7768-4` ADC, in 1, 2, 4 or 8 data lines active.
...
.. image:: https://wiki.analog.com/_media/resources/fpga/docs/hdl/ad7768_diagrams/block_diagram_ad7768.svg
   :alt: axi_ad7768 Block diagram
   :align: center
...
.. image:: https://wiki.analog.com/_media/resources/fpga/docs/hdl/ad7768_diagrams/arhitecture_ad7768_ip.svg
   :alt: axi_ad7768 IP architecture
   :align: center
...
-  `AD7768 IP source code <https::`ADI Linux repository </github.com/analogdevicesinc/hdl/tree/master/library/axi_ad7768>`
   \* :adi:`AD7768 chip information <ad7768>`

...
-  `Sigma-Delta SPI Util <https://wiki.analog.com/util_sigma_delta_spi>`__: Helper module for interfacing ADCs from the Analog Devices Sigma-Delta family
...
-  `Presentation: SPI Engine Design Philosophy <https://wiki.analog.com/_media/resources/fpga/peripherals/spi-engine3.pdf>`__

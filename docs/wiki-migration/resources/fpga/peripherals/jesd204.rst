...
.. admonition:: Download
   ...
   -  `Reference hardware platforms <https://wiki.analog.com/>`__ for rapid-prototyping
   -  `FPGA HDL <https://wiki.analog.com/>`__ for interfacing JESD204B/C ADCs, DACs, and RF Transceivers
   -  `Software <https://wiki.analog.com/>`__ to configure the converter devices and FPGA HDL peripherals
...
-  `AXI_ADXCVR <https://wiki.analog.com/../docs/axi_adxcvr>`__: JESD204B Gigabit Transceiver Register Configuration Peripheral
-  `UTIL_ADXCVR <https://wiki.analog.com/../docs/util_xcvr>`__: JESD204B Gigabit Transceiver Interface Peripheral for Xilinx FPGAs

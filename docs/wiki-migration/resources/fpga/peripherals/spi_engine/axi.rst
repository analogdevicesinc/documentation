...
The peripheral has also support for providing memory-mapped access to one or more `SPI Engine Offload <https://wiki.analog.com/offload>`__ cores and change its content dynamically at runtime.
...
| Name                                                                                                              | Description                                                                 |
+===================================================================================================================+=============================================================================+
| `axi_spi_engine.v <https://github.com/hdl?master/library/spi_engine/axi_spi_engine/axi_spi_engine.v>`__           | Verilog source for the peripheral.                                          |
+-------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
| `axi_spi_engine_ip.tcl <https://github.com/hdl?master/library/spi_engine/axi_spi_engine/axi_spi_engine_ip.tcl>`__ | TCL script to generate the Vivado IP-integrator project for the peripheral. |
+-------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
...
+---------------------+-----------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``spi_engine_ctrl`` | `SPI Engine Control Interface <https://wiki.analog.com/spi_engine_control_interface>`__ slave | SPI Engine Control stream that contains commands and data for the execution module.                                                                                 |
+---------------------+-----------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
One end of the FIFOs are connected to a memory-mapped register and can be accessed via the AXI-Lite interface. The other end is directly connected to the matching stream of the `spi_engine_control_interface <https://wiki.analog.com/spi_engine_control_interface>`__.

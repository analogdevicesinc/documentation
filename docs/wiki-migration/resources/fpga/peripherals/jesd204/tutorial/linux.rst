...
For more information about devicetree visit `devicetree.org <http://devicetree.org>`__.
...
We provide a script `for Zynq <https://raw.githubusercontent.com/analogdevicesinc/wiki-scripts/master/linux/build_zynq_kernel_image.sh>`__ and one `for Zynqmp <https://raw.githubusercontent.com/analogdevicesinc/wiki-scripts/master/linux/build_zynqmp_kernel_image.sh>`__ that do automate the build using the Linaro toolchain.

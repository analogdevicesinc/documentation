...
The ADC JESD204B/C Transport Peripheral implements the transport level handling of a JESD204B/C transmitter device. It is compatible with a `wide range of Analog Devices high-speed analog-to-digital converters <https://wiki.analog.com/>`__.
...
`ad_ip_jesd204_tpl_adc.v <https://github.com/hdl?/master/library/jesd204/ad_ip_jesd204_tpl_adc/ad_ip_jesd204_tpl_adc.v>`__

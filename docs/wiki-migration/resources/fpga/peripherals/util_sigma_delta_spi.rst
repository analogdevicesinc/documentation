...
| File                                                                                                                     | Description                                                                |
+==========================================================================================================================+============================================================================+
| `util_sigma_delta_spi.v <https://github.com/hdl?master/library/util_sigma_delta_spi/util_sigma_delta_spi.v>`__           | Verilog source for the peripheral                                          |
+--------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| `util_sigma_delta_spi_ip.tcl <https://github.com/hdl?master/library/util_sigma_delta_spi/util_sigma_delta_spi_ip.tcl>`__ | TCL script to generate the Vivado IP-integrator project for the peripheral |
+--------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+

...
-  `Quartus II Web Edition <http://www.altera.com/products/software/quartus-ii/web-edition/qts-we-index.html>`_ design software v12.1
-  `Nios II EDS <https://www.altera.com/download/software/nios-ii>`_ v12.1
...
-  `Lab Design Files <https://wiki.analog.com/_media/{{/resources/fpga/altera/bemicro/ad7683_evalboardlab.zip>`_
...
.. note::
   ...
   See `common_quick_evaluation <https://wiki.analog.com/common_quick_evaluation>`_
...
.. note::
   ...
   See `common_software_design <https://wiki.analog.com/common_software_design>`_
...
.. note::
   ...
   See `troubleshooting12 <https://wiki.analog.com/troubleshooting12>`_

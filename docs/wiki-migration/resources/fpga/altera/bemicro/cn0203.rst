BeMicro FPGA Project for CN0203 with Nios driver
================================================
...
This lab presents the steps to setup an environment for using the :adi:`EVAL-CN0203-SDPZ` evaluation board together with the **[**\ https://www.arrow.com/en/datasheets/89166696/arrow-development-tools/bemicrosdk%7CBeMicro **SDK]]** USB stick, the Nios II Embedded Development Suite (EDS) and the `Micrium μC-Probe <http://micrium.com/tools/ucprobe/overview/>`__ run-time monitoring tool. Below is presented a picture of the EVAL-CN0203-SDPZ Evaluation Board with the BeMicro SDK Platform.

.. image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0203_bemicro.jpg
   :alt: cn0203_bemicro.jpg
   :align: center
   :width: 400px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0203_sdp1z.jpg
   :alt: cn0203_sdp1z.jpg
   :align: center
   :width: 400px
...
The :adi:`AD5750-1` is a single-channel, low cost, precision voltage/current output driver with hardware- or software- programmable output ranges. The software ranges are configured via an SPI-/MICROWIRE™-compatible serial interface. The AD5750-1 target applications in PLC and industrial process control. The analog input to the AD5750-1 is provided from a low voltage, single-supply digital-to-analog converter (DAC) and is internally conditioned to provide the desired output current/voltage range. Analog input range available is 0 V to 2.5 V.
...
-  :adi:`CN0203 Product Info <CN0203>` - pricing, samples, datasheet
-  :adi:`AD5660-1 Product Info <AD5660>` - pricing, samples, datasheet
-  :adi:`AD5750-1 Product Info <AD5750-1>` - pricing, samples, datasheet
-  :adi:`EVAL-CN0203-SDPZ evaluation board user guide <CN0203>`
-  `BeMicro SDK <https://www.arrow.com/en/datasheets/89166696/arrow-development-tools/bemicrosdk>`__
...
-  Arrow Electronics `BeMicro SDK <https://www.arrow.com/en/datasheets/89166696/arrow-development-tools/bemicrosdk>`__ FPGA-based MCU Evaluation Board
-  `BeMicro SDK/SDP Interposer <https://www.arrow.com/en/datasheets/2957953708/analog-devices/bemicrosdksdpinterposer>`__ adapter board
...
-  `Lab Design Files <https://wiki.analog.com/_media/{{/resources/fpga/altera/bemicro/cn0203_evalboardlab.zip>`__

Extract the Lab Files
---------------------

Create a folder called “\ **ADIEvalBoardLab**\ ” on your PC and extract the **cn0203_evalboardlab.zip** archive to this folder. Make sure that there are **NO SPACES** in the directory path. After extracting the archive the following folders should be present in the **ADIEvalBoardLab** folder: **FPGA**, **Software**, **ucProbeInterface**, **NiosCpu**.
...
-  Click the **Open** option from the **uC-Probe** menu and select the file **ADIEvalBoardLab/ucProbeInterface/CN0203_Interface.wsp**.

|ucprobeopenfile.png| |cn0203interfaceopen.png|
...
.. image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0203_interface.png
   :alt: cn0203_interface.png
   :align: center
   :width: 600px
...
.. |ucprobeopenfile.png| image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/ucprobeopenfile.png
   :width: 400px
.. |cn0203interfaceopen.png| image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0203interfaceopen.png
   :width: 400px

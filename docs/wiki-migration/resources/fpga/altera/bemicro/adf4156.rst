...
-  a controller board, like the `EVAL-SDP-CS1Z <https://wiki.analog.com/resources/eval/sdp/sdp-s>`_ **(SDP-S)**
...
-  `Lab Design Files <https://wiki.analog.com/_media/resources/fpga/altera/bemicro/adf4156_evalboardlab.zip>`_

...
This lab presents the steps to setup an environment for using the :adi:`EVAL-CN0202-SDPZ` evaluation board together with the `BeMicro SDK <https://www.intel.com/content/www/us/en/programmable/b/bemicro-sdk.html>`__ USB stick, the Nios II Embedded Development Suite (EDS) and the `Micrium μC-Probe <http://micrium.com/tools/ucprobe/overview/>`__ run-time monitoring tool. Below is presented a picture of the EVAL-CN0202-SDPZ Evaluation Board with the BeMicro SDK Platform.

.. image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0202_bemicro.jpg
   :alt: cn0202_bemicro.jpg
   :align: center
   :width: 400px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0202_sdp1z.jpg
   :alt: cn0202_sdp1z.jpg
   :align: center
   :width: 400px
...
-  :adi:`CN0202 Product Info <CN0202>` - pricing, samples, datasheet
-  :adi:`AD5662 Product Info <AD5662>` - pricing, samples, datasheet
-  :adi:`AD5750 Product Info <AD5750>` - pricing, samples, datasheet
-  :adi:`EVAL-CN0202-SDPZ evaluation board user guide <CN0202>`
...
-  `Lab Design Files <https://wiki.analog.com/_media/{{/resources/fpga/altera/bemicro/cn0202_evalboardlab.zip>`__
...
-  Click the **Open** option from the **uC-Probe** menu and select the file **ADIEvalBoardLab/ucProbeInterface/CN0202_Interface.wsp**.

|ucprobeopenfile.png| |cn0202interfaceopen.png|
...
.. image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0202_interface.png
   :alt: cn0202_interface.png
   :align: center
   :width: 600px
...
.. |ucprobeopenfile.png| image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/ucprobeopenfile.png
   :width: 400px
.. |cn0202interfaceopen.png| image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0202interfaceopen.png
   :width: 400px

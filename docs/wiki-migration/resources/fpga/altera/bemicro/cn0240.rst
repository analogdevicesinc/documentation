BeMicro FPGA Project for CN0240 with Nios driver
================================================
...
This lab presents the steps to setup an environment for using the :adi:`EVAL-CN0240-SDPZ` evaluation board together with the `BeMicro SDK <https://www.intel.com/content/www/us/en/programmable/b/bemicro-sdk.html>`__ USB stick, the Nios II Embedded Development Suite (EDS) and the `Micrium μC-Probe <http://micrium.com/tools/ucprobe/overview/>`__ run-time monitoring tool. Below is presented a picture of the EVAL-CN0240-SDPZ Evaluation Board with the BeMicro SDK Platform.

.. image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0240_bemicro.jpg
   :alt: cn0240_bemicro.jpg
   :align: center
   :width: 400px
...
Below is presented a picture of **SDP-B** Controller Board with the **EVAL-CN0240-SDPZ** Evaluation Board.

.. image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0240_sdp1z.jpg
   :alt: cn0240_sdp1z.jpg
   :align: center
   :width: 400px
...
The :adi:`AD7170` is a very low power 12-bit analog-to-digital converter (ADC). It contains a precision 12-bit sigma-delta (Σ-Δ) ADC and an on-chip oscillator. Consuming only 135 μA, the AD7170 is particularly suitable for portable or battery operated products where very low power is a requirement.

More information
----------------

-  :adi:`CN0240 Product Info <CN0240>` - pricing, samples, datasheet
-  :adi:`AD7170 Product Info <AD7170>` - pricing, samples, datasheet
-  :adi:`EVAL-CN0240-SDPZ evaluation board user guide <CN0240>`
...
-  `Lab Design Files <https://wiki.analog.com/_media/{{/resources/fpga/altera/bemicro/cn0240_evalboardlab.zip>`__

Extract the Lab Files
---------------------

Create a folder called “\ **ADIEvalBoardLab**\ ” on your PC and extract the **cn0240_evalboardlab.zip** archive to this folder. Make sure that there are **NO SPACES** in the directory path. After extracting the archive the following folders should be present in the **ADIEvalBoardLab** folder: **FPGA**, **Software**, **ucProbeInterface**, **NiosCpu**.
...
-  Click the **Open** option from the **uC-Probe** menu and select the file **ADIEvalBoardLab/ucProbeInterface/CN0240_Interface.wsp**.

.. image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/ucprobeopenfile.png
   :alt: ucprobeopenfile.png
   :width: 400px
...
The following figure presents the **uC-Probe** interface that can be used for monitoring and controlling the operation of the **EVAL-CN0240-SDPZ** evaluation board.

.. image:: https://wiki.analog.com/_media/resources/fpga/altera/bemicro/cn0240_interface.png
   :alt: cn0240_interface.png
   :align: center
   :width: 400px
...
**Section B** is used to acquire data from AD7170. Vin acquired by the AD7170 is displayed in the segment display. The LEDs light up if there is a communication error or a conversion error.

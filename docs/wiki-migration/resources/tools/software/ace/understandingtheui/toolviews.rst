...
-  :doc:`Previous (Capture View) </wiki-migration/resources/tools/software/ace/understandingtheui/captureview.txt>`
...
| 
| ==== SDP-K1 Recovery Tool View ==== The **SDP-K1 Recovery Tool** is used to recover the firmware loaded to the SDP-K1 Controller Board. The SDP-K1 board is designed to be used in conjunction with various ADI evaluation boards as part of a customer evaluation environment. To know more about SDP-K1, refer to :doc:`SDP-K1 </wiki-migration/resources/eval/sdp/sdp-k1>` wiki page.

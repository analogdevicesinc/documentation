...
View the original :adi:`AN-1108 <media/en/technical-documentation/application-notes/AN-1108.pdf>` document posted to `Analog.com <adi>>`__.
...
|an1108-09651-001.png| *Figure 1. AD9832 Functional Block Diagram*

.. _programming-the-ad9832ad9835-1:

Programming the AD9832/AD9835
-----------------------------

A simple example is best to explain how to program the AD9832 and the AD9835. For further details, refer to the AN-621 Application Note and the :adi:`AD9832` or the :adi:`AD9835` data sheet.
...
| :math:`FreqReg=f_{OUT} x 2^28/f_{MCLK}`
| For *FREQ0* = 3000 Hz
| :math:`\displaystyle Freq0=300 Hz x 2^\frac{32}{25} MHz`

| = 515,396 decimal = 0x0007DD44
| For *FREQ1* = 10 KHz
| :math:`\displaystyle Freq1=10,000 Hz x 2^\frac{32}{25} MHz`
| = 1,717,987 decimal = 0x001A363E
| Note that the `ADIsimDDS tool <https://tools.analog.com/en/simdds/>`__ offers a quick and easy method of generating the desired code in hexadecimal, decimal or binary.
...
Use the register tables in the :adi:`AD9832` or :adi:`AD9835` data sheet for reference.
...
|an1108-09651-002.png| *Figure 2. Put AD9832/AD9835 in Reset--0xD000*
...
|an1108-09651-003.png| *Figure 3. Load 0x21DD*
...
|an1108-09651-004.png| *Figure 4. Take Part Out of Reset--0xC000*
...
|an1108-09651-005.png| *Figure 5. Change FSELECT Bit--0x5800*
...
| :math:`\displaystyle FREQ1 = 40,000 Hz x 2^\frac{32}{25} MHz`
...
|an1108-09651-006.png| *Figure 6. Changing FREQ1 Output from 10 kHz to 40 kHz*

.. |an1108-09651-001.png| image:: https://wiki.analog.com/_media/resources/app-notes/an1108-09651-001.png
.. |an1108-09651-002.png| image:: https://wiki.analog.com/_media/resources/app-notes/an1108-09651-002.png
.. |an1108-09651-003.png| image:: https://wiki.analog.com/_media/resources/app-notes/an1108-09651-003.png
.. |an1108-09651-004.png| image:: https://wiki.analog.com/_media/resources/app-notes/an1108-09651-004.png
.. |an1108-09651-005.png| image:: https://wiki.analog.com/_media/resources/app-notes/an1108-09651-005.png
.. |an1108-09651-006.png| image:: https://wiki.analog.com/_media/resources/app-notes/an1108-09651-006.png

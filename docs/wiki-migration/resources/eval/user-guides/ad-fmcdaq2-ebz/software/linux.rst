...
Analog Devices provides full Linux support for the AD-FMCDAQ2-EBZ. Depending on which FPGA platform you are using the steps to perform to setup the system slightly differ:
...
Descriptions of the individual Linux device drivers for the different parts on the AD-FMCDAQ2-EBZ can be found at:

...
-  Click the links within the Windows install wizard **BEFORE** completing the Mosquitto install.
   ...
   -  `OpenSSL <http://slproweb.com/products/Win32OpenSSL.html>`__

      -  `pthreads <https://wiki.analog.com/ftp/sources.redhat.com/pub/pthreads-win32/dll-latest/dll/x86>`__
      -  Refer to pictures outlined in the additional `step by step instructions. <https://sivatechworld.wordpress.com/2015/06/11/step-by-step-installing-and-configuring-mosquitto-with-windows-7>`__
...
-  Click next and finish the installation.
   ...
   |image5|
      ...
      -  `How to fix VCRUNTIME140.DLL Missing Video <https://www.youtube.com/watch?v=-R3LuYNQf98>`__
      -  `VCRUNTIME140.DLL Download <http://www.sts-tutorial.com/sites/downloadCenter.php?vcruntime140>`__

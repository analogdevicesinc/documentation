Visible Light Detection Demo using Bluetooth [with EVAL-CN0397-ARDZ]
====================================================================
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup3029/reference_designs/cn0397/code_calibration.png
   :align: center
...
-  Make sure the target board is connected to workstation (via **USB** at P10) and using the tool bar, navigate to the small Debug icon\ |image4| and select the debugging session you created. The application will programmed and the program execution will stop at the beginning of the main() function.
...
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup3029/reference_designs/cn0397/terminal_new.png
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-aducm360-ardz/quickstart/bug.png
   :width: 30px
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup3029/reference_designs/cn0397/debug.png

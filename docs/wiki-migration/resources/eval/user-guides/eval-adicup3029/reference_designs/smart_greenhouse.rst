...
-  Sensors/Leds
   ...
   -  A pH probe (We used the `Atlas Scientific <http://www.atlas-scientific.com/product_pages/probes/ph_probe.html>`__ for our demo)
   -  A moisture sensor (We used the `Vegetronix VH400 <http://www.vegetronix.com/Products/VH400/>`__ for our demo)

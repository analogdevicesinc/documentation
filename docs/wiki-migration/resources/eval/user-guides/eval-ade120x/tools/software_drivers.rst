...
For further details refer to `this link <https://confluence.analog.com/display/MBED/Mbed%3A+Instructions+for+Users+and+Customers>`__

Getting Started
---------------

-  To use the EVAl-SDP-K1 with the MBED online compiler a user account must be set up firstly. TO set up an account navigate to `MBED <https://www.mbed.com/en/>`__
...
-  The ADE1202 example application can be found `here <https://os.mbed.com/teams/AnalogDevices/code/EVAL-ADE120x/>`__

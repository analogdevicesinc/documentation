...
`KWIK Stability Lecture Material <https://wiki.analog.com/_media/resources/eval/user-guides/stability_kwik_lecture.pdf>`__

LTspice Simulation Circuits
---------------------------

| LTspice Circuits used in the lecture material are available at `KWIK Stability LTSpice Simulation Files <https://wiki.analog.com/_media/resources/eval/user-guides/stability_kwik_demo_ltspice_files.zip>`__.
|
...
A comprehensive User Guide for the evaluation hardware EVAL-KW4503Z can be found at `Stability Analysis KWIK Demo User Guide <https://wiki.analog.com/_media/resources/eval/user-guides/stability_analysis_testing_procedures.pdf>`__
...
Configuration files for the ADALM2000 and Scopy that are referenced in the lecture material can be found at `ADALM2000 Scopy Configuration Files <https://wiki.analog.com/_media/resources/eval/user-guides/hosc_scopy_config_files.zip>`__

KWIK Demo PCB Schematic
-----------------------

| `EVAL-KW4503Z Schematic <https://wiki.analog.com/_media/resources/eval/user-guides/stability_kwik_demo_schematic.pdf>`__
| ===== KWIK Demo PCB Bill of Materials ===== `EVAL-KW4503Z BOM <https://wiki.analog.com/_media/resources/eval/user-guides/stability_kwik_demo_bom.pdf>`__
| ===== KWIK Demo Gerber Files ===== `EVAL-KW4503Z Gerber Files <https://wiki.analog.com/_media/resources/eval/user-guides/stability_kwik_demo_gerbers.zip>`__
...
`Software Setup Instructions for LTSpice (installation and first time use), ADALM2000 (installation and first time use) and Scopy (installation and first time use) <https://wiki.analog.com/_media/resources/eval/user-guides/adalm2000_scopy_and_ltspice_setup_instructions_v1.0.docx>`__

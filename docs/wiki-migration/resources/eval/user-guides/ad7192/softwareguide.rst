...
.. _ad7192-demo-modes-1:

AD7192 Demo Modes
=================

| :doc:`Visit the demo mode section here </wiki-migration/resources/eval/user-guides/ad7192/softwareguide/demo_modes>`
...
-  Navigate to the Virtual Eval tool by clicking this link: `Virtual Eval <http://beta-tools.analog.com/virtualeval/>`__ or alternatively, by going to the AD7192 homepage on analog.com and finding the link there.

...
.. admonition:: Download
   ...
   `EV-GEAR-EINK Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/ev-gear-eink1z_schematics.pdf>`__

   | `EV-GEAR-EINK1Z Layout and BOM <https://wiki.analog.com/_media/resources/eval/user-guides/ev-gear-eink1z_-_fab.zip>`__
   | `EV-GEAR-EINK1Z assembly <https://wiki.analog.com/_media/resources/eval/user-guides/ev-gear-eink1z_-_assembly_files.zip>`__

...
.. admonition:: Download
   ...
   `Rev. B Hardware design files (including schematics, BoM and layout) <https://wiki.analog.com/_media/resources/eval/user-guides/ad-96tofebz/tof_laser_revb.zip>`__ `Rev. C Hardware design files (including schematics, BoM and layout) <https://wiki.analog.com/_media/resources/eval/user-guides/ad-96tofebz/tof_laser_revc.zip>`__ `Rev. D Hardware design files (including schematics, BoM and layout) <https://wiki.analog.com/_media/resources/eval/user-guides/ad-96tofebz/tof_laser_revd.zip>`__

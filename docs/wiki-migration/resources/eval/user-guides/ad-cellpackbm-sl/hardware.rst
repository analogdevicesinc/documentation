...
.. admonition:: Download
   ...
   | `AD-CELLPACKBM-SL QuickStart Guide <https://wiki.analog.com/_media/resources/eval/user-guides/ad-cellpackbm-sl/ad-cellpackbm-sl_quick_start_guide.pdf>`__
...
.. note::
   ...
   Consult the `MSDK User Guide <https://analogdevicesinc.github.io/msdk/USERGUIDE/#updating-the-max32625pico-pico-debug-adapter-firmware>`__ for detailed instructions on updating the MAX32625PICO Debug Adapter Firmware.

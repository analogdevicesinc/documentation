...
.. container:: indent
   ...
   .. tip::
      ...
      Users can define the fault threshold limits based on their application by adjusting resistor values. Consult the `schematic <https://wiki.analog.com/_media/resources/eval/user-guides/pa_array/02_079905d_top.pdf>`__ for the resistor values.
...
.. admonition:: Download
   ...
   -  `Schematic <https://wiki.analog.com/_media/resources/eval/user-guides/pa_array/02_079905d_top.pdf>`__
   -  `PCB Layout <https://wiki.analog.com/_media/resources/eval/user-guides/pa_array/08-079905-01-c.pdf>`__
   -  `Bill of Materials <https://wiki.analog.com/_media/resources/eval/user-guides/pa_array/bom.zip>`__
   -  `Allegro Project <https://wiki.analog.com/_media/resources/eval/user-guides/pa_array/allegro_project.zip>`__

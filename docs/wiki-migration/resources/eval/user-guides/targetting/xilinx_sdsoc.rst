...
.. admonition:: Download
   ...
   -  `FMCOMMS2 + ZC702 SDSoC platform generation files <https://wiki.analog.com/_media/resources/eval/user-guides/targetting/fmcomms2_zc702_sdsoc_platform.zip>`__
   -  `FMCOMMS2 + ZC706 SDSoC platform generation files <https://wiki.analog.com/_media/resources/eval/user-guides/targetting/fmcomms2_zc706_sdsoc_platform.zip>`__
   -  `FMCOMMS3 + ZC702 SDSoC platform generation files <https://wiki.analog.com/_media/resources/eval/user-guides/targetting/fmcomms3_zc702_sdsoc_platform.zip>`__
   -  `FMCOMMS3 + ZC706 SDSoC platform generation files <https://wiki.analog.com/_media/resources/eval/user-guides/targetting/fmcomms3_zc706_sdsoc_platform.zip>`__
...
.. admonition:: Download
   ...
   -  `SDSoC DDS source code <https://wiki.analog.com/_media/resources/eval/user-guides/targetting/sdsoc_dds_src.zip>`__

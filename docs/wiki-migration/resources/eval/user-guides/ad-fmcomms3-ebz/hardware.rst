...
.. admonition:: Download
   ...
   .. note::
      ...
      | Note that the RF transformers used as baluns on the Rev A board are Mini Circuits `TCM1-63AX+ <http://www.minicircuits.com/pdfs/TCM1-63AX+.pdf>`__. They are rated for an operating frequency between 10 MHz and 6 GHz.

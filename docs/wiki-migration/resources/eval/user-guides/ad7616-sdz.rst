...
-  `STLINK-V3 <https://www.st.com/en/development-tools/stlink-v3set.html>`__ when using SDP-K1
...
:adi:`EVAL-AD7616` is connected to :adi:`SDP-K1` via fly-wire. In order to flash the SDP-K1, an `STLINK-V3 <https://www.st.com/en/development-tools/stlink-v3set.html>`__ is required

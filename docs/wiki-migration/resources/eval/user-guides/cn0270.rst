...
-  `CN0270 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cn0270>`__ (supplied with provided CD in kit)
...
-  **Link PMOD**
   ...
   -  OPEN : control is via onboard processer and J-Link header.Choose this option if you want to connect the board using the J-Link USB and use the `CN0270 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cn0270>`__

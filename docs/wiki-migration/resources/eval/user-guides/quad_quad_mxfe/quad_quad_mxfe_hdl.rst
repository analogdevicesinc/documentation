...
Built on top of `VCU128 <https://www.xilinx.com/VCU128>`__ but does not match any FMC connector due the high number of lanes. The design requires 64 lanes for Rx and 64 lanes for Tx, but the FMC+ connector can expose only 24 pairs instead of 64.

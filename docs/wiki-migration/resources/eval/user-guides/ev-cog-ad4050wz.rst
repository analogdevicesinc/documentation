...
| |image1| Applications using EV-COG-AD4050WZ board can be developed using one of the following toolchains.
...
-  :doc:`Introduction </wiki-migration/resources/eval/user-guides/ev-cog-ad4050wz/introduction>`
   \* :doc:`Software Packs & Board Support Package </wiki-migration/resources/eval/user-guides/ev-cog-ad4050wz/packs_bsp>`:EV-COG-AD4050WZ software architecture is categorized into 2 groups as below.

   |image2|

   -  :doc:`Analog Devices ADuCM4x50 Device Support </wiki-migration/resources/eval/user-guides/ev-cog-ad4050lz/software/aducm4x50>`

      -  :doc:`Analog Devices EV-COG-AD4050 Off-Chip Drivers and Examples </wiki-migration/resources/eval/user-guides/ev-cog-ad4050wz/software/eval-cog-ad4050wz>`

-  :doc:`QuickStart Guide </wiki-migration/resources/eval/user-guides/ev-cog-ad4050wz/quickstart>`
   \* :doc:`EV-COG-AD4050WZ with CrossCore Embedded Studio </wiki-migration/resources/eval/user-guides/ev-cog-ad4050wz/quickstart_guide/cces>`

::

       * [[/resources/eval/user-guides/ev-cog-ad4050wz/quickstart_guide/iar|EV-COG-AD4050WZ with IAR Embedded Workbench for ARM]]
   * [[/resources/eval/user-guides/ev-cog-ad4050wz/hw_details|Hardware Details]]
     * [[/resources/eval/user-guides/ev-cog-ad4050wz/cog_hw_userguide|EV-COG-AD4050WZ MCU Cog]]\\
   ...
   * [[/resources/eval/user-guides/ev-cog-ad4050lz/tools_driver|Development Tools & Driver]]
     * [[/resources/eval/user-guides/ev-cog-ad4050wz/tools/cces_download|CrossCore Embedded Studio Download & Install]]\\
              *[[/resources/ev/user-guides/ev-cog-ad4050wz/tools/cces_guide|CrossCore Embedded Studio Quickstart Userguide]]\\
     * [[/resources/eval/user-guides/ev-cog-ad4050lz/tools/hardware_usb|Driver installation for on-board debugger (CMSIS-DAP)]]\\
   * [[/resources/eval/user-guides/ev-cog-ad4050wz/example_project|Example Project]]\\

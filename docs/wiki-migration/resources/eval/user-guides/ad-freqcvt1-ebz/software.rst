...
The Analog Devices board support packages for the FMCOMMS3/4 design, on the various supported FPGA carriers, include an additional SPI interface routed to the PMOD board header.

...
-  Review the `ADRV902X Unboxing Video <https://www.youtube.com/watch?v=Oq_9bl5f8fM>`__ and ensure that the ADRV9029 evaluation platform is functional and you are able to interact with the ADRV9029 transceiver through the :adi:`ADRV9029 TES GUI <en/license/licensing-agreement/adrv9029-software-license-agreement.html>`.

...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/picozed-sdr-1x1som/aes-z7pz-sdr1-g-front.jpg
   :align: right
   :width: 400px
...
-  :doc:`RF SOM Hardware </wiki-migration/resources/eval/user-guides/adrv936x_rfsom/hardware>`
...
-  Use the PicoZed SDR Hardware to better understand the AD9364
   ...
   -  :doc:`Quick Start Guides </wiki-migration/resources/eval/user-guides/ad-fmcomms2-ebz/quickstart>`
      ...
      -  :doc:`Linux on PicoZed SDR </wiki-migration/resources/eval/user-guides/ad-fmcomms2-ebz/quickstart/zynq>`
   ...
   -  Linux Applications
      ...
      -  :doc:`PicoZed SDR Control IIO Scope Plugin </wiki-migration/resources/tools-software/linux-software/fmcomms2_plugin>`
      -  :doc:`PicoZed SDR Advanced Control IIO Scope Plugin </wiki-migration/resources/tools-software/linux-software/fmcomms2_advanced_plugin>`
   ...
   -  Push custom data into/out of the PicoZed SDR.
      ...
      -  :doc:`Python Support with AD9364 Interface Class </wiki-migration/resources/tools-software/linux-software/pyadi-iio>`
...
-  :doc:`Additional Documentation about SDR Signal Chains </wiki-migration/resources/eval/user-guides/ad-fmcomms2-ebz/additional_docs>`

...
| ===== DESIGN FILES ===== **EVAL-APOLLO-LD-MBZ** Board schematic, layout and BOM files. `eval-apollo-ld-mbz_design_files.zip <https://wiki.analog.com/_media/resources/eval/user-guides/current-dac/eval-apollo-ld-mbz_design_files.zip>`__
| **EVAL-AD5821A-DBZ** Board schematic, layout and BOM files. `eval-ad5821a-dbz_design_files.zip <https://wiki.analog.com/_media/resources/eval/user-guides/current-dac/eval-ad5821a-dbz_design_files.zip>`__

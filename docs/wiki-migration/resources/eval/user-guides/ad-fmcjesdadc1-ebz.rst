...
The analog I/O on this board, uses the `micro-miniature coaxial <https://en.wikipedia.org/wiki/MMCX_connector>`__ connector. To connect to a SMA based test equipment, you will need something like the `Molex 89761-6810 <https://www.digikey.com/0897616810>`__.
...
.. admonition:: Download
   ...
   -  `schematics <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcjesdadc1-ebz/ad-fmcjesdadc1_r1.1.pdf>`__
...
If you have any questions regarding the AD-FMCJESDADC1-EBZ board or are experiencing any problems while using the board or following the user guides feel free to ask us a question. Questions can be asked on our `EngineerZone support community <ez>>`__. Calling on the phone, emailing someone directly, will only cause things to get answered in much slower manner.

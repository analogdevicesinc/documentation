...
.. admonition:: Download
   ...
   -  PCB Layout
   -  Bill of Materials
   -  Allegro Project (get the `Allegro FREE Physical Viewer <https://www.cadence.com/en_US/home/tools/pcb-design-and-analysis/allegro-downloads-start.html>`__; you need 17.2 or higher)
...
.. admonition:: Download
   ...
   -  `Rev B Schematic <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcomms5-ebz/fmcomms5_schematic.pdf>`__
   -  `Rev B BOM <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcomms5-ebz/fmcomms5-bom.xls>`__
   -  `Rev B Build Files <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcomms5-ebz/fmcomms5_build.zip>`__
   -  `Rev B Allegro Board File <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcomms5-ebz/fmcomms5_revb.7z>`__ (This file is `compressed <http://www.7-zip.org/7z.html>`__). Get the `Allegro FREE Physical Viewer <https://www.cadence.com/en_US/home/tools/pcb-design-and-analysis/allegro-downloads-start.html>`__ (You need 16.5 or higher).

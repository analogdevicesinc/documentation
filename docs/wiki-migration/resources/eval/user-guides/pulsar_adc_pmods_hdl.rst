...
The reference design uses the standard `SPI Engine Framework <:doc:`/wiki-migration/resources/fpga/peripherals/spi_engine`>`__ with an integrated pwm generator, which will provide the required conversion rate for the ADC.

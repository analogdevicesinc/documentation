...
.. admonition:: Download
   ...
   `AD-ACEVSECRDSET-SL Design & Integration Files <https://wiki.analog.com/_media/resources/eval/user-guides/ad-acevsecrdset-sl/ad-acevsecrdset-sl_design_support_package_rev._e.zip>`__
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/AD-ACEVSECRDSET-SL>`__ to receive all these great benefits and more!

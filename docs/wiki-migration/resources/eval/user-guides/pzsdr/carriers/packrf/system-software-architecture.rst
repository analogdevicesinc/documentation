...
-  `U-boot Bootloader <https://xilinx-wiki.atlassian.net/wiki/spaces/A/pages/18841973/Build+U-Boot>`__
-  `Graphical User Interface (GUI) <https://github.com/analogdevicesinc/rfsom-box-gui>`__

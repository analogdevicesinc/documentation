...
-  `AMD/XILINX KV260 <https://www.xilinx.com/products/som/kria/kv260-vision-starter-kit.html>`__

Reference HDL Design
--------------------

The design is built upon ADI's generic HDL reference design framework. Thus, this reference design is used to interface the GMSL technology by using the MIPI CSI-2 `specification <https://www.mipi.org/specifications/csi-2>`__ for high-speed data transmission, and I2C standard for control. An in-depth presentation and instructions about the HDL design framework in general, can be found in the :doc:`ADI Reference Designs HDL User Guide </wiki-migration/resources/fpga/docs/hdl>`.

...
MCU Cog has an on-board debugger which supports the `ARM CMSIS DAP <https://developer.mbed.org/handbook/CMSIS-DAP>`__ interface. When connecting up the EV-COG-AD3029LZ to your computer or laptop, all the necessary drivers are automatically located and loaded up when using Windows operating systems.
...
.. admonition:: Download
   ...
   `EV-COG-AD3029LZ Interface File <https://wiki.analog.com/_media/resources/eval/user-guides/eval-cog-ad3029lz/tools/ev_cog_ad3029lz_mbed.zip>`__

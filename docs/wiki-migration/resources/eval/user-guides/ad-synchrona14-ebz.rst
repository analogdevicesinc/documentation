...
| <WRAP> |image1| |image2| <fc #c0c0c0>\ *Figure 1. AD-SYNCHRONA14-EBZ Front and Back Panel*\ </fc> </WRAP>
...
.. container:: centeralign
   ...
   |image3| <fc #c0c0c0>\ *Figure 2. AD-SYNCHRONA14-EBZ Simplified Block Diagram*\ </fc>
...
.. container:: centeralign
   ...
   |image4| <fc #c0c0c0>\ *Figure 3. AD-SYNCHRONA14-EBZ Channel Configuration*\ </fc>


| \| For LVDS
| ac-coupled \| Insert C61, C62 and R95, R96 for downstream devices with high impedance input. \|
...
| The `CJT-BH connector series <https://www.samtec.com/products/cjt-bh>`__ from Samtec are paired with `C28S connector series <https://www.samtec.com/products/c28s>`__ – Circular RF Twinax Cable Assembly.
| ==== Clock Input (Reference Input) ==== On the back panel, there are 3 differential 100 Ω inputs.
...
.. container:: centeralign
   ...
   | |image5| <fc #c0c0c0>\ *Figure 4. PuTTY Terminal View*\ </fc>


| ==== General Page ==== The General Page of the GUI allows users to enable/disable channels, and set the frequencies on each channel. Refer to the **Clock Output Configuration** section above for the proper settings.

.. container:: centeralign

   |image6| <fc #c0c0c0>\ *Figure 5. GUI - General Page View*\ </fc>
...
.. container:: centeralign
   ...
   |image7| <fc #c0c0c0>\ *Figure 6. Coarse Delay Settings Menu*\ </fc>
...
.. container:: centeralign
   ...
   |image8| <fc #c0c0c0>\ *Figure 7. AD-SYNCHRONA14-EBZ Status Icons*\ </fc>
...
| 
| ==== Advanced Page ==== In the Advanced Page of the GUI, you can find a detailed block diagram of AD-SYNCHRONA14-EBZ.
...
.. container:: centeralign
   ...
   |image9| <fc #c0c0c0>\ *Figure 8. GUI - Advanced Page View*\ </fc>


| === Input Priority === The input priority table is used to prioritize the input references.
...
.. container:: centeralign
   ...
   |image10| <fc #c0c0c0>\ *Figure 9. Input Priority Menu*\ </fc>
...
| 
| === Coarse Delay & Fine Delay === Coarse delay and fine delay settings are also available in the **Advanced Page**.

.. container:: centeralign

   |image11| <fc #c0c0c0>\ *Figure 10. Coarse and Fine Delay Settings Menu*\ </fc>
...
.. container:: centeralign
   ...
   |image12| <fc #c0c0c0>\ *Figure 11. Debug Page View*\ </fc>
...
.. container:: centeralign
   ...
   |image13| <fc #c0c0c0>\ *Figure 12. AD-SYNCHRONA14-EBZ Functional Block Diagram*\ </fc>
...
.. container:: centeralign
   ...
   |image14| <fc #c0c0c0>\ *Figure 13. Add-on Voltage Translation Board*\ </fc>
...
.. container:: centeralign
   ...
   |image15| <fc #c0c0c0>\ *Figure 14. Top View of the Add-on Voltage Translation Board*\ </fc>
...
.. admonition:: Download
   ...
   `Schematic AD-SYNCHRONA14-EBZ <https://wiki.analog.com/_media/resources/eval/user-guides/ad-synchrona14-ebz/02-064652-01-b.pdf>`__


   | `Schematic ADD-ON BOARD <https://wiki.analog.com/_media/resources/eval/user-guides/ad-synchrona14-ebz/02-068851-01-a.pdf>`__
   |

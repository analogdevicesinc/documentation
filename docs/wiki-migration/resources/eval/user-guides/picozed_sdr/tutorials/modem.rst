...
A detailed workflow that governs this model development is outlined the figure above, capturing the necessary steps from ideas to production ready hardware. This flow has explored previous in an :adi:`article series about ADS-B <en/analog-dialogue/articles/using-model-based-design-sdr-1.html>`.

Source Outline
--------------

The modem project is available under the :git-MathWorks_tools:`MathWorks_tools <targeting_models/modem-qpsk>` repository. The code is structured in the following way:
...
-  Streaming
   ...
   -  FMCOMMS 2/3/4 with Zed, ZC706, and ZC102
   -  ADALM-PLUTO
...
The main dependencies across all example are `MATLAB <https://www.mathworks.com/products/matlab/>`__ version *2017b* or later, and your license needs to include the following components:
...
+===============================+================================================================+======================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================+
| EndToEndTest.m                | Floating-Point MATLAB simulation with optional radio streaming | `Pluto HSP <https://www.mathworks.com/hardware-support/adalm-pluto-radio.html>`__                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
+-------------------------------+----------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| RadioReceiver.slx             | Floating-Point Simulink simulation                             | `Simulink <https://www.mathworks.com/products/simulink/>`__                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
+-------------------------------+----------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| combinedTxRx_StandardIQ.slx   | Fixed-Point Simulink deployable model                          | `Simulink <https://www.mathworks.com/products/simulink/>`__, `HDL Coder <https://www.mathworks.com/products/hdl-coder/>`__, `HDL Coder Support Package for Xilinx Zynq-7000 Platform <https://www.mathworks.com/matlabcentral/fileexchange/40447-hdl-coder-support-package-for-xilinx-zynq-7000-platform>`__                                                                                                                                                                                                                                                                                         |
+-------------------------------+----------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| combinedTxRx_ExternalMode.slx | Fixed-Point Simulink deployable model                          | `Simulink <https://www.mathworks.com/products/simulink/>`__, `HDL Coder <https://www.mathworks.com/products/hdl-coder/>`__, `Embedded Coder <https://www.mathworks.com/products/embedded-coder/>`__,\ `HDL Coder Support Package for Xilinx Zynq-7000 Platform <https://www.mathworks.com/matlabcentral/fileexchange/40447-hdl-coder-support-package-for-xilinx-zynq-7000-platform>`__, `Embedded Coder Support Package for Xilinx Zynq-7000 Platform <https://www.mathworks.com/matlabcentral/fileexchange/40448-embedded-coder-support-package-for-xilinx-zynq-7000-platform>`__                   |
+-------------------------------+----------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| combinedTxRx_ADIDMA.slx       | Fixed-Point Simulink deployable model                          | `Simulink <https://www.mathworks.com/products/simulink/>`__, `HDL Coder <https://www.mathworks.com/products/hdl-coder/>`__, `HDL Coder Support Package for Xilinx Zynq-7000 Platform <https://www.mathworks.com/matlabcentral/fileexchange/40447-hdl-coder-support-package-for-xilinx-zynq-7000-platform>`__, :doc:`Analog Devices BSP </wiki-migration/resources/eval/user-guides/ad-fmcomms2-ebz/software/matlab_bsp>`                                                                                                                                                                             |
+-------------------------------+----------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Receiver_FPGACap.slx          | Fixed-Point Simulink deployable model                          | `Simulink <https://www.mathworks.com/products/simulink/>`__, `HDL Coder <https://www.mathworks.com/products/hdl-coder/>`__, `HDL Coder Support Package for Xilinx Zynq-7000 Platform <https://www.mathworks.com/matlabcentral/fileexchange/40447-hdl-coder-support-package-for-xilinx-zynq-7000-platform>`__, `HDL Verifier <https://www.mathworks.com/products/hdl-verifier/>`__, `HDL Verifier Support Package for Xilinx FPGA Boards <https://www.mathworks.com/matlabcentral/fileexchange/40434-hdl-verifier-support-package-for-xilinx-fpga-boards>`__                                          |
+-------------------------------+----------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
-  :git-MathWorks_tools:`targeting_models/modem-qpsk/FixedPoint/demos/Standard_IQ`
-  :git-MathWorks_tools:`targeting_models/modem-qpsk/FixedPoint/demos/AXI_MM`
-  :git-MathWorks_tools:`targeting_models/modem-qpsk/FixedPoint/demos/FPGA_Capture`
-  :git-MathWorks_tools:`targeting_models/modem-qpsk/FixedPoint/demos/External_Mode`
-  :git-MathWorks_tools:`targeting_models/modem-qpsk/FixedPoint/demos/ADI_AXIMM`
...
Clone the repository: <code> git clone https://github.com/analogdevicesinc/MathWorks_tools.git\ </code>

Launch MATLAB and navigate to the *MathWorks_tools\\target_models\\modem-qpsk* folder. Now add the necessary files to your path by running the startup script: <code> startup </code>
...
First, make sure you have gone through the setup process for your given board documented `SDR set up <https://www.mathworks.com/help/supportpkg/xilinxzynqbasedradio/installation-and-setup.html>`__. The deployed model is applicable for FMComms 2/3/4 and ADI RF SOM SDR devices.
...
Exposing some of the model's configuration parameters and status values as AXI-Lite registers provides the means to configure and monitor the IP at runtime from software. This way the IP does not have to be regenerated every time a tunning value needs to change and debugging becomes much more flexible.
...
-  `Radio Deployment on SoC Platforms <mw>videos/radio-deployment-on-soc-platforms-1513346830203.html]>`__

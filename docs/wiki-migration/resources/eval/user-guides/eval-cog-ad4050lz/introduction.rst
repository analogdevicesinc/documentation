...
-  An optional connectivity *Cog* (such as the :doc:`EV-COG-BLEINTP1Z Connectivity Cog </wiki-migration/resources/eval/user-guides/ev-cog-bleintp1z>`) which offers BTLE, LPWAN or WiFi connectivity options.

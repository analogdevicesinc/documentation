...
Interfaced with EVAL-CN0363-PMDZ is an FPGA development board (`ZED Board <http://zedboard.org/product/zedboard>`__ rev C or later). Zedboard requires a separate 12V DC power supply connected to its DC power jack.

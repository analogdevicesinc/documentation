...
-  `SDP USB Driver Installer <https://swdownloads.analog.com/ACE/SDP/SDPDrivers.exe>`__
-  `sdp_drivers_installation_instruction.pdf <https://wiki.analog.com/_media/resources/eval/user-guides/admx/sdp_drivers_installation_instruction.pdf>`__

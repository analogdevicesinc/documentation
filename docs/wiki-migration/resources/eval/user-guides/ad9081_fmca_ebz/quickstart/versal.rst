...
|image1| This guide provides some quick instructions (still takes awhile to download, and set things up) on how to setup the :adi:`AD9081-FMCA-EBZ`/:adi:`AD9082-FMCA-EBZ` on `VCK190 <https://www.xilinx.com/VCK190>`__ board.
...
-  System controller image
   ...
   -  `design-license-xef.html?filename=sc2.2_01.img.zip <https://www.xilinx.com/member/forms/download/design-license-xef.html?filename=sc2.2_01.img.zip>`__

Required Hardware
-----------------

-  Xilinx `VCK190 <https://www.xilinx.com/VCK190>`__

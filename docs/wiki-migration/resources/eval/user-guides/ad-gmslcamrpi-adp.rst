...
.. admonition:: Download
   ...
   **Hardware design files**
   ...
   -  `Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/02_075922a_top.pdf>`__
      \* `Layout <https://wiki.analog.com/_media/resources/eval/user-guides/08_075922a.zip>`__
      \* `High level BOM <https://wiki.analog.com/_media/resources/eval/user-guides/05-075922-01-a.zip>`__
...
Refer to the :doc:`Serializer and Deserializer EV Kit Compatibility Guide </wiki-migration/resources/eval/user-guides/ad-gmslcamrpi-adp/comp_guide>` to see the connections across EV kits.
...
The GMSL Linux kernel drivers, the complete Linux distributions for the supported processing platforms, and software user guides can be found on the `Analog Devices GMSL github repository <https://github.com/analogdevicesinc/gmsl>`__.

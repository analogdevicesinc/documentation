...
-  Make sure the target board is connected to the computer (via **DEBUG USB**) and using the tool bar, navigate to the small Debug icon\ |image2| and select the debugging session you created. The application will programmed and the program execution will stop at the beginning of the main() function.
...
| 
| |Reference Designs#demo_cli|CLI Demo|

.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/reference_designs/blink_hw_blue.jpg
   :width: 500px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-aducm360-ardz/quickstart/bug.png
   :width: 30px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-aducm360-ardz/reference_designs/project_blink_26_08_2015.png
   :width: 350px
.. |Reference Designs#demo_cli|CLI Demo| image:: /navigation EVAL-ADICUP#none#./

...
| |image2|
| ===Sensor Connections=== The CN-0411 has three hardware connectors which have no polarity and can connect directly to the sensors:
...
| P2 is a terminal block connector for conductivity probe's with no BNC plug. The connection diagram is shown below
| |image6| P3 is a terminal block connector for a 2-wire RTD. The software is compatible with Pt100 and Pt1000 RTDs. The connection diagram is shown below
| |image7|
...
| |image8|
| ===Sensor Select=== PRB_SEL selects the connection to the conductivity sensor. By default, the shunt is placed connecting pin 1 and 2 to measure the conductivity of the solution.
...
.. _total-dissolved-solids-measurement-1:
...
| The system can automatically select the proper gain resistance from the user-defined excitation voltage when commanding the system to measure TDS. Below is the procedure used to select the gain resistance appropriate to the measured conductivity range.
| |image10|
| To decrease the effect of system noise to the measurement, the zero-scale calibration should be performed once per board. Every measured voltage level will be referenced to the zero-scale calibration voltage. Below are the steps to perform zero-scale calibration.
...
-  :doc:`ADICUP360 + CN0411 Demo Software and Setup </wiki-migration/resources/eval/user-guides/eval-adicup360/reference_designs/demo_cn0411>`
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0411-ARDZ?&v=RevC>`__ to receive all these great benefits and more!


// End of Document //

.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/hardware/cn0411/20180628_145941.jpg
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/hardware/cn0411/shunt_header_positions.jpg
   :width: 600px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/hardware/cn0411/s217t.gif
   :width: 200px
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/hardware/cn0411/cs-sk20.jpg
   :width: 200px
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/hardware/cn0411/s218t.gif
   :width: 200px
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/hardware/cn0411/probe_connection.png
   :width: 600px
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/hardware/cn0411/rtd_connection.png
   :width: 600px
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/hardware/cn0411/board_silkscreen_with_edits.png
   :width: 600px
.. |image9| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/hardware/cn0411/probe_immersion.png
   :width: 200px
.. |image10| image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/hardware/cn0411/auto-range_flowchart.png
   :width: 600px

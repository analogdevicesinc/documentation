...
.. important::
   ...
   It EXTREMELY important to ensure that all drivers are installed, before trying to use the ADICUP360 with the ADuCM360-IDE. So when you see that the drivers are being installed in the task bar, open it up and wait till everything finished before progressing.

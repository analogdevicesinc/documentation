...
-  `ADAR2004-EVALZ Schematic <https://wiki.analog.com/_media/resources/eval/user-guides/adar2004/02_048685d_top.pdf>`__
-  `ADAR2004-EVALZ Layout File <https://wiki.analog.com/_media/resources/eval/user-guides/adar2004/08_048685d.zip>`__
-  `ADAR2004-EVALZ Gerbers <https://wiki.analog.com/_media/resources/eval/user-guides/adar2004/adar2004_fab.zip>`__
...
-  Open :adi:`ace` and connect to the board by double-clicking on the ":adi:`adar2004` Board" plugin in the "Attached Hardware" section of the Start page. See `Figure 4 <https://wiki.analog.com/>`__.

...
The :adi:`ADRV9361-Z7035` is built on a portfolio of highly integrated System-On-Module (SOMs) based on the Xilinx Zynq®-7000 All Programmable (AP)SoC. Starting with the AD9361, it is schematically & HDL similar to the `ad-fmcomms3-ebz <https://wiki.analog.com/ad-fmcomms3-ebz>`__.
...
-  :doc:`Introduction to the AD9361. </wiki-migration/resources/eval/user-guides/ad9361>`
...
-  :doc:`Introduction to Boards Based on the AD9361. </wiki-migration/resources/eval/user-guides/adrv9361-z7035/introduction>`
-  ADRV9361-Z7035 Hardware

   -  :doc:`Mechanical Design </wiki-migration/resources/eval/user-guides/adrv9361-z7035/mechanical>`
   ...
   -  :doc:`Revision History </wiki-migration/resources/eval/user-guides/adrv9361-z7035/revision-history>`

      -  including schematics and BOM

   -  Carriers

      -  :doc:`FMC Carrier (PZSDRCC-FMC) </wiki-migration/resources/eval/user-guides/pzsdr/carriers/fmc>`
      -  :doc:`Breakout Carrier (PZSDRCC-BRK) </wiki-migration/resources/eval/user-guides/pzsdr/carriers/brk>`
...
-  Design with the AD9361
   ...
   -  Simulation
      ...
      -  :doc:`MathWorks RF Blockset Models of the AD9361 </wiki-migration/resources/eval/user-guides/ad-fmcomms2-ebz/software/simrf>`

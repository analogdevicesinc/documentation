...
These scripts make use of the `v4l2-ctl <https://manpages.ubuntu.com/manpages/bionic/man1/v4l2-ctl.1.html>`__ command line tool in Linux. Note, this is pre-installed on the EVAL-ADTF3175D Linux.

`adsd3500.c <https://github.com/ToF?master/drivers/adsd3500/nxp/src/adsd3500.c>`__
...
Line 9: Start the stream; width is MP width of 1024; height is 3072 pixels - 3 phase frames (1024x1024 each), no AB, no confidence; pixel format `BG12 <https://www.kernel.org/doc/html/v4.8/media/uapi/v4l/pixfmt-srggb12.html>`__.

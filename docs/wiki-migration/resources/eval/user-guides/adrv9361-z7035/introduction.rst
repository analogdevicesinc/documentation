...
|                                                                  |               | Tx / Rx      | (Ranges)            | (Ranges)            |                                                          |             |
+==================================================================+===============+==============+=====================+=====================+==========================================================+=============+
| `ADRV9361-Z7035 <https://wiki.analog.com/../adrv9361-z7035>`__   | 1 x AD9361    | 2 x 2        | 2 (2400 - 2500 MHz) | 2 (2400 - 2500 MHz) | Highly Integrated System on Module                       | HSMC        |
+------------------------------------------------------------------+---------------+--------------+---------------------+---------------------+----------------------------------------------------------+-------------+
| `ADRV9364-Z7020 <https://wiki.analog.com/../adrv9364-z7020>`__   | 1 x AD9364    | 1 x 1        | 1 (2400 - 2500 MHz) | 1 (2400 - 2500 MHz) | Highly Integrated System on Module                       | HSMC        |
+------------------------------------------------------------------+---------------+--------------+---------------------+---------------------+----------------------------------------------------------+-------------+
...
+------------------------------------------------------------------------------------------------------+-------------+----------------+----------------+--------------+----------+---------+
| Board                                                                                                | ADALM-Pluto | ADRV9361-Z7035 | ADRV9364-Z7020 | FMCOMMS2/3/4 | FMCOMMS5 | Arradio |
+======================================================================================================+=============+================+================+==============+==========+=========+
| `FMC Carrier <https://wiki.analog.com/../pzsdr/carriers/fmc>`__                                      |             | √              | √              | √            |          |         |
+------------------------------------------------------------------------------------------------------+-------------+----------------+----------------+--------------+----------+---------+
| `Breakout Board <https://wiki.analog.com/../pzsdr/carriers/brk>`__                                   |             | √              | √              | √            |          |         |
+------------------------------------------------------------------------------------------------------+-------------+----------------+----------------+--------------+----------+---------+
| `PCIe Carrier <https://wiki.analog.com/../pzsdr/carriers/pcie>`__                                    |             | √              | √              | √            |          |         |
+------------------------------------------------------------------------------------------------------+-------------+----------------+----------------+--------------+----------+---------+
| `PackRF Carrier <https://wiki.analog.com/../pzsdr/carriers/packrf>`__                                |             | √              | √              | √            |          |         |
+------------------------------------------------------------------------------------------------------+-------------+----------------+----------------+--------------+----------+---------+
...
+------------------------------------------------------------------------------------------------------+-------------+----------------+----------------+--------------+----------+---------+
| `MITX045 <http://zedboard.org/product/mini-itx-board>`__                                             |             |                |                | √            |          |         |
+------------------------------------------------------------------------------------------------------+-------------+----------------+----------------+--------------+----------+---------+
| `SoCKit <https://www.arrow.com/en/products/sockit/arrow-development-tools>`__                        |             |                |                |              |          | √       |
+------------------------------------------------------------------------------------------------------+-------------+----------------+----------------+--------------+----------+---------+
...
The items needed to get started are detailed in the `prerequisites <https://wiki.analog.com/prerequisites>`__, and the `quickstart <https://wiki.analog.com/quickstart>`__. They detail supported carriers, external equipment requirements and how to set the boot switches.

Once you have a working platform, you may be interested in investigating

-  `Introduction <https://wiki.analog.com/resources/eval/user-guides/adrv9361-z7035/ad9361>`__ to the AD9361/AD9364
-  `Tuning <https://wiki.analog.com/resources/eval/user-guides/adrv9361-z7035/software/filters>`__ the AD9361/AD9364 FIR Filters for your application
-  How to `simulate <https://wiki.analog.com/resources/eval/user-guides/adrv9361-z7035/software/simrf>`__ the part with `MathWorks SimRF <https://www.mathworks.com/hardware-support/analog-devices-rf-transceivers.html>`__, to see if it is appropriate for your application
...
-  Create your own `custom HDL from Simulink <https://wiki.analog.com/resources/eval/user-guides/adrv9361-z7035/software/matlab_bsp>`__ and insert it into the ADI design to see how it works
-  Modifying the `ADI provided HDL <https://wiki.analog.com/reference_hdl>`__
...
-  `ADRV9361-Z7035 <https://wiki.analog.com/../adrv9361-z7035>`__

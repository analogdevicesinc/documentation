...
-  Install Cross Core Embedded Studio
   ...
   -  `CrossCore Embedded Studio 2.7.0 for Ubuntu Linux 14.04 x86 <http://download.analog.com/tools/CrossCoreEmbeddedStudio/Releases/Release_2.7.0/adi-CrossCoreEmbeddedStudio-linux-x86-2.7.0.deb>`__
...
-  Download the following packs for EV-COG-AD4050LZ
   ...
   -  `Analog Devices ADuCM4050_DFP Pack 3.2.0 (Latest) <http://download.analog.com/tools/EZBoards/ADuCM4050/Releases/AnalogDevices.ADuCM4x50_DFP.3.2.0.pack>`__

...
.. warning::
   ...
   Xilinx provide a list of `monitors <https://support.xilinx.com/s/article/68671?language=en_US>`__ that were tested and work with the Ultrascale+ Display Port controller.
...
-  on-board 38.4MHz oscillator - `GTXO-74V/JI <https://www.golledge.com/products/gtxo-74v-low-phase-noise-sm-tcxo-with-voltage-control-and-clipped-sine-output/c-26/p-327>`__ made by Golledge
...
The RF Add-on board expose B receive channels RX1B and RX2B to the front pannel. The receive path has a by-passable `LNA TSY-13LNB+ <https://www.minicircuits.com/WebStore/dashboard.html?model=TSY-13LNB%2B>`__ with frequency range 10MHz to 1GHz.
...
.. admonition:: Download
   ...
   -  `Rev C Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/jupiter-sdr/02-048139-01-c.pdf>`__
   -  `Rev C BOM <https://wiki.analog.com/_media/resources/eval/user-guides/jupiter-sdr/05-048139-01-c.zip>`__
...
.. admonition:: Download
   ...
   -  `Rev B Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/jupiter-sdr/02-071103-01-b.pdf>`__
   -  `Rev B BOM <https://wiki.analog.com/_media/resources/eval/user-guides/jupiter-sdr/05-071103-01-b.zip>`__

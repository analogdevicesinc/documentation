...
Although this board does meet most of the FMC specifications, it is not meant as a `commercial off the shelf <https://en.wikipedia.org/wiki/Commercial_off-the-shelf>`__ (COTS) board. If you want a commercial, ready to integrate product, please refer to one of the many FMC manufacturers.
...
.. admonition:: Download
   ...
   -  `02-036007-01-c-1.pdf <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcadc2-ebz/02-036007-01-c-1.pdf>`__
   -  `AD-FMCADC2-EBZ_gerbers.zip <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcadc2-ebz/AD-FMCADC2-EBZ_gerbers.zip>`__
   -  `05_036007_c_bom_wiki.xlsx <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcadc2-ebz/05_036007_c_bom_wiki.xlsx>`__
...
.. admonition:: Download
   ...
   -  `02_036007d.pdf <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcadc2-ebz/02_036007d.pdf>`__
   -  `AD-FMCADC2-EBZ_RevD_gerbers.zip <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcadc2-ebz/AD-FMCADC2-EBZ_RevD_gerbers.zip>`__
   -  `036007_d_bom_wiki.xlsx <https://wiki.analog.com/_media/resources/eval/user-guides/ad-fmcadc2-ebz/036007_d_bom_wiki.xlsx>`__

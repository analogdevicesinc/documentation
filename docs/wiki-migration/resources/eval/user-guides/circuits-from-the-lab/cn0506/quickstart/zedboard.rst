CN0506 + ZedBoard Quick Start Guide
===================================

This guide provides some quick instructions (still takes a while to download and set things up) on how to setup the :adi:`EVAL-CN0506-FMCZ` on the `ZedBoard <avnet>ZedBoard>`__ platform.
...
-  Avnet `ZedBoard <avnet>ZedBoard>`__ Rev 1.0 or later board
...
-  Turn on the power switch (SW8) on the FPGA board. Green Power LED (LD13) should illuminate. Wait ~ 15 seconds. The blue Done LED (LD12) should illuminate.

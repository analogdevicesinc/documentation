CN0506 + Arria 10 SoC Quick Start Guide
=======================================

This guide provides some quick instructions (still takes awhile to download, and set things up) on how to setup the :adi:`EVAL-CN0506-FMCZ` on the `Arria 10 SoC <https://www.intel.com/content/www/us/en/programmable/Arria 10 SoC>`__ platform.

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad9208_dual_ebz/quickstart/tbd.png
   :width: 600px
...
`Schematic, Gerber layout and BOM <https://wiki.analog.com/_media/resources/eval/user-guides/ad9208_dual_ebz/quickstart/ad9208-dual-ebz.zip>`__
...
-  Altera `Arria 10 SoC <https://www.intel.com/content/www/us/en/programmable/Arria 10 SoC>`__ Rev 1.0 or later board
...
-  IIO Scope :git-iio-oscilloscope:`Download <releases/download/v0.13-master/adi-osc-setup.exe>`
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad9208_dual_ebz/quickstart/iio_connect_noip.png
   :align: center
...
-  :doc:`EVAL-CN0506-FMCZ Hardware User Guide </wiki-migration/resources/eval/user-guides/circuits-from-the-lab/cn0506>`
-  :doc:`CN0506 HDL Development </wiki-migration/resources/eval/user-guides/circuits-from-the-lab/cn0506/hdl>`


.. note::

   See `resources/eval/user-guides/circuits-from-the-lab/CN0506 <https://wiki.analog.com/resources/eval/user-guides/circuits-from-the-lab/CN0506#Support>`__


.. |Subclass 0| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad9208_dual_ebz/quickstart/subclass0_waves.png
   :width: 800px
.. |Subclass 1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad9208_dual_ebz/quickstart/subclass1_waves.png
   :width: 800px

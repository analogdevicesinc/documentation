...
-  Extract the files within the file **CN0323 SDP Eval Software.zip** and open the file **setup.exe**. It is recommended that you install the CN0323 SDP Evaluation Software to the default directory path **C:\\Program Files\\Analog Devices\\CN0323\\** and all National Instruments products to **C:\\Program Files\\National Instruments\\**\
...
-  Step 1: Begin by selecting manual or automatic calibration.
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0323-SDPZ?&v=RevA>`__ to receive all these great benefits and more!


.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0323/software_install_2.png
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0323/software_install_3.png
   :width: 600px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0323/software_install_5.png
   :width: 600px
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0323/software_install_6.png
   :width: 600px
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0323/software_install_7.png
   :width: 600px
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0323/software_front_panel_2.png
   :width: 600px
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0323/software_front_panel_1.png
   :width: 600px

...
-  :adi:`EVAL-CFTL-LVDT <CN0371>` Linear Variable Differential Transformer (Measurement Specialties, Inc. E-100 Economy Series LVDT)
-  `CN-0371 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0371>`__
...
-  The :adi:`EVAL-CN0371-SDPZ` **(CN-0371 Board)** connects to the :adi:`EVAL-SDP-CB1Z` **(SDP-B Board)** via the 120-Pin connector
-  The :adi:`EVAL-CFTL-6V-PWRZ` **(+6V DC Power Supply)** powers the :adi:`EVAL-CN0371-SDPZ <CN0371>` **(CN-0371 Board)** via the DC barrel jack
-  The :adi:`EVAL-CFTL-LVDT <CN0371>` **(LVDT)** connects to the :adi:`EVAL-CN0371-SDPZ <CN0371>` **(CN-0371 Board)** via the 6-pin header at **J3**.

| 
| |cn0371-test_setup.png|
...
-  Extract the file **CN0371 Eval Software.zip** and open the file **setup.exe**.

.. tip::

   \ **NOTE:** It is recommended that you install the `CN-0371 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0371>`__ to the default directory path **C:\\Program Files\\Analog Devices\\CN0371\\** and all National Instruments products to **C:\\Program Files\\National Instruments\\**\
...
-  Upon completion of the installation of the **CN-0371 Evaluation Software**, the installer for the **ADI SDP Drivers** will execute.
...
-  Connect the :adi:`EVAL-CFTL-LVDT <CN0371>` **(LVDT)** to **J3** of the :adi:`EVAL-CN0371-SDPZ` **(CN-0371 Board)** as depicted below.
...
|cn0371-wiring_schematic.png|

-  Connect **P3** of the :adi:`EVAL-CN0371-SDPZ` **(CN-0371 Board)** to **CON A** of the :adi:`EVAL-SDP-CB1Z` **(SDP-B Board)**
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0371-SDPZ?&v=RevB>`__ to receive all these great benefits and more!


.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0371/cn0371-simplified_schematic.png
   :width: 800px
.. |cn0371-test_setup.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0371/cn0371-test_setup.png
   :width: 600px
.. |CN0371-install1.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/CN0371/CN0371-install1.png
   :width: 600px
.. |CN0371-install2.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/CN0371/CN0371-install2.png
   :width: 600px
.. |CN0371-install3.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/CN0371/CN0371-install3.png
   :width: 600px
.. |CN0371-install4.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/CN0371/CN0371-install4.png
   :width: 600px
.. |CN0371-install5.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/CN0371/CN0371-install5.png
   :width: 600px
.. |cn0371-wiring_schematic.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0371/cn0371-wiring_schematic.png
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0371/cn0371-hardware1.jpg
   :width: 600px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0371/cn0371-software1.png
   :width: 800px
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0371/cn0371-software2.png
   :width: 800px
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0371/cn0371-software3.png
   :width: 800px

...
-  `CN-0371 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0371>`_
...
.. tip::
   ...
   \ **NOTE:** It is recommended that you install the `CN-0371 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0371>`_ to the default directory path **C:\\Program Files\\Analog Devices\\CN0371\\** and all National Instruments products to **C:\\Program Files\\National Instruments\\**\
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0371-SDPZ?&v=RevB>`_ to receive all these great benefits and more!

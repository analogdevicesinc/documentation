...
-  :adi:`EVAL-CN0233-SDPZ` Evaluation Board
-  :adi:`EVAL-SDP-CB1Z` Evaluation Board
-  `CN0233 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0233>`__
...
-  Extract the file **CN0233 Eval Software.zip** and open the file **setup.exe**.

.. tip::

   \ **NOTE:** It is recommended that you install the `CN0233 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0233>`__ to the default directory path **C:\\Program Files\\Analog Devices\\CN0233\\** and all National Instruments products to **C:\\Program Files\\National Instruments\\**\
...
|image2|
   ...
   \* Upon completion of the installation of the **CN0233 Evaluation Software**, the installer for the **ADI SDP Drivers** will execute.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0233/cn0233-figure_6.jpg
   :align: center

-  Connect the 120-pin connector on the :adi:`EVAL-CN0233-SDPZ` circuit board to the connector marked “CON A” on the EVAL-SDP-CB1Z evaluation (SDP) board. Nylon hardware should be used to firmly secure the two boards, using the holes provided at the ends of the 120-pin connectors as depicted in the image below.
-  Connect a voltmeter to Vout of :adi:`EVAL-CN0233-SDPZ`.
-  Connect a current meter to Iout of :adi:`EVAL-CN0233-SDPZ`.
-  To power on the :adi:`EVAL-CN0233-SDPZ`, connect the +6V DC power supply to P2, using a wallwart power supply, or to P3, using bench supply.
...
.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0233/cn0233-figure_1a.jpg
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0233/cn0233-figure_2a.jpg
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0233/cn0233-figure_3a.jpg
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0233/cn0233-figure_4a.jpg
...
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0233/cn0233_cn0233-figure_7.jpg
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0233/cn0233_cn0233-figure_8.jpg

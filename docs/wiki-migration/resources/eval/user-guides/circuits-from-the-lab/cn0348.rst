...
-  `CN0348 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0348>`__
...
.. tip::
   ...
   \ **NOTE:** It is recommended that you install the `CN0348 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0348>`__ to the default directory path **C:\\Program Files\\Analog Devices\\CN0348\\** and all National Instruments products to **C:\\Program Files\\National Instruments\\**\
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0348-SDPZ?&v=RevB>`__ to receive all these great benefits and more!

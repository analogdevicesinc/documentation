...
:adi:`CN-0348 <CN0348>` showcases a solution for precision 16-bit digital-to-analog conversion with wide dynamic signal range in a single supply system. It utilizes a 5V voltage reference (:adi:`ADR4550`), a voltage output digital-to-analog converter (:adi:`AD5541A`), and a rail-rail amplifier as the output buffer (:adi:`ADA4500-2`). The ADA4500-2 exhibits zero crossover distortion and this feature makes it an excellent choice as an output buffer to maintain the linearity of the AD5541A over its input digital code and provide a wide dynamic output range. The combination of parts provides industry-leading 16-bit integral nonlinearity (INL) of ±1LSB and differential nonlinearity (DNL) of ±1LSB with guaranteed monotonicity. This user guide gives information on how to use the evaluation software to collect data from the :adi:`EVAL-CN0348-SDPZ` Daughter Board.
...
-  :adi:`EVAL-CN0348-SDPZ` Evaluation Board (**CN-0348 Board**)
-  `CN0348 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0348>`_
...
.. tip::
   ...
   \ **NOTE:** It is recommended that you install the `CN0348 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0348>`_ to the default directory path **C:\\Program Files\\Analog Devices\\CN0348\\** and all National Instruments products to **C:\\Program Files\\National Instruments\\**\
...
| \* Upon completion of the installation of the **CN0348 SDP Evaluation Software**, the installer for the **ADI SDP Drivers** will execute.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/software1.png
   :align: center
   :width: 600px
...
-  The LED indicator displays the current state of the software in the form of an LED. There are three status LED colors\\ |resources-eval-user-guides-circuits-from-the-lab-black_led_button.png|Inactive\\ |resources-eval-user-guides-circuits-from-the-lab-green_led_button.png|Busy\\ |resources-eval-user-guides-circuits-from-the-lab-red_led_button.png|Error\\  \\

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/software2.png
   :align: center
   :width: 600px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/software3.png
   :align: center
   :width: 600px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/software4.png
   :align: center
   :width: 600px
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0348-SDPZ?&v=RevB>`_ to receive all these great benefits and more!


.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0348_simplified_schematic.pdf.png
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0348-install1.png
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0348-install2.png
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0348-install3.png
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0348-install4.png

.. |resources-eval-user-guides-circuits-from-the-lab-black_led_button.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/black_led_button.png
.. |resources-eval-user-guides-circuits-from-the-lab-green_led_button.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/green_led_button.png
.. |resources-eval-user-guides-circuits-from-the-lab-red_led_button.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/red_led_button.png

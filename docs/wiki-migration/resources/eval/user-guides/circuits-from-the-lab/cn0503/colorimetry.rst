...
-  Host computer with CN0503 software (see `Quick Setup Guide <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0503/cn0503_gui_quick_start_guide.docx>`__) and Microsoft Excel (Optional for generating your own measurement curve)
...
-  Load the configuration file for pH Measurement (`cn0503_defaults_ph.zip <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0503/cn0503_defaults_ph.zip>`__)

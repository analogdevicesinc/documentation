...
-  In the settings window, select the correct COM Port of the device and connect (see `Quick Setup Guide <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0503/cn0503_gui_quick_start_guide.docx>`__ for help)

|image10|

-  Load the configuration file for Fluorescence Measurement (`cn0503_defaults_fluorescence.zip <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0503/cn0503_defaults_fluorescence.zip>`__)

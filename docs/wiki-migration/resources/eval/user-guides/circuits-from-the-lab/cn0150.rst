...
| The EVAL-CN0150-SDPZ board connects to ADI’s System Demonstration Platform (SDP) and is powered by a +6 V supply or +6 V “wall wart”. |image1|
| ----

Required Equipment
------------------

-  :adi:`EVAL-CN0150A-SDPZ Evaluation Board <EVAL-CN0150A-SDPZ>`
-  :adi:`EVAL-SDP-CB1Z` Controller Board (**SDP-B Board**)
-  `CN0150A Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0150>`__
-  Power Supply
...
| 
| ==== Test setup ==== |image3|
| \* Connect the 120-pin connector on the :adi:`EVAL-CN0150A-SDPZ Evaluation Board <EVAL-CN0150A-SDPZ>` to the connector marked “CON A” on the :adi:`EVAL-SDP-CB1Z` evaluation (SDP) board

-  Connect the RF signal source to the :adi:`EVAL-CN0150A-SDPZ Evaluation Board <EVAL-CN0150A-SDPZ>` via the SMA RF input connector
...
| 
| ==== Calibration ==== Because the slope and intercept of the system vary from device to device, a system level calibration is **required**.

-  Apply two known signal levels PIN_1 and PIN_2 close to the endpoints of the AD8318 linear input range. Note that it should be well within the linear operating range of the device (**-50 dBm to -10 dBm for this device**)\
...
-  Extract the file **CN0150_Evaluation_Software.zip** and open the file **setup.exe**.

.. tip::

   \ **NOTE:** It is recommended that you install the `CN0150 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0150>`__ to the default directory path **C:\\Program Files (x86)\\Analog Devices\\CN0150\\** and all National Instruments products to **C:\\Program Files\\National Instruments\\**\


   |image5|

-  **Accept** the license agreement to proceed to the installation review page
   |image6|}
   ...
   \* Upon completion of the installation of the **CN-0150 Evaluation Software**, the installer for the **ADI SDP Drivers** will execute.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/11.png
   :align: center
   :width: 700px

-  **Connect** Button - Starts the connection between the :adi:`CN0150 Evaluation Board <CN0150>` and :adi:`SDP-B Controller Board <EVAL-SDP-CB1Z>`.
-  **Reset and Disconnect** Button - Resets and ends the connection between the :adi:`CN0150 Evaluation Board <CN0150>` and :adi:`SDP-B Controller Board <EVAL-SDP-CB1Z>`
...
-  `CN0150 Evaluation Software <https://wiki.analog.com/ftp/ftp.analog.com/pub/cftl/cn0150>`__
-  :adi:`CN0150 Circuit Note Page <CN0150>`
-  :adi:`CN0150 Design Support Package <cn0150>`
...
.. admonition:: Download
   ...
   :adi:`EVAL-CN0150-SDPZ Design & Integration Files <media/en/reference-design-documentation/design-integration-files/CN0150-DesignSupport.zip>`
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0150A-SDPZ?&v=Rev E>`__ to receive all these great benefits and more!


*End of Document*

.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/cn0150-hw-1024.jpg
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/10.png
   :width: 600px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/10-30-2017_2-47-07_pm.png
   :width: 600px
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/14.png
   :width: 400px
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/1.png
   :width: 500px
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/2.png
   :width: 500px
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/3.png
   :width: 500px
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/4.png
   :width: 500px
.. |image9| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/5.png
   :width: 500px
.. |image10| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/6.png
   :width: 500px
.. |image11| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/8.png
   :width: 500px
.. |image12| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/12.png
   :width: 600px
.. |image13| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/15.png
   :width: 600px

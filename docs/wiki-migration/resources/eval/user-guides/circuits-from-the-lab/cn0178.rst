...
| The EVAL-CN0178-SDPZ board connects to ADI’s System Demonstration Platform (SDP) and is powered by a +6 V supply or +6 V “wall wart”. |image1|
| ----

Required Equipment
------------------

-  :adi:`EVAL-CN0178-SDPZ Evaluation Board <EVAL-CN0178-SDPZ>`
-  :adi:`EVAL-SDP-CB1Z` Controller Board (**SDP-B Board**)
-  `CN0178 Evaluation Software <http://swdownloads.analog.com/cse/cftl/CN0178/CN0178_SDP_Eval_Software.zip>`__
...
| |image2|
| \* The :adi:`EVAL-CN0178-SDPZ` **(CN-0178 Board)** connects to the :adi:`EVAL-SDP-CB1Z` **(SDP-B Board)** via the 120-Pin connector
...
| 
| ==== Test setup ==== |image3|
| \* Connect the 120-pin connector on the :adi:`EVAL-CN0178-SDPZ Evaluation Board <EVAL-CN0178-SDPZ>` to the connector marked “CON A” on the :adi:`EVAL-SDP-CB1Z` evaluation (SDP) board

-  Connect the RF signal source to the :adi:`EVAL-CN0178-SDPZ Evaluation Board <EVAL-CN0178-SDPZ>` via the SMA RF input connector
...
-  Extract the file **CN0178_Evaluation_Software.zip** and open the file **setup.exe**.

.. tip::

   \ **NOTE:** It is recommended that you install the `CN0178 Evaluation Software <http://swdownloads.analog.com/cse/cftl/CN0178/CN0178_SDP_Eval_Software.zip>`__ to the default directory path **C:\\Program Files (x86)\\Analog Devices\\CN0178\\** and all National Instruments products to **C:\\Program Files\\National Instruments\\**\
...
|image6|
   ...
   \* Upon completion of the installation of the **CN-0178 Evaluation Software**, the installer for the **ADI SDP Drivers** will execute.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/9.png
   :align: center
   :width: 700px

-  **Connect** Button - Starts the connection between the :adi:`CN0178 Evaluation Board <CN0178>` and :adi:`SDP-B Controller Board <EVAL-SDP-CB1Z>`.
-  **Disconnect** Button - Ends the connection between the :adi:`CN0178 Evaluation Board <CN0178>` and :adi:`SDP-B Controller Board <EVAL-SDP-CB1Z>`
...
-  `CN0178 Evaluation Software <http://swdownloads.analog.com/cse/cftl/CN0178/CN0178_SDP_Eval_Software.zip>`__
-  :adi:`CN0178 Circuit Note Page <CN0178>`
-  :adi:`CN0178 Design Support Package <media/en/reference-design-documentation/design-integration-files/CN0178-DesignSupport.zip>`
...
.. admonition:: Download
   ...
   :adi:`EVAL-CN0178-SDPZ Design & Integration Files <media/en/reference-design-documentation/design-integration-files/CN0178-DesignSupport.zip>`
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0178-SDPZ?&v=Rev C>`__ to receive all these great benefits and more!


*End of Document*

.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/cn0178-hw-1024.jpg
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/10-25-2017_2-16-34_pm.png
   :width: 650px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/10-30-2017_3-33-48_pm.png
   :width: 600px
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/8.png
   :width: 400px
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/1.png
   :width: 500px
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/2.png
   :width: 500px
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/3.png
   :width: 500px
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/4.png
   :width: 500px
.. |image9| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/5.png
   :width: 500px
.. |image10| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/6.png
   :width: 500px
.. |image11| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0178/10.png
   :width: 700px
.. |image12| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0150/11.png
   :width: 700px

Magneto-Resistive Rotational Position Measurement (CN0368)
==========================================================
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/cn0368.jpg
   :align: center
   :width: 600px
...
::
   ...
   *One [[:adi:`CN0368|EVAL-CN0368-SDPZ]]` Evaluation Board
   *[[:adi:`EVAL-SDP-CB1Z|EVAL-SDP-CB1Z]]` Evaluation board
   *[[/ftp/ftp.analog.com/pub/cftl/cn0368|CN0368 Evaluation Software]]
...
-  Press **“Install”** to install the Drivers and complete the installation of all software necessary to evaluate the **EVAL-CN0368-SDPZ**

Opening and Enabling the Evaluation Software
--------------------------------------------

-  Launch the executable found at **C:\\Program Files\\Analog Devices\\CN0368** and press the **“Connect"** button.
-
...
-  A prompt will appear instructing the user to rotate the magnetic stimulus through 360 degrees.

   -  In this time the software is actively calculating VSIN_Offset and VCOS_Offset.

-  Press '**End Calibration**' when finished.

   -  The software will display the magnetic field angle, VSIN_Offset, and VCOS_Offset.

-  Press '**Sample Data**' to actively calculate the magnetic field angle using the offsets calculated during the Single Temperature Calibration.
-
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0368-SDPZ?&v=RevA>`__ to receive all these great benefits and more!


.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/software_2.png
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/software_3.png
   :width: 600px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/software_5.png
   :width: 600px
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/software_6.png
   :width: 600px
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/software_8.png
   :width: 600px
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/single_temperature_calibration.png
   :width: 600px
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/sample_data.png
   :width: 600px
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/multiple_temperature_calibration_1.png
   :width: 600px
.. |image9| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/multiple_temperature_calibration_2.png
   :width: 600px
.. |image10| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/multiple_temperature_calibration_3.png
   :width: 600px
.. |image11| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/multiple_temperature_calibration_4.png
   :width: 600px
.. |image12| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0368/dynamic_calibration_2.png
   :width: 600px

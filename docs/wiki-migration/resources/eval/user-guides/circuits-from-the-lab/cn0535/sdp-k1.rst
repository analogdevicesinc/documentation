...
The following sections on setup describe the steps for setting up the CN0535 board using the :adi:`SDP-K1` and the `mbed Example program for CN0535-FMCZ <https://os.mbed.com/teams/AnalogDevices/code/EVAL-CN0535-FMCZ>`__.

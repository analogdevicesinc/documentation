...
For the hardware board support packages to work, you must use Matlab version **R2022b** or newer. You can go to the download page by clicking `here <https://www.mathworks.com/downloads>`__, you may be required to sign in with your MathWorks account first.
...
| Once both the Phaser and Pluto are able to communicate with MATLAB, download and extract `phaser_steeringangle_rev1.zip <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0566/matlab/phaser_steeringangle_rev1.zip>`__

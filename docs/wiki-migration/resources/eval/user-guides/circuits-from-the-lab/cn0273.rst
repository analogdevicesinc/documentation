...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0273/cn0273-hw-1024.jpg
   :align: center
   :width: 300px
...
-  :adi:`EVAL-CN0273-EB1Z` circuit evaluation board
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0273/demo_setupv4.png
   :align: center
...
-  Maximum allowable differential input is ±3.5 V/G1, where G1 is the gain of the first stage.

.. note::

   There is a tradeoff between the maximum allowable differential input and the closed-loop gain of the first stage.
...
.. note::
   ...
   The output swing of the circuit is limited to ±3.5 V when operating on ±5 V supplies
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0273/gain_config1.png
   :align: center
   :width: 300px
...
.. admonition:: Download
   ...
   -  `Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0273/eval-cn0273-eb1z-padsschematics-reva.pdf>`__ (PDF)
   -  `Bill of Materials <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0273/eval-cn0273-eb1z-bom-reva.xls>`__ (Excel)
   -  `Layout Gerbers <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0273/eval-cn0273-eb1z-gerberfiles-reva.zip>`__ (ZIP)
   -  `Assembly Drawing <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0273/eval-cn0273-eb1z-assemblydrawing-reva.pdf>`__ (PDF)
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0273-EB1Z?&v=RevA>`__ to receive all these great benefits and more!


// End of Document //

.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0273/gain_output.png
   :width: 400px

...
-  `CN0357 Evaluation Software <https://swdownloads.analog.com/cse/cftl/CN0357/1.0.0/CN0357_Evaluation_Software.zip>`__
...
.. tip::
   ...
   \ **NOTE:** It is recommended that you install the `CN0357 Evaluation Software <https://swdownloads.analog.com/cse/cftl/CN0357/1.0.0/CN0357_Evaluation_Software.zip>`__ to the default directory path **C:\\Program Files\\Analog Devices\\CN0357\\** and all National Instruments products to **C:\\Program Files\\National Instruments\\**\
...
-**Mode Register Numerical Indicator**
   ...
   * Table 12 in the [[:adi:`AD7790|AD7790]]` Datasheet outlines the **Register Bit Designations** for the filter register.\\ \\
...
`CN0357 LabVIEW Source <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-labview_source.zip>`__
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0357-ARDZ?&v=RevC>`__ to receive all these great benefits and more!

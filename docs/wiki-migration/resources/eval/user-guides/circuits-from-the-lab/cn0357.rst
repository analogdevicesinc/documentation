...
This user guide will discuss how to use the evaluation software to collect data from the :adi:`EVAL-CN0357-PMDZ` Evaluation Board **(CN-0357 Board)**

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-simplified_schematic.png
   :width: 1000px
...
-  :adi:`EVAL-CN0357-PMDZ` Evaluation Board (**CN-0357 Board**)
-  :adi:`SDP-PMD-IB1Z` Interposer Board (**SDP to Pmod Interposer Board**)
-  :adi:`EVAL-CFTL-6V-PWRZ` **(+6V Power Supply)** or equivalent
-  `CN0357 Evaluation Software <https://swdownloads.analog.com/cse/cftl/CN0357/1.0.0/CN0357_Evaluation_Software.zip>`_
...
-  The :adi:`EVAL-CN0357-PMDZ` **(CN-0357 Board)** connects to the :adi:`SDP-PMD-IB1Z` **(SDP to Pmod Interposer Board)** via the 12-Pin connector
-  The :adi:`SDP-PMD-IB1Z` **(SDP to Pmod Interposer Board)** connects to the :adi:`EVAL-SDP-CB1Z` **(SDP-B Board)** via the 120-Pin connector
-  The :adi:`EVAL-CFTL-6V-PWRZ` **(+6V DC Power Supply)** powers the :adi:`SDP-PMD-IB1Z` **(SDP to Pmod Interposer Board)** via the DC barrel jack
-  The :adi:`EVAL-SDP-CB1Z` **(SDP-B Board)** connects to the PC via the USB cable.

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-test_setup.png
   :align: center
...
-  Extract the file **CN0357_Evaluation_Software.zip** and open the file **setup.exe**.

.. tip::

   \ **NOTE:** It is recommended that you install the `CN0357 Evaluation Software <https://swdownloads.analog.com/cse/cftl/CN0357/1.0.0/CN0357_Evaluation_Software.zip>`_ to the default directory path **C:\\Program Files\\Analog Devices\\CN0357\\** and all National Instruments products to **C:\\Program Files\\National Instruments\\**\
...
|image2|
   ...
   \* Upon completion of the installation of the **CN-0357 Evaluation Software**, the installer for the **ADI SDP Drivers** will execute.
...
-  Connect the :adi:`EVAL-CN0357-PMDZ` **(CN0357 Board)** to the :adi:`SDP-PMD-IB1Z` **(SDP to Pmod Interposer Board)** and the :adi:`EVAL-SDP-CB1Z` **(SDP-B Board)** to the :adi:`SDP-PMD-IB1Z` **(SDP to Pmod Interposer Board)** as depicted below.


|image7|

   \* Connect the :adi:`EVAL-CFTL-6V-PWRZ` **(+6V DC Power Supply)** to the Barrel Jack at **J1** on the :adi:`SDP-PMD-IB1Z` **(SDP to Pmod Interposer Board)**
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-software.png
   :width: 900px

--------------

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-software2.png
   :width: 900px
...
-  This control influences the feedback resistance set by the Rheostat (:adi:`AD5270`).
...
-  The feedback resistance of the transimpedance amplifier on the **CN0357 Board** (:adi:`ADA4528-2`).
-  This can be set by the Rheostat (:adi:`AD5270`) or by populating a fixed resistor in the available footprint.
...
-  The converted voltage seen by the ADC (:adi:`AD7790`).
-**Chart Controls**
...
-  This indicator displays the current state of the software in the form of an LED.  There are three status LED colors.\\ |resources-eval-user-guides-circuits-from-the-lab-cn0357-cn0357-software-inactive.png|Inactive\\ |resources-eval-user-guides-circuits-from-the-lab-cn0357-cn0357-software-busy.png|Busy\\ |resources-eval-user-guides-circuits-from-the-lab-cn0357-cn0357-software-error.png|Error
...
-  __Unbuffered Mode__ - This disables the buffers, lowering the power consumption of the device.\\ \\
...
-  The **Register Bit Designations** can be found on Page 11 of the :adi:`AD7790` Datasheet in Table 9.
-**Filter Register Numerical Indicator**
-  This register is used to set the output word rate.
-  Table 12 in the :adi:`AD7790` Datasheet outlines the **Register Bit Designations** for the filter register.\\ \\
...
`CN0357 LabVIEW Source <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-labview_source.zip>`_
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0357-ARDZ?&v=RevC>`_ to receive all these great benefits and more!


.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-install1.png
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-install2.png
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-install3.png
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-install4.png
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-install5.png
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-install6.png
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-hardware1.jpg
   :width: 600px
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-hardware2.jpg
   :width: 600px
.. |image9| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-hardware3.jpg
   :width: 600px

.. |resources-eval-user-guides-circuits-from-the-lab-cn0357-cn0357-software-busy.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-software-busy.png
.. |resources-eval-user-guides-circuits-from-the-lab-cn0357-cn0357-software-error.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-software-error.png
.. |resources-eval-user-guides-circuits-from-the-lab-cn0357-cn0357-software-inactive.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0357/cn0357-software-inactive.png

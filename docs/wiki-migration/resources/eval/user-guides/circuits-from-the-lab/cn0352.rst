...
:adi:`CN-0352 <CN0352>` is a cost effective, multi-channel battery testing reference system designed for signle-cell Li-ion battery with open circuit voltage(OCV) between 3.5V to 4.4V.
...
Each :adi:`CN-0352 <CN0352>` battery testing module could handle 8-channel Li-ion battery cell. With RS485 commumication bus, the testing channels could be extended upto more than hundred channels. The limitation is the communication bandwidth of RS485.
...
The picture below shows all 3 type of boards and give each connector a serial number for better understanding. See the tables below with detais of the connectors and jumpers on each board.
...
.. note::
   ...
   See the **red dots** on the picture. Each dot indicate the 1st pin location on the connector. the Pin1-to-Pin1 hookup must always be done during EVAL-CN0352-EB1Z module setup process.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/eval-cn0352-eb1z_hookingup.jpg
   :align: center
   :width: 500px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/cn0352_demo_system1.jpg
   :align: center
   :width: 500px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/cn0352_esw_installation.png
   :align: center
   :width: 500px
...
-  |image3| : Click to switch to the **1st** Battery available.
-  |image4| : Click to switch to the **previous** Battery available.
-  |image5| : Switch to the expected battery channel by input the battery index.
-  |image6| : Click to switch to the **next** Battery available.
-  |image7| : Click to switch to the **last** Battery available.
...
-  **Configuration**
   ...
   -  *Testing Configuration*
      ...
      -  *Charging Configuration*
         ...
         -  *Input Current Limitation*: The maximum current that going into the VIN pin of :adi:`ADP5065 <adp5065.html>`. See |ADP5065 Datasheet| for more details.
         -  *Trickle Vlotage Threshold*: The charging voltage thershold of trickle charge mode. Trickle Charging is a charging mode of :adi:`ADP5065 <adp5065.html>` with small charging current to reset the battery pack protection circuit and lift the voltage to safe level for fast charging. See |ADP5065 Datasheet| for more details.
         -  *Trickle Current Threshold*: The charging current of trickle charge mode. See |ADP5065 Datasheet| for more details.
         -  *Fast Charge Current*: The configurable charing current during constant current charging stage of :adi:`ADP5065 <adp5065.html>`. See |ADP5065 Datasheet| for more details.
         -  *Charge Termination Voltage*: The termination voltage of constant current fast charging mode of :adi:`ADP5065 <adp5065.html>`. See |ADP5065 Datasheet| for more details.
         -  *Charge Termination Current*: The termination charging current of constant voltage charging mode of :adi:`ADP5065 <adp5065.html>`. See |ADP5065 Datasheet| for more details.

      -  *Discharging Configuration*: The maximum current that going into the VIN pin of :adi:`ADP5065 <adp5065.html>`. See |ADP5065 Datasheet| for more details.
...
|image9| The **Battery Summary** tab listed all latest informations of each battery on one row. It is very convenient to see the any battery interested without switching the channel.

Module ID Programmer
""""""""""""""""""""

|image10| Before doing the test, each EVAL-CN0352-EB1Z sharing the same RS485 bus need to have a unique ID. This ID is a 8-bit ID. The Default ID for the EVAL-CN0352-EB1Z is 0xFF. If there are multiple modules sharing the same RS485, than each Module need to have a different ID. This **Module ID Programmer** is the tools for assigning the ID.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/cn0352_esw_com_steps.png
   :align: center
   :width: 500px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/cn0352_esw_idprogsteps.png
   :align: center
   :width: 500px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/cn0352_eswdemosteps1.png
   :align: center
   :width: 500px
...
.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/cn0352_connector2.png
   :width: 500px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/cn0352_01_main_configuraion.png
   :width: 500px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/leftest.png
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/left.png
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/digital_id.png
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/Right.png
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/Rightest.png
.. |ADP5065 Datasheet| image:: http://www.analog.com/media/en/technical-documentation/data-sheets/ADP5065.pdf
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/cn0352_esw_batteryplot.png
   :width: 500px
.. |image9| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/cn0352_esw_batterysummary.png
   :width: 500px
.. |image10| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0352/cn0352_esw_batteryidprog.png
   :width: 500px

...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0359/cn0359-conductivity-2w-small.png
   :align: center
...
.. _electrode-conductivity-sensor-connection-1:
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0359/cn0359-rtd-4w-small.png
   :align: center
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0359/cn0359-rtd-3w-small.png
   :align: center
...
| In the Rev A boards, J4 is pin compatible with `SEGGER J-Link <https://www.segger.com/jlink-debug-probes.html>`__ debug probes that have the standard 20-pin connector/cable. The following table shows the pin map of J4 in this case:
| ^ Pin Number ^ Signal Name ^ Pin Description ^
...
| In the Rev B boards, J4 is pin compatible with `SEGGER J-Link <https://www.segger.com/jlink-debug-probes.html>`__ debug probes that have the smaller 10-pin connector/cable. The following table shows the pin map of J4 in this case:
| ^ Pin Number ^ Signal Name ^ Pin Description ^
...
-  The onboard buzzer will beep for 100 ms twice, with an short interval of 100 ms in between. This indicates that the interface is now in the LCD contrast setting screen.
-  Turn the encoder **S1** clockwise/counterclockwise to increase/decrease LCD contrast. Adjust it such that the text will appear clearly and sharply.
-  Push the button **S1** to exit the LCD contrast setting screen.
-  Select the "Return to home" option in the main menu and press the button. The new LCD contrast setting should now be saved.
...
.. important::
   ...
   To communicate with the CN0359 from a PC, use a RS-485 to USB converter (or UART to USB bridge, depending on the version of the board) and a terminal emulator such as `Putty <http://www.putty.org/>`__ or `Tera Term <https://ttssh2.osdn.jp/index.html.en>`__. Please check the settings of your software before connecting to the board. The output of the terminal program must match the following command formats.
...
The **setk** command is used to input the cell constant of the conductivity sensor used, ranging from 0.01 cm\ :sup:`-1` to 100 cm\ :sup:`-1`. For example, the following command will input a cell constant of 1.268 cm\ :sup:`-1` to the CN0359 at address 100:
...
The **setk** command is used to input the cell constant of the conductivity sensor used, ranging from 0.01 cm\ :sup:`-1` to 100 cm\ :sup:`-1`. For example, the following command will input a cell constant of 1.268 cm\ :sup:`-1` to the CN0359 via UART:
...
.. tip::
   ...
   Details regarding the J-Link debug probe can be found at `J-Link Manual <https://www.segger.com/downloads/jlink>`__\
...
1. Download and install the latest `J-Link Software and Documentation Pack <https://www.segger.com/downloads/jlink>`__.
...
.. raw:: html
   ...
   | Download the latest :adi:`CN0359 Design & Integration Files <cn0359-designsupport>` and extract the contents of *CN0359 Source Code Package* in *CN0359 Design & Integration Files*.
|
...
.. raw:: html
   ...
   | Download the latest release of ADuCM360_demo_cn0359 from :git-EVAL-ADICUP360>`__. Currently, Release 1.0 is available: `ADuCM360_demo_cn0359 <https::`EVAL-ADICUP360 </github.com/analogdevicesinc/EVAL-ADICUP360/releases/download/Release-1.0/ADuCM360_demo_cn0359>`
|
...
The source code for the CN0359 software can be downloaded from: :git-EVAL-ADICUP360:`projects/ADuCM360_demo_cn0359_reva`.
...
The source code for the CN0359 software can be downloaded from: :git-EVAL-ADICUP360:`projects/ADuCM360_demo_cn0359`.
...
.. admonition:: Download
   ...
   :adi:`EVAL-CN0359-EBZ Design and Integration Files <CN0359-DesignSupport>`
...
.. admonition:: Download
   ...
   -  :git-EVAL-ADICUP360:`Software Binary Release 1.0 <releases/download/Release-1.0/ADuCM360_demo_cn0359.bin>`
   
   EVAL-CN0359-EB1Z Rev A Files
   
   -  :git-EVAL-ADICUP360:`Software Source Code <projects/ADuCM360_demo_cn0359_reva>`
   -  :git-EVAL-ADICUP360:`Software Binary Release 1.0 <releases/download/Release-1.0/ADuCM360_demo_cn0359_reva.bin>`
...
.. tip::
   ...
   Receive software update notifications, documentation updates, view the latest videos, and more when you register your hardware. `Register your Rev A Board <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0359-EB1Z?&v=RevA>`__ or `Register your Rev B board <https://form.analog.com/Form_Pages/FeedBack/EVAL-CN0359-EBZ?&v=RevB>`__ to receive all these great benefits and more!


.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0359/cn0359_reva_front.jpg
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0359/cn0359-top.png
   :width: 600px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0359/cn0359-conductivity-4w-small.png
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0359/cn0359-rtd-2w-small.png
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0359/cn0359_rs485.jpg
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0359/cn0359-uart-pin-map.png
   :width: 240px
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0359/poll_output.png
   :width: 600px

...
The AD124 Evaluartion+ software is available :adi:`here. <media/en/evaluation-boards-kits/evaluation-software/AD7124-Eval-plus-installer-V1-3-5-12.zip>`

The quick start guide is available on the landing page here :doc:`(Quick Start Guide) </wiki-migration/resources/eval/user-guides/ad7124>` or for the step by step install guide see the below
...
-  :adi:`AD7124 Evaluation Software <media/en/evaluation-boards-kits/evaluation-software/AD7124-Eval-plus-installer-V1-3-5-12.zip>`
...
-  In the next pop-up screen you will be asked to disable Windows fast start. National Instruments recommends disabling fast start as it can cause hardware issues. For more information click the link provided in the pop-up, or alternatively `here <https://knowledge.ni.com/KnowledgeArticleDetails?id=kA00Z000000P9ErSAK&l=en-IE>`__. In this example, it has been disabled. Hit 'Next >>' box to continue.
...
| :doc:`Visit the demo mode section here </wiki-migration/resources/eval/user-guides/ad7124/software/demo_modes>`
| **Contents of the demo modes section:**

-  :doc:`Noise Test Demo </wiki-migration/resources/eval/user-guides/ad7124/software/demo_modes>`
-  :doc:`2 Wire RTD Demo </wiki-migration/resources/eval/user-guides/ad7124/software/demo_modes>`
-  :doc:`3 Wire RTD Demo </wiki-migration/resources/eval/user-guides/ad7124/software/demo_modes>`
-  :doc:`4 Wire RTD Demo </wiki-migration/resources/eval/user-guides/ad7124/software/demo_modes>`
-  :doc:`Thermocouple Demo </wiki-migration/resources/eval/user-guides/ad7124/software/demo_modes>`
-  :doc:`Thermistor Demo </wiki-migration/resources/eval/user-guides/ad7124/software/demo_modes>`
-  :doc:`4 Wire Bridge Demo </wiki-migration/resources/eval/user-guides/ad7124/software/demo_modes>`
-  :doc:`6 Wire Bridge Demo </wiki-migration/resources/eval/user-guides/ad7124/software/demo_modes>`

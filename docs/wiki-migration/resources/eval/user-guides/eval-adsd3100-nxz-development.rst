...
Source code: `main.cpp <https://github.com/ToF?master/examples/first-frame/main.cpp>`__
...
To understand what can be returned the please reference the definition of **availableFrameTypes** in `adsd3500_sensor.h <https://github.com/ToF?master/sdk/src/connections/target/adsd3500_sensor.h>`__
...
For the definition of **DepthSensorFrameType** and \**DepthSensorFrameContent \*\*, see `sensor_definitions.h <https://github.com/ToF?master/sdk/include/aditof/sensor_definitions.h>`__.
...
-  For the definition of **FrameDataDetails**, see `frame_definitions.h <https://github.com/ToF?master/sdk/include/aditof/frame_definitions.h>`__.

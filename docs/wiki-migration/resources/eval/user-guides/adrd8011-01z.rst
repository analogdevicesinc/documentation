...
| 
| =====Software Development===== The GMSL Linux kernel drivers, the complete Linux distributions for the supported processing platforms, and software user guides can be found on the :git-gmsl>`__.
| ----
...
.. tip::
   ...
   Get complete access to hardware components, design files, and procedure on how to setup and use the ADRD8011-01Z Carrier Board:

   
   -  `ad-gmsl522-sl_getting_started_guide <https::`Analog Devices GMSL GitHub repository </wiki.analog.com/ad-gmsl522-sl_getting_started_guide>`
   -  `ad-gmsl522-sl_hardware_guide <https://wiki.analog.com/ad-gmsl522-sl_hardware_guide>`__
   -  `gmsl522_labs\_--\_follow_along_guides <https://wiki.analog.com/gmsl522_labs_--_follow_along_guides>`__
...
.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad-gmsl522-sl/ad-gmsl522-sl_block_diagram.png
   :width: 600px

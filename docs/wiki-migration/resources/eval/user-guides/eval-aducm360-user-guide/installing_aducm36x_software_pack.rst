...
The Software Pack for Keil μVision5 can be installed manually, downloading it from the `Keil MDK5 Software Packs website <https://www.keil.com/dd2/pack/>`__, or it can be installed through the Pack Installer inside Keil μVision5.
...
-  Download Analog Devices ADuCM36x Device Support and Examples from `Keil MDK5 Software Packs website <https://www.keil.com/dd2/pack/>`__

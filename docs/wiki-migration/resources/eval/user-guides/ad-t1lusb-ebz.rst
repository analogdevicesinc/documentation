...
The current hardware configuration provides a straightforward architecture with a USB Ethernet Controller and MAC (`LAN9500A <https://wiki.analog.com/http/www.microchip.com/en-us/product/lan9500a>`__) connected through MII to the :adi:`ADIN1100` PHY.
...
.. admonition:: Download
   ...
   `AD-T1LUSB2.0-EBZ Design Support Package <https://wiki.analog.com/_media/resources/eval/user-guides/ad-t1lusb2.0-ebz/ad-t1lusb2.0-ebz_design_support_package.zip>`__

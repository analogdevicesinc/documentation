**UNDER CONSTRUCTION** ADAQ8092 ZedBoard User Guide
===================================================

.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/adaq8092/adaq8092.png
   :align: right
   :width: 300px
...
The :adi:`ADAQ8092` is a 14-bit, 105MSPS, high-speed dual-channel data acquisition (DAQ) μModule® solution. It incorporates signal conditioning, ADC driver, and ADC in a single package via system-in-package (SIP) technology. This μModule® solution simplifies the development of a high-speed data acquisition system by transferring the design burden of component selection, optimization, and layout from the designer to the device. It enables a 6x footprint reduction.
...
-  ADAQ8092 FMC board
-  `A FMC extender board <https://www.avnet.com/shop/us/products/avnet-engineering-services/aes-fmc-ext-g-3074457345635221630/>`__
-  An 8GB SD card
-  Ethernet cable
-  1 x Micro-USB cable
...
::
   ...
   *''An Image file for Zynq''
   *''A BOOT.BIN specific to your ADAQ8092 + ZedBoard''
   *''A system.dtb for Zynq specific to your ADAQ8092 + ZedBoard''
...
.. tip::
   ...
   Before executing below steps, make sure that VADJ is set to 2.5V.
...
| |iioosc_remote_adaq8092_zed_login.png|
| You should see two screens:
| |iioosc_remote_adaq8092_zed.png|
...
| Functional Overview The reference design is a processor based (ARM) embedded system. A functional block diagram of the system is given below. The device interface is a self-contained peripheral similar to other such pcores in the system. The core is programmable through an AXI-lite interface.
| |image2|
|
...
.. admonition:: Download
   ...
   +================================================+==============================================================================================+=========================================================================================+======================+==========================================================================================================+
   | :adi:`ADAQ8092` | :git-hdl:`projects/adaq8092_fmc` | :git-hdl:`projects/adaq8092_fmc/zed` | NA                   | `axi_adaq8092 <http://github.com/analogdevicesinc/hdl/tree/master/library/axiadaq8092>`__                |
   +------------------------------------------------+----------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------+----------------------+----------------------------------------------------------------------------------------------------------+
   |                                                |                                                                                              |                                                                                         |                      | `axi_dmac <http://github.com/analogdevicesinc/hdl/tree/master/library/axi_dmac>`__                       |
   +------------------------------------------------+----------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------+----------------------+----------------------------------------------------------------------------------------------------------+
   |                                                |                                                                                              |                                                                                         |                      | `axi_hdmi_tx <http://github.com/analogdevicesinc/hdl/tree/master/library/axi_hdmi_tx>`__                 |
   +------------------------------------------------+----------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------+----------------------+----------------------------------------------------------------------------------------------------------+
...
-  :adi:`ADAQ8092 Datasheet <ADAQ8092>`
-  :doc:`AXI-ADAQ8092 </wiki-migration/resources/fpga/docs/adaq8092>`

.. include:: ad9081_fmca_ebz/common.rst

.. |zedboard.png| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/adaq8092/zedboard.png
   :width: 600px
.. |zed_jumpers.jpg| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/adaq8092/zed_jumpers.jpg
   :width: 400px
.. |iioosc_remote_adaq8092_zed_login.png| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/adaq8092/iioosc_remote_adaq8092_zed_login.png
   :width: 700px
   :height: 0px
.. |iioosc_remote_adaq8092_zed.png| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/adaq8092/iioosc_remote_adaq8092_zed.png
   :width: 1000px
.. |image1| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/ad-fmcomms1-ebz/shutdown.png
   :width: 300px
.. |image2| image:: https://wiki.analog.com/_media/resources/fpga/xilinx/fmc/adaq8092/adaq8092_xilinx_v4.png
   :width: 800px

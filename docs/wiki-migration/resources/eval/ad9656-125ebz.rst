...
| ==== Output Signals ==== The default setup uses the Analog Devices high speed converter evaluation platform (:adi:`HSC-ADC-EVALEZ <hsadcevalboard>`) for data capture. The JESD204B outputs from the ADC are routed to P2 using 100Ω differential traces. For more information on the data capture board and its optional settings, visit :adi:`www.analog.com/hsadcevalboard <hsadcevalboard>`.
...
| `visualanalog_setup.exe <https://wiki.analog.com/ftp/ftp.analog.com/pub/hssp_sw/visualanalog/visualanalog_setup.exe>`_
| `spicontroller_setup.exe <https://wiki.analog.com/ftp/ftp.analog.com/pub/adispi/a2dcomponents/install/spicontroller_setup.exe>`_
...
-  Start VisualAnalog on the connected PC. The appropriate part type should be listed in the status bar of the **VisualAnalog – New Canvas** window. Select the template that corresponds to the type of testing to be performed (see Figure 3). Average FFT is a good test to start with.\ |image4|\
...
| 4. To configure VisualAnalog to operate with the AD9656, push the Settings button on the ADCDataCapture block, as shown in Figure 7. |image8|
...
| Push the program button. |image10|
...
\* Click the **New DUT** button in the **SPIController** window (see Figure 12)\ |image13|\
...
\* In the **ADCBase1** tab of the **SPIController** window, set the number of lanes the AD9656 will be configured to. Note that the number of lanes selected here must match the settings made in VisualAnalog as shown in Step 7, Figure 10 above.\ |image16|\
...
-  To begin testing, click the **Run** or **Continuous Run** button in the **VisualAnalog** toolbar (see Figure 17).\ |image18|\
...
-  Adjust the amplitude of the input signal so that the fundamental is at the desired level. Examine the **Fund Power** reading in the left panel of the **VisualAnalog Graph - AD9656 FFT** window (see Figure 18).\ |image19|\
...
.. |image1| image:: https://wiki.analog.com/_media/resources/eval/AD9656-125EBZ_top_level.png
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/AD9656_125EBZ_default_jumpers.png
   :width: 600px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/ad9656_jumper_location_wiki_figure_3_-_white_box.png
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/AD9656_VA_New_Canvas_window.PNG
   :width: 500px
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/10235-005.png
   :width: 400px
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/AD9656_VA_toolbar_collapsed.PNG
   :width: 500px
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/AD9656_VA_avg_FFT_window_2ch_expanded.PNG
   :width: 700px
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/AD9656_ADC_DataCaptureSettings_button.PNG
   :width: 200px
.. |image9| image:: https://wiki.analog.com/_media/resources/eval/AD9656_ADC_DataCaptureSettings_GeneralTab.PNG
   :width: 500px
.. |image10| image:: https://wiki.analog.com/_media/resources/eval/AD9656_ADC_DataCaptureSettings_CaptureBoardTab.PNG
   :width: 500px
.. |image11| image:: https://wiki.analog.com/_media/resources/eval/AD9656_ADC_DataCaptureSettings_DeviceTab.PNG
   :width: 500px
.. |image12| image:: https://wiki.analog.com/_media/resources/eval/AD9656_SPIController_Global_tab_ChipID.PNG
   :width: 600px
.. |image13| image:: https://wiki.analog.com/_media/resources/eval/AD9656_spicontroller_global_tab_newdUT_button.png
   :width: 600px
.. |image14| image:: https://wiki.analog.com/_media/resources/eval/AD9656_SPIController_ADCBase0_tab_ClkDiv.png
   :width: 600px
.. |image15| image:: https://wiki.analog.com/_media/resources/eval/AD9656_SPIController_ADCBase0_tab_DigReset.png
   :width: 600px
.. |image16| image:: https://wiki.analog.com/_media/resources/eval/AD9656_SPIController_ADCBase1_tab_QuickConfig.png
   :width: 600px
.. |image17| image:: https://wiki.analog.com/_media/resources/eval/AD9656_SPIController_ADCA_tab.PNG
   :width: 600px
.. |image18| image:: https://wiki.analog.com/_media/resources/eval/AD9656_VA_toolbar_collapsed_run_button.PNG
   :width: 600px
.. |image19| image:: https://wiki.analog.com/_media/resources/eval/AD9656_FFT_example.png
   :width: 600px

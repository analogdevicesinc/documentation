...
| The BeMicro SDK/SDP Interposer board is an adaptor that allows Arrow’s `BeMicro SDK <https://www.arrow.com/en/datasheets/89166696/arrow-development-tools/bemicrosdk>`__ USB stick to connect to all daughter boards on the SDP Platform. The BeMicro SDK/SDP Interposer provides embedded FPGA system developers the chance to prototype their FPGA + ADI data converter, mixed signal or RF system concept quickly and easily.
...
-  `BeMicro SDK/SDP Interposer board <https://www.arrow.com/en/datasheets/2957953708/analog-devices/bemicrosdksdpinterposer>`__ at Arrow
-  `BeMicro SDK/SDP Schematics <https://static5.arrow.com/pdfs/2013/9/26/7/5/38/918/adi_/manual/bemicro-sdp-adapter.pdf>`__ at Arrow

Design Partner/Manufacture
~~~~~~~~~~~~~~~~~~~~~~~~~~

-  `Hitex Interposer page <http://www.ehitex.de/p_info.php?xPD=113_129&products_id=622>`__
...
-  the `BeMicro SDK <https://www.arrow.com/en/datasheets/89166696/arrow-development-tools/bemicrosdk>`__

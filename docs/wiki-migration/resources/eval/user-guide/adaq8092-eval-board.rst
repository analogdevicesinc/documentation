...
| The evaluation board schematic and other board files can be found on the `EVAL-ADAQ8092-FMCZ <https://wcm.cldnet.analog.com/en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/EVAL-ADAQ8092.html>`__ web page.

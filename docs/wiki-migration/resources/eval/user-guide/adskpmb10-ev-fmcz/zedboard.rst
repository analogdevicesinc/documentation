...
-  Download, extract, and copy the following `files <https://wiki.analog.com/_media/resources/eval/user-guide/adskpmb10-ev-fmcz/adskpmb10-ev-fmcz_firmware.zip>`__ to the SD card.

AD9142-M5375-EBZ Evaluation Board Quick Start Guide
===================================================

Getting Started with the AD9142-M5375-EBZ Evaluation Board and Software
-----------------------------------------------------------------------

What's in the Box
~~~~~~~~~~~~~~~~~

-  AD9142-M5375-EBZ Evaluation Board
-  Evaluation Board CD
-  Mini-USB Cable
...
The AD9142-M5375-EBZ connects to a DPG2 for quick evaluation of the AD9142, a high-speed, signal processing Digital to Analog Converter. The DPG2 automatically formats the data and sends it to the AD9142-M5375-EBZ, simplifying evaluation of the device. The Evaluation Board (EVB) runs from a +5V supply. A clock distribution chip AD9516 is included on this EVB as a clock fan-out and frequency divider for the DACCLK, REFCLK and DPG2 input clock. Also included is a quadrature modulator ADL5375 for quick DAC+IQMOD evaluation. Figure 2 is an image of the top side of the AD9142-M5375-EBZ.
...
.. container:: center
   ...
   | |image3|                                               | |image4|                               |
   +--------------------------------------------------------+----------------------------------------+
   | Figure 1. Block diagram of the AD9142 lab bench set-up | Figure 2. Top view of AD9142-M5375-EBZ |
   +--------------------------------------------------------+----------------------------------------+
...
.. container:: center
   ...
   | 4. The current on the 5V supply should read about 1190mA.
|
...
.. container:: center
   ...
   | Figure 7 AD9142-M5375 Eval Board output Spectrum |
...
.. |image10| image:: https://wiki.analog.com/_media/resources/eval/dpg/ad9142/ad9142_spi_software_quick_start_config.png
   :width: 600px
.. |image11| image:: https://wiki.analog.com/_media/resources/eval/dpg/ad9142/ad9142-m5375_output.gif
   :width: 600px

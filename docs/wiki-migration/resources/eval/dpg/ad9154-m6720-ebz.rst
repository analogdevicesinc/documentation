...
</WRAP center> i. Click on “ADRF67202” tab for Mod 2 and confirm the GUI matches Figure 6 below.
...
a. Open DPG Downloader. (Start > All Programs > Analog Devices > DPG > DPGDownloader). DPG Downlader GUI will come up as shown Figure 7.

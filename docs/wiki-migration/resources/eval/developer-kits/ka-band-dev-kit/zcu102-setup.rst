ZCU102 Setup for Ka-Band Developer's Kit
========================================

This guide will walk you through setting up the ZCU102 FPGA platform to work with the Ka-Band Developer's Kit.
...
| 
| `ZCU102 Configuration Files <https://wiki.analog.com/_media/resources/eval/developer-kits/x-band-dev-kit/zcu102_files.zip>`__

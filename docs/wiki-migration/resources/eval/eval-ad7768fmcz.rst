...
-  Ensure that LK17 is in Position A (USB)
...
+==============+==================+================================================================================================================================================================================================================+
| LK1          | B                | Selects which inverter to use. **Position A**: ADP5075 is used as inverter. **Position B**: LTC1983 is used as inverter.                                                                                       |
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| LK3          | B                | Selects between LTC1983 or ADP5075 output. **Position A**: Use ADP5075_VOUT. **Position B**: Use LTC1983_VOUT.                                                                                                 |
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| LK4          | A                | May be used for bypassing LDO (U8) during split supply. **Position A**: -2.5 V Output, set to bypass LDO (U8) only. **Position B**: -3V Output.                                                                |
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| LK5          | A                | Option to bypass or connect to LDO (U8). **Position A**: Connects to LDO. **Position B**: Bypass LDO. **NOTE: Do not bypass LDO (U8) when using LTC1983 for split supply configuration**                       |
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| LK7          | Inserted         | Disconnect if LDO (U8) is bypassed.                                                                                                                                                                            |
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| LK9          | A                | Enable options for 5V and 3.3V supply for AVDD. **Position A**: AVDD = 5V. **Position B**: AVDD = 3.3V                                                                                                         |
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| LK12         | Inserted         | Connects the on-board ADR4525 external reference :adi:`ADR4525 <en/products/adr4525.html>` for 2.5V voltage reference of the ADC core. Remove LK12 if using a different external reference                     |
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| LK25         | B                | Used to shutdown ADUM6421 for isolation purpose only. **Position A**: Turns the ADUM6421 in OFF or SHUTDOWN MODE **Position B**: ADUM6421 is ON                                                                |
+--------------+------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. container:: center
   ...
   **Single supply**: AVDD = 5V, AVSS = 0V, IOVDD = 5V 
   ...
   +-------------------------------------------------------+----------------------------------------------------------+
   | **Single supply**: AVDD = 5V, AVSS = 0V, IOVDD = 3.3V |                                                          |
   +=======================================================+==========================================================+
   | Link Number                                           | Position                                                 |
   +-------------------------------------------------------+----------------------------------------------------------+
   | LK1                                                   | B                                                        |
...
The EVAL-AD4111ARDZ includes an external 2.5 V reference, the ADR4525ARZ and LTC6655. By default, LK5 is inserted, connecting the external reference to the REF+ pin of the AD4111. Remove LK5 if using a different single-ended external reference.

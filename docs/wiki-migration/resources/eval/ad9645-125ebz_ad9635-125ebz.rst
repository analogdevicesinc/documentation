...
| This user guide describes the :adi:`AD9655`, :adi:`AD9645` and :adi:`AD9635` evaluation boards, :adi:`AD9655-125EBZ <AD9655>`, :adi:`AD9645-125EBZ <AD9645>` and :adi:`AD9635-125EBZ <AD9635>`, which provide all of the support circuitry required to operate these parts in their various modes and configurations. The application software used to interface with the devices is also described.
| The :adi:`AD9655`, :adi:`AD9645` and :adi:`AD9635` data sheets provide additional information and should be consulted when using the evaluation board. All documents and software tools are available at :adi:`www.analog.com/hsadcevalboard <hsadcevalboard>`. For additional information or questions, send an email to highspeed.converters@analog.com.
...
.. container:: centeralign
   ...
   \ *Figure 1. Evaluation Board Connection—*\ :adi:`AD9655-125EBZ <AD9655>`\ *,* :adi:`AD9645-125EBZ <AD9645>` *or* :adi:`AD9635-125EBZ <AD9635>` *(on Left) and* :adi:`HSC-ADC-EVALCZ <hsadcevalboard>` *(on Right)*\


Features
--------

-  Full featured evaluation board for the :adi:`AD9655`/:adi:`AD9645`/:adi:`AD9635`
...
-  :adi:`AD9655`, :adi:`AD9645` or :adi:`AD9635` data sheet
...
-  :adi:`Schematics, layout files, bill of materials <ug-448_designsupport>`
...
-  PC running Windows®
-  USB 2.0 port
-  :adi:`AD9655-125EBZ <AD9655>`, :adi:`AD9645-125EBZ <AD9645>` or :adi:`AD9635-125EBZ <AD9635>` board
-  :adi:`HSC-ADC-EVALCZ <hsadcevalboard>` FPGA-based data capture kit

Getting Started
---------------

| This section provides quick start procedures for using the :adi:`AD9655-125EBZ <AD9655>`, :adi:`AD9645-125EBZ <AD9645>` or :adi:`AD9635-125EBZ <AD9635>` board. Both the default and optional settings are described.
...
-  Connect one 6V, 2.5A switching power supply (such as the CUI, Inc., EPS060250UH-PHP-SZ that is supplied) to the :adi:`AD9655-125EBZ <AD9655>`, :adi:`AD9645-125EBZ <AD9645>` or :adi:`AD9635-125EBZ <AD9635>`.
...
| Two additional supplies, AMP_VDD and 3.3V_AVDD, are used to bias the optional input path amplifiers and optional :adi:`AD9517-4` clock chip, respectively. If used, these supplies should each have 0.5A current capability.
...
.. container:: centeralign
   ...
   *Figure 2. Default Jumper Connections for* :adi:`AD9655-125EBZ <AD9655>`\ */*\ :adi:`AD9645-125EBZ <AD9645>`\ */*\ :adi:`AD9635-125EBZ <AD9635>` *Board*


Evaluation Board Circuitry
--------------------------

| This section explains the default and optional settings or modes allowed on the :adi:`AD9655-125EBZ <AD9655>`, :adi:`AD9645-125EBZ <AD9645>` and the :adi:`AD9635-125EBZ <AD9635>` boards.
...
Additional information on the Standalone (PIN) Mode is provided in the :adi:`AD9655`, :adi:`AD9645` and :adi:`AD9635` data sheets.
...
-  Open VisualAnalog on the connected PC. The appropriate part type should be listed in the status bar of the **VisualAnalog – New Canvas** window. Select the template that corresponds to the type of testing to be performed (see Figure 3, where the :adi:`AD9645` is shown as an example).\ |image3|\
...
-  Open the SPI controller software by going to the **Start** menu or by double-clicking the **SPIController** software desktop icon. If prompted for a configuration file, select the appropriate one. If not, check the title bar of the window to determine which configuration is loaded. If necessary, choose **Cfg Open** from the **File** menu and select the appropriate file based on your part type. Note that the **CHIP ID(1)** box should be filled in to indicate whether the correct SPI controller configuration file is loaded (see Figure 7).\ |image7|\
...
-  Click the **Continuous Run** button in the **VisualAnalog** toolbar (see Figure 11).\ |image11|\
...
-  Adjust the amplitude of the input signal so that the fundamental is at the desired level. Examine the **Fund Power** reading in the left panel of the **VisualAnalog Graph - AD9645 FFT** window (see Figure 12).\ |image12|\
...
-  Check that there is correct power to the :adi:`AD9655-125EBZ <AD9655>`, :adi:`AD9645-125EBZ <AD9645>` or :adi:`AD9635-125EBZ <AD9635>` board, and to the :adi:`HSC-ADC-EVALCZ <hsadcevalboard>`.
...
.. |image1| image:: https://wiki.analog.com/_media/resources/eval/ad9645_125ebz_typical_setup.jpg
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/ad9645_125ebz_default_jumpers.png
   :width: 500px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/ad9645_va_new_canvas.png
   :width: 400px
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/10235-005.png
   :width: 400px
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/ad9645_va_new_window_pre_expansion.png
   :width: 500px
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/ad9645_va_new_window_expanded.png
   :width: 400px
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/ad9645_spictrl_global_tab_chipid.png
   :width: 400px
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/ad9645_spictrl_global_tab_newdutbutton.png
   :width: 400px
.. |image9| image:: https://wiki.analog.com/_media/resources/eval/ad9645_spictrl_adcbase0_clkdiv_hilite.png
   :width: 400px
.. |image10| image:: https://wiki.analog.com/_media/resources/eval/ad9645_spictrl_adca_tab.png
   :width: 400px
.. |image11| image:: https://wiki.analog.com/_media/resources/eval/ad9645_va_new_window_pre_expansion_continrun_button.png
   :width: 500px
.. |image12| image:: https://wiki.analog.com/_media/resources/eval/ad9645_cha_fft_input_ampl_hilite.png
   :width: 400px

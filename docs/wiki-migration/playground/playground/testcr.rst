...
+-----------------+------+---------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2111            | 1    | RESERVED                                                | The uC makes no autonomous attempt to interact with the ADIN2111                                                                                                   |
+-----------------+------+---------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _microcontroller-modes-of-operation-1:
...
| 2111            | 1    | RESERVED                                | The uC makes no autonomous attempt to interact with the ADIN2111                                                                                                                              |
+-----------------+------+-----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 1111            | 0    | Reset ADIN2111                          | Reset the ADIN2111                                                                                                                                                                            |
+-----------------+------+-----------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
-  If no device enumeration and no virtual COM port has been assigned on the device manager check the following:
   ...
   -  The correct COM port is set on the terminal (port number can be checked from the device manager on Windows

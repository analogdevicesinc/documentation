...
Download the pre-build image for you device in question: `Master Microblaze images <https://swdownloads.analog.com/cse/microblaze/master/latest_microblaze_images.tar.gz>`_
...
If you FPGA carrier board features a LCD display and the board is connected to
a DHCP enabled network. You should also see it's IP address printed on the
display. This allows you to connect remote to the board as well. (ssh, libiio
remote)

...
scripts are provided in `linux_image_ADI-scripts <https://github.com/analogdevicesinc/linux_image_ADI-scripts>`_
...
#.  :xilinx:`ZC706` carrier board and power supply
#. keyboard/mouse
#. HDMI monitor
#. SD test card
#. :adi:`AD-FMCOMMS3-EBZ` board
...
:download:`Initial Evaluation Results<../resources/ad-frqcvt1.pptx>`
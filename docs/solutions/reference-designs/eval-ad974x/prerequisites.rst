...
#. One of the AD974x evaluation boards:
   ...
   - :adi:`EVAL-AD9740` - 10-bit variant
   - :adi:`EVAL-AD9742` - 12-bit variant
   - :adi:`EVAL-AD9744` - 14-bit variant
   - :adi:`EVAL-AD9748` -  8-bit variant

#. `ZedBoard <https://digilent.com/shop/zedboard-zynq-7000-arm-fpga-soc-development-board>`__
Rev D or later (Zynq-7000 SoC)Rev D or later (Zynq-7000 SoC)

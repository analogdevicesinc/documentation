...
.. list-table::
   ...
   * - FPGA board
     ...
     - :adi:`EVAL-AD9744`
     - :adi:`EVAL-AD9748`
   * - `ZedBoard <https://digilent.com/shop/zedboard-zynq-7000-arm-fpga-soc-development-board>`
     - FMC LPC
     - FMC LPC
     - FMC LPC
     - FMC LPC
...
via the FMC LPC connector (P1 on thenevaluation board, FMC on the ZedBoard).
Before inserting the evaluation board, set VADJ to 3.3 V and configure the
ZedBoard for SD card boot.

...
- Xlink :xilinx:`ZCU102` Evaluation Board Rev 1.0 or a later version
...
#. Connect the ZCU102 USB-to-UART Bridge with Mini USB Connector (U52, J21) to 
...
#. Download the latest Linux Image and flash the file to your 16 GB SD Card. 
   Refer to adi-kuiper_images for more detailed instruction.

#. In your flashed Linux Image BOOT partition, copy the kernel to the root 
   folder. The kernel will vary depending on the carrier platform. With ZCU102, 
...
:dokuwiki:`ADIN1300/ADIN1200 PHY Linux Driver <resources/eval/user-guides/circuits-from-the-lab/cn0506/hdl>`

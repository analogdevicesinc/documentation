...
#. The AD9680-based evaluation board: :adi:`AD-FMCADC4-EBZ`
#. An FPGA carrier platform. Our supported ones can be found
   :ref:`here <ad_fmcadc4_ebz carriers>`.
#. Up to four signal sources for the analog input connectors
   (J301A, J301B, J301C, J301D).

...
- Write ``u-boot-splx4.sfp`` from **socfpga_arria10_socdk_template** folder
...
To be compatible with the :adi:`EVAL-AD9002`, these pins need to be connected
...
to be compatible with the :adi:`EVAL-AD9002`.
...
.. include-template:: ../../common/using-iio-osc.rst
   ...
   connection_image: ../images/ADRV9002_IIO_connection_a10soc.png
   iio_has_plugin: true
...
.. include-template:: ../../common/using-scopy.rst
...
:git-pyadi-iio:`PyADI-IIO </>` is a Python

...
* EVAL-ADIN1320FMCZ
* `Zedboard - Zynq7000 development board <https://digilent.com/reference/programmable-logic/zedboard/start?srsltid=AfmBOooLHZGv61ESZdJs-bF4BuBzL1dxbhf5wkQucS6hcOSApGy8SCFY>`__
...
.. list-table:: Port 0 hardware configuration (RGMII to Copper or Fiber)
   ...
   * - LED_1/LSFLD_CFG
     - MODE_1
     - LINK_ST active high, fast link down and Clause 37 autonegotiation disabled
   * - LED_2/MDIX_MODE
     - MODE_4
...
Flash a Linux distribution image to an SD card. :adi:`Kuiper Linux
<en/resources/evaluation-hardware-and-software/software/kuiper-linux.html>`
is recommended, since it contains everything (kernel and HDL images,
devicetree, rootfs) needed to get started.
...
.. shell::
   ...
   $ethtool -s eth0 mdix auto # auto-mdix (no way to set preference, MDI is preferred by default)

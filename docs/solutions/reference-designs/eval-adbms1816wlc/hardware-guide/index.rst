...
The :adi:`EVAL-ADBMS1816WLC` can be evaluated through the ACE GUI by running the AD-BMSE2E3WLC software package. 

Access the software resources and see the setup procedure in the 
:ref:`Software User Guide <eval-adbms1816wlc software>`.

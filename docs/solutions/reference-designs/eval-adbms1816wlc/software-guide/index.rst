...
This guide provides step-by-step instructions for firmware installation,
loading the ACE GUI plugin, and using the AD-BMSE2E3WLC-SL evaluation system.
...
.. admonition:: Download
    ...
    Required software and files for the AD-BMSE2E3WLC-SL evaluation:
    ...
    - AD-BMSE2E3WLC-SL ACE GUI Plugin Installer (link to follow)
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    - Change the pin header setting for the EVAL-ADBMS1816WLC from pin 2→3 to pin 1→2
        ...
        .. figure:: shunt-connection-mode.png
            ...
            EVAL-ADBMS1816WLC Connection Mode P17 (from 2->3 to 1→2)

    - Open the ACE GUI and run the plugin.

        - Expected: No output on BMS2

        .. figure:: without-BMS2-output.png
            :width: 800 px

            EVAL-ADBMS1816WLC P17 (from 2->3 to 1→2) should reflect no output on BMS2
    ...
    - Restore P17 to its original setting (pin 2→3):
        ...
        .. figure:: with-BMS2-output.png
            ...
            EVAL-ADBMS1816WLC P17 (return to 2→3) should show output on BMS2
...
**Minimum Voltage Test**
    ...
    - Rotate both DC2472A knobs **clockwise (for minimum setting)**
...
**Maximum Voltage Test**
    ...
    - Rotate both DC2472A knobs **counterclockwise (for maximum setting)**
...
Measure using a **Digital Multimeter (DMM)**:
    ...
    - Connect **DMM (–)** to AD-BMSE2E3WLC-48V Baseboard's **Ground**.
    - Connect **DMM (+)** to AD-BMSE2E3WLC-48V Baseboard's **TP23**.
...
Driving Mode:
    ...
    - Once done, set the Vehicle State again to **Parked**, then close the GUI.

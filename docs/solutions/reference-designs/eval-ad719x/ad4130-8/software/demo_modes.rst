...
If you have not set up the EVAL-AD4130-8WARDZ and controller board previously please go to the :doc:`Quick Start Guide </solutions/reference-designs/eval-ad719x/ad4130-8/index>`

If you have not set up/installed the ACE plugin before please go to :doc:`Install Guide </solutions/reference-designs/eval-ad719x/ad4130-8/software>`
...
-  For more information on the Waveform window go to the software section :doc:`here </solutions/reference-designs/eval-ad719x/ad4130-8/software>`
...
-  The value in the Refin1(+/−) field on the Configuration tab is set to 2.5 V
   ...
   -  Information on the reference choice can be viewed in the :doc:`Reference Options Tab </solutions/reference-designs/eval-ad719x/ad4130-8/hardware>`

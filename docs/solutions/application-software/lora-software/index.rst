...
:ref:`PHASE 1: Hardware Setup <ad-max32lrwise-sl>`
...
1. Download and extract the **ADI Wireless Sensor Standalone Software**
  
  .. figure:: extracting_file.png

2. Once extracted, run the **ADI Wireless Sensor Standalone Software** with
   administrator privileges. 
   
   .. figure:: run_admin_privileges.png

3. This will start the initialization process and run the process on your PC.
   
   .. figure:: initializing_and_run.png
      
4. Check the IP address assigned to the Raspberry Pi gateway. Take note that the
...
5. Use the assigned ChirpStack IP address saved earlier to access its
...
6. Add the ChirpStack Port (8080) to the end of IP address.
   Open a page in the browser using the **URL : 169.254.117.207:8080**
   
   .. figure:: adding_chirpstack_port.png

7. This will open the login page. Enter the same credentials we used to
...
#. Change the Event Endpoint URL to the IP of the adapter your gateway is
   ...
   .. tip:: In this example, it is the IP of the Apple Network Adapter, which is

...
- [ADI Kuiper Linux Documentation](https://wiki.analog.com/resources/tools-software/linux-software/kuiper-linux)
- [ADI Network Configuration Guide](https://wiki.analog.com/resources/tools-software/linux-software/network-config)

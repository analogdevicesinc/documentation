...
1. Open a terminal in the pyRadar directory using your choosen IDE, e.g.
   ```bash
...
```{image} xbdp_0.6m_Distance_FMCW_Range.PNG
...
```{image} xbdp_1.2m_Distance_FMCW_Scan.PNG
:alt: FMCW Scan Visualization
```
...
### Documentation
- [pyadi-iio Documentation](https://analogdevicesinc.github.io/pyadi-iio/) - Python IIO library reference
...
- [Kuiper Linux Wiki](https://wiki.analog.com/resources/tools-software/linux-software/kuiper-linux) - Linux image documentation

### Tools and Software
- [IIO Oscilloscope](https://wiki.analog.com/resources/tools-software/linux-software/iio_oscilloscope) - Real-time IIO device visualization

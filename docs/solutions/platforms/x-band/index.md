...
The system is designed to mate with a :xilinx:`ZCU102 <ZCU102>` Evaluation Board from Xilinx®, featuring the Zynq® UltraScale+™ ZU9EG FPGA, with provided reference software, HDL code, and MATLAB/Python system-level interfacing.
...
:ez:`ADEF System Platforms Forum <adef-system-platforms/>`
```

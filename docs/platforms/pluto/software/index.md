...
Python Programming <python_install>
MATLAB Programming <matlab_install>
GNU Radio <grc_install>
QIQ Software <qiq_install>
C Programming <c_install>
BASH USB OTG Scripts <bash_install>
```

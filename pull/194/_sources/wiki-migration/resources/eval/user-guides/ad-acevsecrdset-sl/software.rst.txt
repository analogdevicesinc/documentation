...
| Download the MAX32655FTHR Firmware image from `here <https://github.com/MaximIntegrated/max32625pico-firmware-images/>`_
| Follow the procedure indicated at `here <https://github.com/MaximIntegrated/max32625pico-firmware-images/#how-to-update-the-firmware>`_ to load the new firmware.

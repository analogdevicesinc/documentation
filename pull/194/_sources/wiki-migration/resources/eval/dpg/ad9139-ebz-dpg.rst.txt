...
| These settings configure the AD9139 to output a sine wave using the DPG2/3 and allow the user to view the single-tone performance, under the condition: Fdata = 600MHz, 2X interpolation, DAC_output = 60MHz

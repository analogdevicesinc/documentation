...
It has been designed for interoperability with `Analog Devices JESD204 ADC converter products <https://wiki.analog.com/>`_. To form a complete JESD204 receive logic device it has to be combined with a `PHY layer <https://wiki.analog.com/resources/fpga/peripherals/jesd204/>`_ and `transport layer <https://wiki.analog.com/resources/fpga/peripherals/jesd204/>`_ peripheral.
...
| Name                                                                                                           | Description                                                                 |
+================================================================================================================+=============================================================================+
| `axi_jesd204_rx.v <https://github.com/hdl?master/library/jesd204/axi_jesd204_rx/axi_jesd204_rx.v>`_            | Verilog source for the peripheral.                                          |
+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
| `axi_jesd204_rx_ip.tcl <https://github.com/hdl?master/library/jesd204/axi_jesd204_rx/axi_jesd204_rx_ip.tcl>`_  | TCL script to generate the Vivado IP-integrator project for the peripheral. |
+----------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
...
-  `JESD204 Glossary <https://wiki.analog.com/../jesd204/jesd204_glossary>`_

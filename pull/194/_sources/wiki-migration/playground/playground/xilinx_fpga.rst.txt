:doc:`Return to Digital Engines... </wiki-migration/playground/playground/powering_digital_engines>`
...
`All Spartan 6 Power Solutions... <https://wiki.analog.com/playground/playground/spartan6>`_
...
`All Spartan 7 Power Solutions... <https://wiki.analog.com/playground/playground/spartan7>`_
...
`All Artix 7 Power Solutions... <https://wiki.analog.com/playground/playground/artix7>`_
...
`All Kintex 7 Power Solutions... <https://wiki.analog.com/playground/playground/kintex7>`_
...
`All Virtex 7 Power Solutions... <https://wiki.analog.com/playground/playground/virtex7>`_
...
`All Kintex UltraScale Power Solutions... <https://wiki.analog.com/playground/playground/kintexultrascale>`_
...
`All Virtex UltraScale Power Solutions... <https://wiki.analog.com/playground/playground/virtexultrascale>`_
...
`All Artix UltraScale+ Power Solutions... <https://wiki.analog.com/playground/playground/artixultrascale+>`_
...
|                               | Device                                                                |
+===============================+=======================================================================+
| Virtex UltraScale+ Foundation | `VU3P <https://wiki.analog.com/playground/playground/xilinx_vu3p>`_   |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU5P <https://wiki.analog.com/playground/playground/xilinx_vu5p>`_   |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU7P <https://wiki.analog.com/playground/playground/xilinx_vu7p>`_   |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU9P <https://wiki.analog.com/playground/playground/xilinx_vu9p>`_   |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU9P <https://wiki.analog.com/playground/playground/xilinx_vu9p>`_   |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU11P <https://wiki.analog.com/playground/playground/xilinx_vu11p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
|                               | :doc:`VU13P </wiki-migration/playground/playground/xilinx_vu13p>`     |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU19P <https://wiki.analog.com/playground/playground/xilinx_vu19p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
| Virtex UltraScale+ 58G        | `VU23P <https://wiki.analog.com/playground/playground/xilinx_vu23p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU27P <https://wiki.analog.com/playground/playground/xilinx_vu27p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU29P <https://wiki.analog.com/playground/playground/xilinx_vu29p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
| Virtex UltraScale+ HBM        | `VU31P <https://wiki.analog.com/playground/playground/xilinx_vu31p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU33P <https://wiki.analog.com/playground/playground/xilinx_vu33p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU35P <https://wiki.analog.com/playground/playground/xilinx_vu35p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU37P <https://wiki.analog.com/playground/playground/xilinx_vu37p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU45P <https://wiki.analog.com/playground/playground/xilinx_vu45p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU47P <https://wiki.analog.com/playground/playground/xilinx_vu47p>`_ |
+-------------------------------+-----------------------------------------------------------------------+
|                               | `VU57P <https://wiki.analog.com/playground/playground/xilinx_vu57p>`_ |
+-------------------------------+-----------------------------------------------------------------------+

Zynq-7000 SOC
=============

`All Zynq-7000 SOC Power Solutions... <https://wiki.analog.com/playground/playground/zynq-7000soc>`_
...
`All Zynq-7000S SOC Power Solutions... <https://wiki.analog.com/playground/playground/zynq-7000ssoc>`_
...
`All Zynq UltraScale+ MPSoC Power Solutions... <https://wiki.analog.com/playground/playground/zynqultrascale+mpsoc>`_

+---------------------------+-------------------------------------------------------------------------+
|                           | Device                                                                  |
+===========================+=========================================================================+
| Zynq UltraScale+ MPSoC CG | `ZU1CG <https://wiki.analog.com/playground/playground/xilinx_zu1cg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU2CG <https://wiki.analog.com/playground/playground/xilinx_zu2cg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU3CG <https://wiki.analog.com/playground/playground/xilinx_zu3cg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU4CG <https://wiki.analog.com/playground/playground/xilinx_zu4cg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU5CG <https://wiki.analog.com/playground/playground/xilinx_zu5cg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU6CG <https://wiki.analog.com/playground/playground/xilinx_zu6cg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU7CG <https://wiki.analog.com/playground/playground/xilinx_zu7cg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU9CG <https://wiki.analog.com/playground/playground/xilinx_zu9cg>`_   |
+---------------------------+-------------------------------------------------------------------------+
| Zynq UltraScale+ MPSoC EG | `ZU1EG <https://wiki.analog.com/playground/playground/xilinx_zu1eg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU2EG <https://wiki.analog.com/playground/playground/xilinx_zu2eg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU3EG <https://wiki.analog.com/playground/playground/xilinx_zu3eg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU4EG <https://wiki.analog.com/playground/playground/xilinx_zu4eg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU5EG <https://wiki.analog.com/playground/playground/xilinx_zu5eg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU6EG <https://wiki.analog.com/playground/playground/xilinx_zu6eg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU7EG <https://wiki.analog.com/playground/playground/xilinx_zu7eg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU9EG <https://wiki.analog.com/playground/playground/xilinx_zu9eg>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | :doc:`ZU11EG </wiki-migration/playground/playground/xilinx_zu11eg>`     |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU15EG <https://wiki.analog.com/playground/playground/xilinx_zu15eg>`_ |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU17EG <https://wiki.analog.com/playground/playground/xilinx_zu17eg>`_ |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU19EG <https://wiki.analog.com/playground/playground/xilinx_zu19eg>`_ |
+---------------------------+-------------------------------------------------------------------------+
| Zynq UltraScale+ MPSoC EV | `ZU4EV <https://wiki.analog.com/playground/playground/xilinx_zu4ev>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU5EV <https://wiki.analog.com/playground/playground/xilinx_zu5ev>`_   |
+---------------------------+-------------------------------------------------------------------------+
|                           | `ZU7EV <https://wiki.analog.com/playground/playground/xilinx_zu7ev>`_   |
+---------------------------+-------------------------------------------------------------------------+

Zynq UltraScale+ RFSoC
======================

`All Zynq UltraScale+ RFSoC Power Solutions... <https://wiki.analog.com/playground/playground/zynqultrascale+rfsoc>`_

+-----------------------------+-------------------------------------------------------------------------+
|                             | Device                                                                  |
+=============================+=========================================================================+
| Zynq UltraScale+ RFSoC Gen1 | `ZU21DR <https://wiki.analog.com/playground/playground/xilinx_zu21dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
|                             | `ZU25DR <https://wiki.analog.com/playground/playground/xilinx_zu25dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
|                             | `ZU27DR <https://wiki.analog.com/playground/playground/xilinx_zu27dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
|                             | `ZU28DR <https://wiki.analog.com/playground/playground/xilinx_zu28dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
|                             | `ZU29DR <https://wiki.analog.com/playground/playground/xilinx_zu29dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
| Zynq UltraScale+ RFSoC Gen2 | `ZU39DR <https://wiki.analog.com/playground/playground/xilinx_zu39dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
| Zynq UltraScale+ RFSoC Gen3 | `ZU42DR <https://wiki.analog.com/playground/playground/xilinx_zu42dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
|                             | `ZU43DR <https://wiki.analog.com/playground/playground/xilinx_zu43dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
|                             | `ZU46DR <https://wiki.analog.com/playground/playground/xilinx_zu46dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
|                             | `ZU47DR <https://wiki.analog.com/playground/playground/xilinx_zu47dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
|                             | `ZU48DR <https://wiki.analog.com/playground/playground/xilinx_zu48dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
|                             | `ZU49DR <https://wiki.analog.com/playground/playground/xilinx_zu49dr>`_ |
+-----------------------------+-------------------------------------------------------------------------+
